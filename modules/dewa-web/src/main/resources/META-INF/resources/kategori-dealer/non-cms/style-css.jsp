...
<style>
    ...
    #kategori_dealer_nonMCS_table_length > label{
        visibility: hidden;
    }

    #kategori_dealer_nonMCS_table_length > label > select{
        visibility: visible !important;
    }

    .kategori_dealer_nonCMS {
        margin: 25px;
    }

    .kategori_dealer_nonCMS > .tabcontent {
        box-shadow: 0 6px 10px rgba(0, 0, 0, 0.42);
        border-radius: 10px;
        padding: 0.75em;
    }

    #kategori_dealer_nonMCS_table > thead {
    ...
    table#kategori_dealer_nonMCS_table {
    ...
    #kategori_dealer_nonMCS_table tbody tr {
        border: 1px solid #DCDFE3;
    }

    #kategori_dealer_nonMCS_table > thead > tr > th {
        font-weight: bold;
        text-align: center;
