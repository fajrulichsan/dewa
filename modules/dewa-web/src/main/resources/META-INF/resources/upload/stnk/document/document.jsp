...
<portlet:resourceURL id="upload-stnk-document-list-noncms" var="uploadStnkDocumentListURL"/>

<portlet:resourceURL id="upload-stnk-document-dealer" var="dealerUploadStnkURL"/>
<portlet:resourceURL id="upload-stnk-document-application-category" var="requestUploadStnkURL"/>
<%--
<portlet:resourceURL id="upload-stnk-document-application-assign-status" var="statusUploadStnkURL"/>
--%>
<portlet:resourceURL id="/upload-request/status" var="statusUploadStnkURL"/>
<portlet:resourceURL id="upload-stnk-document-tahun" var="tahunUploadStnkURL"/>
...
<style>
    ...
    #uploadSTNKDocument img {
        padding: 5px 0;
    }

    #uploadSTNKDocument h4 {
        font-weight: 300;
        padding: 0 9px;
        margin: 0 0;
    }

    #uploadSTNKDocument p {
        font-weight: 300;
        padding: 0 9px;
        margin: 0 0;
    }

    #uploadSTNKDocument a {
        font-weight: 700;
        /*padding: 0 16px;*/
    }
...
<script>
   ...
   $(document).ready(function () {
      $('.title-breadcrumb').text('Home > Claim Dealer > Copy STNK Test Car > Hasil Upload Dokumen')
