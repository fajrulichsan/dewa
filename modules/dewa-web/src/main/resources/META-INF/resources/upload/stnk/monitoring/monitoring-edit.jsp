...
<portlet:resourceURL id="upload-stnk-monitoring-request-action" var="uploadStnkActionURL" />
<portlet:resourceURL id="upload-file-upload-stnk-monitoring" var="uploadFileUploadStnkCommandURL" />
<portlet:resourceURL id="delete-file-upload-stnk-monitoring" var="deleteFileUploadStnkCommandURL" />

<portlet:resourceURL id="/non-cms/stnk-application-category" var="requestUploadStnkURL"/>
<portlet:resourceURL id="upload-stnk-monitoring-application-header-status" var="statusUploadStnkURL"/>
...
<script>
   ...
   $(document).ready(function() {
      $('.title-breadcrumb').text('Home > Claim Dealer > Copy STNK Test Car > Ubah Request');
      ...
      if (data.reqYearId < threeYearsAgo) {
         Swal.fire({
            ...
            if (result.isConfirmed) {
               window.location.href = '/group/dealink/copy-stnk-test-car/monitoring-request';
            }
         });
      } else {
         getRequestUploads();
            ...
            $.ajax({
               ...
               success: function(response){
                  ...
                  if (status === 'success') {
                     ...
                     Swal.fire("Gagal menghapus file", "", "warning");
                  }
               },
               error: function(e){
                  console.log(e);
