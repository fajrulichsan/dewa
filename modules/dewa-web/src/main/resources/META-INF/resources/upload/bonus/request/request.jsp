...
<portlet:resourceURL id="upload-bonus-request" var="uploadBonusRequestURL"/>
<portlet:resourceURL id="upload-bonus-request-action" var="uploadBonusActionURL"/>
<portlet:resourceURL id="upload-file-upload-bonus-request" var="uploadFileUploadBonusCommandURL"/>
<portlet:resourceURL id="delete-file-upload-bonus-request" var="deleteFileUploadBonusCommandURL"/>

<portlet:resourceURL id="/non-cms/bonus-application-category" var="requestUploadBonusURL"/>
...
<form data-toggle="validator" role="form" class="form-horizontal" id="formUploadBonus" method="post"
   ...
   <div class="row">
      ...
      <div class="col-xs-6 col-md-3">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <input type="text" class="form-control" style="margin-top: 23px;" id="ticketHour" name="ticketHour"
      ...
      <div class="col-md-6">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            ...
            <input type="text" class="form-control" id="ticketNumber" name="ticketNumber" placeholder="Auto Generate"
                   readonly>
         </div>
      </div>
      <div class="col-md-6">
   ...
   <div class="row">
      <div class="col-md-6">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            ...
            <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" data-minlength="6" maxlength="35"
   ...
   <div class="row">
      <div class="col-md-6">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <label for="requestBonusId" class="control-label title-form">
               Request Category
      ...
      <div class="col-md-6">
         <div class="form-group nominalPengajuan" style="margin-left: 1px;margin-right: 1px;">
            <label for="nominalPengajuan" class="control-label title-form">
               Nominal Pengajuan
               <span style="color: red;">*</span>
            </label>
      ...
      <div class="col-md-6">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <label for="reqYearId" class="control-label title-form">
               Tahun
               <span style="color: red;">*</span>
            </label>
      ...
      <div class="col-md-12">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <label for="requestDescription" class="control-label title-form">
               Request Description
               <span style="color: red;">*</span>
            </label>
      ...
      <div class="col-md-12">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <label for="businessBenefit" class="control-label title-form">
               Business Benefit
               <span style="color: red;">*</span>
            </label>
      ...
      <div class="col-md-12">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <label for="attachment" class="control-label title-form">
               Attachment
               <span style="color: red;">*</span>
            </label>
            <div class="input-group">
               <label class="btn btn-browse btn-fill input-group-addon lbl-atc inv"
                      style="border-width: 0px;background-color:  #014689;">
                  <span class="icon-browse"><img src="<%=request.getContextPath()%>/assets/img/file.svg"/></span>
                  <span class="text-browse">Pilih File</span>
                  <input type="file" accept="application/pdf, image/jpg, image/jpeg, image/png" placeholder=""
                         name="uploadBonusImageFile" id="uploadBonusImageFile" data-filename="" data-location=""
               ...
               <input type="text" class="form-control required" data-type="file" data-name=""
                      name="uploadBonusImageFileName" readonly style="border: 1px solid #DBEDFF; background-color: white">
            ...
            <div style="margin-top: 0px;">
               <button class="btn btn-sm btn-primary btn-round button-text" type="button" id="btnPreview" style="width: 142px;">Preview
               </button>
               <button class="btn btn-sm btn-danger btn-round button-text" type="button" id="btnDelete" style="width: 142px;">Delete
               </button>
            </div>
         </div>
      </div>
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="form-group" style="margin-left: 1px;margin-right: 1px;">
            <label for="requestDescription" class="control-label title-form">Notes <span
...
<script>
   ...
   var ticketDateNew = "";
   var ticketHourNew = "";
   var homeUrl = "/group/dealink/kuitansi-bonus/monitoring-request";
   ...
   $(document).ready(function () {
      $('.title-breadcrumb').text('Home > Claim Dealer > Kuitansi Bonus > Buat Request');
   ...
   function formSend(statusBonusId) {
      ...
      if (submitProcess === false) {
         if (phone === null || phone === undefined || phone.length < 9 || phone.length > 16) {
            ...
            return false;
         } else if (requestBonusId !== '4' && (nominalPengajuan === null || nominalPengajuan === undefined || nominalPengajuan.length < 1)) {
            ...
            if (requestBonusId === '4') {
               ...
               formData.set("<portlet:namespace/>nominalPengajuan", nominalPengajuan);
            }
