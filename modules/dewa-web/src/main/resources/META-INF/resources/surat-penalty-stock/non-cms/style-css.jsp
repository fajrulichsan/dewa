...
<style>
    ...
    <%--
      ...
      #surat_penalty_stock_nonCMS_table_length > label {
          visibility: hidden;
      }

      #surat_penalty_stock_nonCMS_table_length > label > select {
      ...
      .surat_penalty_stock > .tabcontent {
          box-shadow: 0 6px 10px rgba(0, 0, 0, 0.42);
          border-radius: 10px;
          padding: 0.75em;
      }

      #surat_penalty_stock_nonCMS_table > thead {
      ...
      table#surat_penalty_stock_nonCMS_table {
      ...
      #surat_penalty_stock_nonCMS_table tbody tr {
          border: 1px solid #DCDFE3;
      }

      #surat_penalty_stock_nonCMS_table > thead > tr > th {
          font-weight: bold;
          text-align: center;
