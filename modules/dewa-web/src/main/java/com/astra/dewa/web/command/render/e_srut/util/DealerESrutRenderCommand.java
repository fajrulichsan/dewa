package com.astra.dewa.web.command.render.e_srut.util;
...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/dealer-e-srut"
      },
      service = MVCResourceCommand.class
)
public class DealerESrutRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DealerESrutRenderCommand.class);
