package com.astra.dewa.web.command.render.kategori_dealer_noncms.util;
...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/tahun-kategori-dealer-noncms"
        },
        service = MVCResourceCommand.class
)

public class TahunKategoriDealerNonCMSRenderCommand extends BaseMVCResourceCommand {

    private final Log log = LogFactoryUtil.getLog(TahunKategoriDealerNonCMSRenderCommand.class);
    ...
    private List<Integer> getTahun () {
        ...
        try{
            ...
            for(int i=0; i< kategoriDealers.size(); i++){
                Integer tahun = kategoriDealers.get(i).getTahun();
