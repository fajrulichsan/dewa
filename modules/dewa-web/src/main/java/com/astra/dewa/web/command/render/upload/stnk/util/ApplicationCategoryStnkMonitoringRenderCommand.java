...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-stnk-monitoring-application-category"
   },
   service = MVCResourceCommand.class
)
public class ApplicationCategoryStnkMonitoringRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(ApplicationCategoryStnkMonitoringRenderCommand.class);
