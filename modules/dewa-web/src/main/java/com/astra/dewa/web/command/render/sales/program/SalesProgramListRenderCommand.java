...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/sales-program-list"
      },
      service = MVCResourceCommand.class
)
public class SalesProgramListRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(SalesProgramListRenderCommand.class);
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      try {
         ...
         for (SalesProgram salesProgram : salesPrograms) {
            ...
            dto.put("periodeNumber", HtmlUtil.escape(DateUtil.getMonthNumberByName(salesProgram.getPeriode()).toString()));
