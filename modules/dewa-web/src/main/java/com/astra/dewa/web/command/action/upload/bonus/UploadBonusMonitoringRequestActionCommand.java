...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-bonus-monitoring-request-action"
      },
      service = MVCResourceCommand.class
)
public class UploadBonusMonitoringRequestActionCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadBonusMonitoringRequestActionCommand.class);
   private User user;
...
//            String attachmentPath = ParamUtil.getString(portletRequest, "attachmentPath");
         ...
         if (e instanceof PrincipalException) {
            LOG.error("You are not authorized to access resource. Possible CSRF attack. " + "UserId: " + PortalUtil.getUserId(portletRequest));
            LOG.error("Invalid CSRF token!  Token: " + ParamUtil.get(portletRequest, "p_auth", "none"), e);
