package com.astra.dewa.web.command.render.faktur.pajak.util;
...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/dealer-faktur-pajak"
   },
   service = MVCResourceCommand.class
)
public class DealerFakturPajakRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerFakturPajakRenderCommand.class);
