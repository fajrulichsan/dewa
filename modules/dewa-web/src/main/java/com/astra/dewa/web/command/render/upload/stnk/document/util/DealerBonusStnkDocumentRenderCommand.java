...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-stnk-document-dealer"
   },
   service = MVCResourceCommand.class
)
public class DealerBonusStnkDocumentRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerBonusStnkDocumentRenderCommand.class);
