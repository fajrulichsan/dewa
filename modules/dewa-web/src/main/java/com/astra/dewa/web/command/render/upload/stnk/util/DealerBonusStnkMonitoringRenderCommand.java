...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-stnk-monitoring-dealer"
   },
   service = MVCResourceCommand.class
)
public class DealerBonusStnkMonitoringRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerBonusStnkMonitoringRenderCommand.class);
