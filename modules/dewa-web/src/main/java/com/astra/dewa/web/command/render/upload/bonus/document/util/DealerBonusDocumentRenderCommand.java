...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-bonus-document-dealer"
   },
   service = MVCResourceCommand.class
)
public class DealerBonusDocumentRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerBonusDocumentRenderCommand.class);
