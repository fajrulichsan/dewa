...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/surat-penalty-stock-list"
      },
      service = MVCResourceCommand.class
)
public class SuratPenaltyStockListRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(SuratPenaltyStockListRenderCommand.class);
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      try {
         ...
         for (SuratPenaltyStock suratPenaltyStock : suratPenaltyStocks) {
            ...
            Dealer dealer = DealerLocalServiceUtil.getDealer(suratPenaltyStock.getDealerId());
