package com.astra.dewa.web.command.render.sales.report.noncms.util;
...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/non-cms/sales-report/dealers"
        },
        service = MVCResourceCommand.class
)

public class DealerSalesReportNonCMSListRenderCommand extends BaseMVCResourceCommand {
