...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-bonus-monitoring-tahun"
      },
      service = MVCResourceCommand.class
)
public class TahunBonusMonitoringRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunBonusMonitoringRenderCommand.class);
