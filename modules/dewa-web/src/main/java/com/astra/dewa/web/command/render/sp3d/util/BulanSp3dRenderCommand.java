...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/bulan-sp3d"
        },
        service = MVCResourceCommand.class
)
public class BulanSp3dRenderCommand extends BaseMVCResourceCommand {
    private final Log LOG = LogFactoryUtil.getLog(BulanSp3dRenderCommand.class);
