package com.astra.dewa.web.command.render.upload.bonus.request.util;
...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/non-cms/bonus-application-category"
   },
   service = MVCResourceCommand.class
)
public class ApplicationCategoryBonusResourceCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(ApplicationCategoryBonusResourceCommand.class);
