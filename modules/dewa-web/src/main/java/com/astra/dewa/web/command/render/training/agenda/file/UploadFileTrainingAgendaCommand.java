package com.astra.dewa.web.command.render.training.agenda.file;
...
//            "javax.portlet.name=" + DewaWebPortletKeys.TRAINING_AGENDA,
            "mvc.command.name=/upload-file-training-agenda"
      },
      service = MVCResourceCommand.class
)
public class UploadFileTrainingAgendaCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadFileTrainingAgendaCommand.class);
   ...
   protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
      ...
      try {
         ...
         if (fileId == 0) {
            payload = FileUtil.uploadFileIntoMenuFolder(file, fileName, themeDisplay, resourceRequest, DewaWebKeys.AGENDA_PELATIHAN);
         } else {
            try {
