...
@Component(
   property = {
      ...
      "mvc.command.name=/delete-file-diskon-fleet"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileDiskonFleetCommand extends BaseMVCResourceCommand {
   private final Log LOGGER = LogFactoryUtil.getLog(DeleteFileDiskonFleetCommand.class);
