...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-stnk-monitoring-single"
      },
      service = MVCResourceCommand.class
)
public class UploadStnkMonitoringSingleRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadStnkMonitoringSingleRenderCommand.class);
