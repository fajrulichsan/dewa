...
@Component(
   property = {
      ...
      "mvc.command.name=/delete-file-sp3d"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileSp3dCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileSp3dCommand.class);
