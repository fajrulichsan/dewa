...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-bonus-monitoring-list-card"
   },
   service = MVCResourceCommand.class
)
public class UploadBonusMonitoringListCardRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(UploadBonusMonitoringListCardRenderCommand.class);
