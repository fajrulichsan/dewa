...
@Component(
   property = {
      ...
      "mvc.command.name=delete-file-upload-bonus-monitoring"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileUploadMonitoringCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileUploadMonitoringCommand.class);
