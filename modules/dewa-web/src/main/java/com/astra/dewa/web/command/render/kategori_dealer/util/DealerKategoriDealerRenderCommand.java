...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/dealer-kategori-dealer"
   },
   service = MVCResourceCommand.class
)
public class DealerKategoriDealerRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerKategoriDealerRenderCommand.class);
