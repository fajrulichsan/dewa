...
//            "javax.portlet.name=" + DewaWebPortletKeys.TRAINING_AGENDA,
            "mvc.command.name=/delete-file-training-agenda"
      },
      service = MVCResourceCommand.class
)
public class DeleteFileTrainingAgendaCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileTrainingAgendaCommand.class);
