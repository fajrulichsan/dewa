...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-stnk-monitoring-update-status-action"
      },
      service = MVCResourceCommand.class
)
public class UploadStnkMonitoringRequestUpdateStatusActionCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(UploadStnkMonitoringRequestUpdateStatusActionCommand.class);
   private User user;
