...
@Component(
   property = {
      ...
      "mvc.command.name=/delete-file-training-materi"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileTrainingMateriCommand extends BaseMVCResourceCommand {
   private final Log LOGGER = LogFactoryUtil.getLog(DeleteFileTrainingMateriCommand.class);
