...
@Component(
      property = {
            ...
            "mvc.command.name=/delete-e-srut-file"
      },
      service = MVCResourceCommand.class
)
public class DeleteESrutFileCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteESrutFileCommand.class);
