...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/tahun-sales-program"
      },
      service = MVCResourceCommand.class
)
public class TahunSalesProgramRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(TahunSalesProgramRenderCommand.class);
