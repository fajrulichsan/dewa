...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/dealer-diskon-fleet-non-cms"
        },
        service = MVCResourceCommand.class
)
public class DealerDiskonFleetNonCMSRenderCommand extends BaseMVCResourceCommand {

    private final Log log = LogFactoryUtil.getLog(DealerDiskonFleetNonCMSRenderCommand.class);
