...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/tahun-sk-iris"
   },
   service = MVCResourceCommand.class
)
public class TahunSkIrisRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunSkIrisRenderCommand.class);
