...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/jenis-materi-single-training"
   },
   service = MVCResourceCommand.class
)
public class JenisMateriSingleRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(JenisMateriSingleRenderCommand.class);
...
//      HttpServletRequest httpReq = PortalUtil.getOriginalServletRequest(PortalUtil.getHttpServletRequest(request));
      ...
      try {
         ...
         JenisMateri jm = JenisMateriLocalServiceUtil.getJenisMateri(Integer.parseInt(entryId));
         dto.put("id", jm.getId());
         dto.put("jenisMateriName", jm.getName());
         dto.put("imageId", jm.getImageId());
         dto.put("imageName", jm.getImageName());
         dto.put("imagePath", jm.getImagePath());
