...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/tahun-surat-penalty-stock"
   },
   service = MVCResourceCommand.class
)
public class TahunSuratPenaltyStockRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(TahunSuratPenaltyStockRenderCommand.class);
