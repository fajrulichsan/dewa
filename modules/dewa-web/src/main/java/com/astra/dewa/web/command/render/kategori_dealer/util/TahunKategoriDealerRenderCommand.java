package com.astra.dewa.web.command.render.kategori_dealer.util;
...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/tahun-kategori-dealer"
   },
   service = MVCResourceCommand.class
)
public class TahunKategoriDealerRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunKategoriDealerRenderCommand.class);
