package com.astra.dewa.web.command.render.sp3d.file;
...
@Component(
      property = {
            ...
            "mvc.command.name=/upload-file-sp3d"
      },
      service = MVCResourceCommand.class
)

public class UploadFileSp3dCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadFileSp3dCommand.class);
   ...
   protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
      ...
      try {
         ...
         fileName = "SP3D-" + periode + "-" + tahun + "." + FileUtil.getExtensionByStringHandling(fileName).get();
         String menuName = DewaWebKeys.SP3D_MENU;
