package com.astra.dewa.web.command.render.sp3d_noncms.util;
...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/tahun-sp3d-non-cms"
        },
        service = MVCResourceCommand.class
)
public class TahunSp3dNonCMSRenderCommand extends BaseMVCResourceCommand {
    private final Log log = LogFactoryUtil.getLog(TahunSp3dNonCMSRenderCommand.class);
    @Override
