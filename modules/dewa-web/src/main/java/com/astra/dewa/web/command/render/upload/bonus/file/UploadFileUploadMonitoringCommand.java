package com.astra.dewa.web.command.render.upload.bonus.file;
...
@Component(
   property = {
      ...
      "mvc.command.name=upload-file-upload-bonus-monitoring"
   },
   service = MVCResourceCommand.class
)

public class UploadFileUploadMonitoringCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadFileUploadMonitoringCommand.class);
