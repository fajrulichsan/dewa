package com.astra.dewa.web.command.render.diskon.fakpol.util;
...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/tahun-diskon-fakpol-file"
      },
      service = MVCResourceCommand.class
)
public class TahunDiskonFakpolFileRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunDiskonFakpolFileRenderCommand.class);
