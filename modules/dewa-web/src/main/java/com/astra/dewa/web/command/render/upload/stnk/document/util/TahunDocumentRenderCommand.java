...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-stnk-document-tahun"
   },
   service = MVCResourceCommand.class
)
public class TahunDocumentRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunDocumentRenderCommand.class);
   ...
   private JSONArray getTahun() {
      ...
      try{
         ...
         query.add(RestrictionsFactoryUtil.eq("ApplicationId", ApplicationEnum.UPLOAD_STNK.ordinal()));
