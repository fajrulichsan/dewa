...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/tahun-diskon-test-car-file"
      },
      service = MVCResourceCommand.class
)
public class TahunDiskonTestCarFileRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunDiskonTestCarFileRenderCommand.class);
