...
@Component(
   property = {
      ...
      "mvc.command.name=delete-file-upload-stnk-monitoring"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileUploadStnkMonitoringCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileUploadStnkMonitoringCommand.class);
