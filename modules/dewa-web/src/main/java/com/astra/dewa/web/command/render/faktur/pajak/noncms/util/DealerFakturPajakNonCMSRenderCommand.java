package com.astra.dewa.web.command.render.faktur.pajak.noncms.util;
...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/dealer-faktur-pajak-non-cms"
      },
      service = MVCResourceCommand.class
)
public class DealerFakturPajakNonCMSRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DealerFakturPajakNonCMSRenderCommand.class);
