...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/tahun-create-sp3d"
        },
        service = MVCResourceCommand.class
)
public class TahunSp3dCreateRenderCommand extends BaseMVCResourceCommand {
    private final Log LOG = LogFactoryUtil.getLog(TahunSp3dCreateRenderCommand.class);
