...
@Component(
   property = {
      ...
      "mvc.command.name=/delete-file-faktur-pajak"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileFakturPajakCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileFakturPajakCommand.class);
