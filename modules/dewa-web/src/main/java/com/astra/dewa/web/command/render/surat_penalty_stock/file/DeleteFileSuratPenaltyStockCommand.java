...
@Component(
   property = {
      ...
      "mvc.command.name=/delete-file-surat-penalty-stock"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileSuratPenaltyStockCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileSuratPenaltyStockCommand.class);
