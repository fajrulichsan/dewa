...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-bonus-monitoring-edit"
      },
      service = {MVCRenderCommand.class}
)
public class UploadBonusMonitoringEditRenderCommand implements MVCRenderCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadBonusMonitoringEditRenderCommand.class);
...
//         AuthTokenUtil.checkCSRFToken(httpRequest, this.getClass().getName());
      ...
      return "/upload/bonus/monitoring/monitoring-edit.jsp";
   }
}