...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/periode-review-surat-penalty-stock"
   },
   service = MVCResourceCommand.class
)
public class PeriodeReviewSuratPenaltyStockRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(PeriodeReviewSuratPenaltyStockRenderCommand.class);
