...
@Component(
   property = {
      ...
      "mvc.command.name=/faktur-indirect/delete-file"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileFakturIndirectCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileFakturIndirectCommand.class);
