package com.astra.dewa.web.command.render.training.util;
...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/dealer-training"
   },
   service = MVCResourceCommand.class
)
public class DealerTrainingRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerTrainingRenderCommand.class);
