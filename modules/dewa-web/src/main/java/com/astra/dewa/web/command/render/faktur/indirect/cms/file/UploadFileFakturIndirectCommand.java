package com.astra.dewa.web.command.render.faktur.indirect.cms.file;
...
@Component(
   property = {
      ...
      "mvc.command.name=/faktur-indirect/upload-file"
   },
   service = MVCResourceCommand.class
)

public class UploadFileFakturIndirectCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadFileFakturIndirectCommand.class);
   ...
   protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
      ...
      try {
         ...
         fileName = DewaWebKeys.REKAP_FAKTUR_KENDARAAN + "-" + dealerCode + "-" + invoiceDate + "." + FileUtil.getExtensionByStringHandling(fileName).get();
         payload = FileUtil.uploadFileIntoMenuFolder(file, fileName, themeDisplay, resourceRequest, DewaWebKeys.FAKTUR_INDIRECT_MENU);
      } catch (Exception e) {
