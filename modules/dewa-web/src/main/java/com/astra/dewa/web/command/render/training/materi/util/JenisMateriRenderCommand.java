...
import com.astra.dewa.utils.JenisMateriUtils;
...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/jenis-materi-training"
   },
   service = MVCResourceCommand.class
)
public class JenisMateriRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(JenisMateriRenderCommand.class);
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      try {
         ...
         jsonData = JenisMateriUtils.selects();
         acknowledge = 1;
