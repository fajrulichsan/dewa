...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/dealer-diskon-fakpol-non-cms"
      },
      service = MVCResourceCommand.class
)
public class DealerDiskonFakpolNonCMSRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerDiskonFakpolNonCMSRenderCommand.class);
