...
@Component(
   property = {
      ...
      "mvc.command.name=delete-file-calender-event"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileCalenderEventCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileCalenderEventCommand.class);
