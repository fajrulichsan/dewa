...
@Component(
      property = {
            ...
            "mvc.command.name=/report-plafond/upload-file"
      },
      service = MVCResourceCommand.class
)
public class UploadFileReportPlafondCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadFileReportPlafondCommand.class);
   ...
   protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse) throws Exception {
      ...
      try {
         ...
         Date date = DateUtil.stringToDate(periode);

         fileName = DewaWebKeys.REPORT_PLAFOND + "-" + DateUtil.dateToString(date) + "-" + DealerUtils.getDealerCode(Integer.parseInt(dealerId)) + "." + FileUtil.getExtensionByStringHandling(fileName).get();
