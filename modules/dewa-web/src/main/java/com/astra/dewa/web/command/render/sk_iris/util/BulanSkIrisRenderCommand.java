...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/bulan-sk-iris"
   },
   service = MVCResourceCommand.class
)
public class BulanSkIrisRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(BulanSkIrisRenderCommand.class);
