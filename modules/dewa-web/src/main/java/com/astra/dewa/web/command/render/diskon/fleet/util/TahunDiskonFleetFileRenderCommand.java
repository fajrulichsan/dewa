...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/tahun-diskon-fleet-file"
      },
      service = MVCResourceCommand.class
)
public class TahunDiskonFleetFileRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunDiskonFleetFileRenderCommand.class);
