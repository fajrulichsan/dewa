...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/tahun-filter-sk-iris"
        },
        service = MVCResourceCommand.class
)
public class TahunSkIrisFilterRenderCommand extends BaseMVCResourceCommand {
    private final Log log = LogFactoryUtil.getLog(TahunSkIrisFilterRenderCommand.class);
