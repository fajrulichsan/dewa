...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/tahun-diskon-fakpol-non-cms"
      },
      service = MVCResourceCommand.class
)
public class TahunDiskonFakpolNonCMSRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunDiskonFakpolNonCMSRenderCommand.class);
   private String role;
