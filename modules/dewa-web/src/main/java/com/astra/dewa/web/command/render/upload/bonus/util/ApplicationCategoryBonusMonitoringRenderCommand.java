...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-bonus-monitoring-application-category"
   },
   service = MVCResourceCommand.class
)
public class ApplicationCategoryBonusMonitoringRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(ApplicationCategoryBonusMonitoringRenderCommand.class);
