...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-bonus-document-tahun"
      },
      service = MVCResourceCommand.class
)
public class TahunBonusDocumentRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunBonusDocumentRenderCommand.class);
