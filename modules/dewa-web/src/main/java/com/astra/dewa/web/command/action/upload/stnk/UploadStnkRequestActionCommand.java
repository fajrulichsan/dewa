...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-stnk-request-action"
      },
      service = MVCResourceCommand.class
)
public class UploadStnkRequestActionCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadStnkRequestActionCommand.class);
   private User user;
