package com.astra.dewa.web.command.render.upload.stnk.request.file;
...
@Component(
   property = {
      ...
      "mvc.command.name=delete-file-upload-stnk-request"
   },
   service = MVCResourceCommand.class
)
public class DeleteFileUploadStnkCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DeleteFileUploadStnkCommand.class);
