...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/dealer-sp3d"
      },
      service = MVCResourceCommand.class
)
public class DealerSp3dRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DealerSp3dRenderCommand.class);
