...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=/tahun-diskon-test-car-non-cms"
      },
      service = MVCResourceCommand.class
)
public class TahunDiskonTestCarNonCMSRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunDiskonTestCarNonCMSRenderCommand.class);
   private String role;
