...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=/tahun-diskon-fleet-non-cms"
        },
        service = MVCResourceCommand.class
)
public class TahunDiskonFleetNonCMSRenderCommand extends BaseMVCResourceCommand {

    private final Log log = LogFactoryUtil.getLog(TahunDiskonFleetNonCMSRenderCommand.class);
    private String role;
