...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/role-dealer-dealer"
   },
   service = MVCResourceCommand.class
)
public class RoleDealerDealerRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(RoleDealerDealerRenderCommand.class);
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      try {
         jsonData = RoleDealerUtils.selects();
         acknowledge = 1;
