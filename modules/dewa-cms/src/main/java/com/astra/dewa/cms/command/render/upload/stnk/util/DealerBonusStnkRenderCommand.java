...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-stnk-dealer"
      },
      service = MVCResourceCommand.class
)
public class DealerBonusStnkRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(DealerBonusStnkRenderCommand.class);
