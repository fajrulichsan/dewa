...
@Component(
        ...
        property = {
                ...
                "mvc.command.name=" + CmsKeys.CMS_PATH + CmsKeys.REALISASI_DISKON_PATH + "/others/year"
        },
        service = MVCResourceCommand.class
)
public class DiskonOthersYearResourceCommand extends BaseMVCResourceCommand {
