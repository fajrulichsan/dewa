...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-bonus-dealer"
      },
      service = MVCResourceCommand.class
)
public class DealerBonusRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(DealerBonusRenderCommand.class);
