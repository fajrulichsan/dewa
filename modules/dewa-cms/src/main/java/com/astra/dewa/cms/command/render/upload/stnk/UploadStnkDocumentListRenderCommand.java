...
@Component(immediate = true, property = {
      ...
      "mvc.command.name=upload-stnk-document-list-cms"
}, service = MVCResourceCommand.class)
public class UploadStnkDocumentListRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadStnkDocumentListRenderCommand.class);
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      try {
         ...
         countQuery
               .add(RestrictionsFactoryUtil.ne("ApplicationHeaderStatusId", ApplicationHeaderStatusEnum.DRAFT.getId()));
         ...
         for (ApplicationHeader bonus : bonuses) {
            ...
            // String thumbnailURL = DLUtil.getThumbnailSrc(fileEntry, themeDisplay);
