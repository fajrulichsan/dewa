...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-bonus-document"
      },
      service = {MVCRenderCommand.class}
)
public class UploadBonusDocumentRenderCommand implements MVCRenderCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadBonusDocumentRenderCommand.class);
   ...
   public String render(RenderRequest request, RenderResponse response) throws PortletException {
      ...
      return "/upload/bonus/document.jsp";
   }
}