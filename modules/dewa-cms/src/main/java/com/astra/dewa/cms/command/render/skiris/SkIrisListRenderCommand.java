...
public class SkIrisListRenderCommand extends BaseMVCResourceCommand {
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      try {
         ...
         // List<Dealer> dealers = DealerLocalServiceUtil.getDealers(0, 10);
         ...
         for (Dealer dealer : dealers) {
            ...
            // dto.put("hoCode", dealer.getHoCode());
            dto.put("roleDealer", dealer.getKodeHo() + " - " + dealer.getName());
            Cabang cabang;
            try {
