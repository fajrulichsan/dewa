...
@Component(immediate = true, property = {
      ...
      "mvc.command.name=upload-bonus-list"
}, service = MVCResourceCommand.class)
public class UploadBonusListRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(UploadBonusListRenderCommand.class);
   ...
   protected void doServeResource(ResourceRequest request, ResourceResponse response) throws Exception {
      ...
      boolean isApprover = MasterApprovalUtils.isActiveApprover(ApplicationEnum.UPLOAD_BONUS.ordinal() + 1,
            user.getUserId());
      ...
      if (isApprover || isInternalDSO || RoleDealerUtils.isSuperUser(user.getUserId())) {
         try {
            ...
            for (ApplicationHeader bonus : applicationHeaderList) {
               count++;
               ...
               ApplicationCategory requestBonus = ApplicationCategoryLocalServiceUtil
                     .getApplicationCategory(bonus.getApplicationCategoryId());
               ...
               ApplicationHeaderStatus statusBonus = ApplicationHeaderStatusLocalServiceUtil
                     .getApplicationHeaderStatus(bonus.getApplicationHeaderStatusId());
