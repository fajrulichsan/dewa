...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-stnk-tahun"
   },
   service = MVCResourceCommand.class
)
public class TahunStnkRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(TahunStnkRenderCommand.class);
