...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-bonus-application-category"
   },
   service = MVCResourceCommand.class
)
public class ApplicationCategoryBonusRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(ApplicationCategoryBonusRenderCommand.class);
