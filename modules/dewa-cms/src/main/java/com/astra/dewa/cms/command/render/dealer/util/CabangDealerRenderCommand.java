...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=/cabang-dealer"
   },
   service = MVCResourceCommand.class
)
public class CabangDealerRenderCommand extends BaseMVCResourceCommand {

   private final Log log = LogFactoryUtil.getLog(CabangDealerRenderCommand.class);
