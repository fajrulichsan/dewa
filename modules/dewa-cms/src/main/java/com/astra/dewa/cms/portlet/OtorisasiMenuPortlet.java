...
@Component(
        ...
        property = {
                ...
                "javax.portlet.display-name=Otorisasi Menu",
                "javax.portlet.init-param.template-path=/",
                "javax.portlet.init-param.view-template=/otorisasi-menu/view.jsp",
...
public class OtorisasiMenuPortlet extends MVCPortlet {
    @Override
