...
@Component(
   ...
   property = {
      ...
      "mvc.command.name=upload-bonus-edit"
   },
   service = {MVCRenderCommand.class}
)
public class UploadBonusEditRenderCommand implements MVCRenderCommand {

   private final Log log = LogFactoryUtil.getLog(UploadBonusEditRenderCommand.class);
