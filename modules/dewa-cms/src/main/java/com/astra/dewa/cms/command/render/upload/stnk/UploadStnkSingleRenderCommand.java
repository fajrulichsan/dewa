...
@Component(
      ...
      property = {
            ...
            "mvc.command.name=upload-stnk-single"
      },
      service = MVCResourceCommand.class
)
public class UploadStnkSingleRenderCommand extends BaseMVCResourceCommand {
   private final Log LOG = LogFactoryUtil.getLog(UploadStnkSingleRenderCommand.class);
