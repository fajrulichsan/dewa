...
<portlet:resourceURL id="upload-file-upload-stnk" var="uploadFileUploadStnkCommandURL" />
<portlet:resourceURL id="delete-file-upload-stnk" var="deleteFileUploadStnkCommandURL" />
         ...
         <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
               <input type="text" class="form-control numberOnly" id="phone" name="phone"
                      ...
                      data-error="Nomer 9-16 karakter."/>
               <div class="help-block with-errors"></div>
            </div>
         </div>
      </div>
   ...
   <div class="row">
      ...
      <div class="col-md-4">
         <div class="form-group nominalPengajuan">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
               <input type="text" class="form-control numberOnly" id="nominalPengajuan" name="nominalPengajuan"
...
<script>
   ...
   var ticketDateNew = "";
   var ticketHourNew = "";
   var homeUrl = "/group/dewa/cms-upload-stnk";
   ...
   function formSend(statusBonusId) {
      ...
      if (submitProcess === false) {
         if (phone === null || phone === undefined || phone.length < 9) {
            ...
            Swal.fire("Request Category belum diisi.", "", "warning");
            return false;
