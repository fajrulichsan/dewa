...
<portlet:resourceURL id="upload-bonus-list" var="uploadBonusListURL"/>
<portlet:resourceURL id="upload-bonus-single" var="uploadBonusSingleURL"/>
<portlet:resourceURL id="upload-bonus-action" var="uploadBonusActionURL"/>
<portlet:resourceURL id="upload-bonus-update-status-action" var="uploadBonusUpdateStatusActionURL"/>
<portlet:renderURL var="uploadBonusEditURL">
   <portlet:param name="mvcRenderCommandName" value="upload-bonus-edit"/>
</portlet:renderURL>
<portlet:renderURL var="uploadBonusDocumentURL">
   <portlet:param name="mvcRenderCommandName" value="upload-bonus-document"/>
</portlet:renderURL>
...
<portlet:resourceURL id="upload-bonus-application-header-status" var="applicationStatusURL"/>
...
<style>
   ...
   #upload-bonus-table tbody tr {
      border: 1px solid #DCDFE3;
   }

   #upload-bonus-table > thead > tr > th {
      font-weight: normal;
      text-align: center;
      vertical-align: middle;
   }

   #upload-bonus-table table td {
      vertical-align: middle;
   }
...
<div class="upload-bonus">
   <div class="tabcontent">
      ...
      <div>
         <div class="row">
            <div class="col-md-12">
               <h5 class="bonus-title" style="padding: 5px;margin-bottom: 20px;color: #FFFFFF;background-color: #456b9a;">Display Tickets</h5>
            </div>
         </div>
         ...
         <div class="row document-button-field" style="margin-bottom: 15px;">
            ...
            <div class="col-xs-12 col-md-6" style="text-align: right;">
               <form class="form-inline">
                  <a href="${uploadBonusDocumentURL}" class="btn btn-info btn_table btnDocument">
         ...
         <table id="upload-bonus-table" class="table table-hover nowrap" style="width:100%; margin: 15px 0 36px 0;">
            <thead>
            <tr>
               <th>No</th>
               <th>Action</th>
         ...
         <div class="modal-body">
            <form data-toggle="validator" role="form" class="form-horizontal">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label for="requestBonusName" class="col-xs-12 col-sm-12 col-md-4 col-lg-4 control-label">Request Category <span style="color: red;">*</span></label>
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                           <input type="text" class="form-control" id="requestBonusName" name="requestBonusName" readonly/>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                           <input type="text" class="form-control" id="nominalPengajuan" name="nominalPengajuan" placeholder="" readonly/>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                           <input type="text" class="form-control" id="reqYearId" name="reqYearId" placeholder="" readonly/>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                           <textarea class="form-control" rows="3" id="requestDescription" name="requestDescription" placeholder="" readonly></textarea>
                        </div>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                           <textarea class="form-control" rows="3" id="businessBenefit" name="businessBenefit" placeholder="" readonly></textarea>
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-xs-12 col-sm-12 col-md-2 col-lg-2 control-label">Attachment <span style="color: red;">*</span></label>
                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
...
<script>
   ...
   $('.btnDocument').click(function (e) {
      window.location = "${uploadBonusDocumentURL}";
   });
   ...
   $('.nav-tabs').on('click', '#inbox-nav-tab', function () {
      ...
      uploadBonusDataTable.clear().draw();
      refresh();
   });
   ...
   function getUploadBonus() {
      createLoading();
      uploadBonusDataTable = $('#upload-bonus-table').DataTable({
         destroy: true,
         processing: true,
         serverSide: true,
         paging: true,
   ...
   function updateStatus(statusId, statusName) {
      ...
      if (notes === null || notes === undefined || notes.length < 9) {
         ...
         Swal.fire({
            ...
            if (result.isConfirmed) {
               var formData = new FormData();
               formData.set("<portlet:namespace/>crudType", "updateStatus");
               formData.set("<portlet:namespace/>bonusId", bonusId);
               formData.set("<portlet:namespace/>statusId", statusId);
               formData.set("<portlet:namespace/>notes", notes);
               formData.set("<portlet:namespace/>p_auth", Liferay.authToken);

               $.ajax({
                  url: "${uploadBonusUpdateStatusActionURL}",
                  type: "POST",
                  data: formData,
                  processData: false,
                  contentType: false,
   ...
   function getChecks() {
      var kwitansiBonuses = [];
      var rows_selected = uploadBonusDataTable.column(0).checkboxes.selected();
   ...
   function createExels(kwitansiBonuses) {
      ...
      workbook.xlsx.writeBuffer().then((xData) => {
         ...
         saveAs(blob, "Upload Kuitansi Bonus" + ".xlsx");
      });
   }
</script>
