...
<portlet:resourceURL id="upload-stnk-document-list-cms" var="uploadStnkDocumentListURL"/>

<portlet:resourceURL id="upload-dealer" var="dealerUploadStnkURL"/>
<portlet:resourceURL id="upload-application-header-status" var="statusUploadStnkURL"/>
...
<style>
   ...
   #UploadSTNKDocumentCMS img {
      padding: 5px 0;
   }

   #UploadSTNKDocumentCMS h4 {
      font-weight: 300;
      padding: 0 9px;
      margin: 0 0;
   }

   #UploadSTNKDocumentCMS p {
      font-weight: 300;
      padding: 0 9px;
      margin: 0 0;
   }

   #UploadSTNKDocumentCMS a {
      font-weight: 700;
   }
...
<section id="UploadSTNKDocumentCMS">
   <div class="row">
      <div class="col-md-12">
