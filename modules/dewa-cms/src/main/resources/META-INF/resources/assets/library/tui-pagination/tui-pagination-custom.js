            ...
            /***/ (function(module, exports, __webpack_require__) {
                ...
                var Pagination = defineClass(
                    /** @lends Pagination.prototype */ {
                      ...
                      resetAndPage: function(totalItems, page) {
                         if (isUndefined(totalItems)) {
                            totalItems = this._options.totalItems;
                         }
                    ...
                    /** @lends View.prototype */ {
                        ...
                        _appendPrevMoreButton: function(viewData) {
                            ...
                            if (viewData.prevMore) {
                                ...
                                firstPage.href = "#";
                                firstPage.classList.add("tui-page-btn");
                                firstPage.classList.add("tui-first-more");
                                firstPage.innerText = "1";

                                this._buttons["firstMore"] = firstPage;

                                this._getContainerElement().appendChild(firstPage);
                                this._getContainerElement().appendChild(button);
                            }
                        },
                        ...
                        _appendNextMoreButton: function(viewData) {
                            ...
                            if (viewData.nextMore) {
                                ...
                                lastPage.href = "#";
                                lastPage.classList.add("tui-page-btn");
                                lastPage.classList.add("tui-last-more");
                                lastPage.innerText = viewData.lastPage;

                                this._buttons["lastMore"] = lastPage;

                                this._getContainerElement().appendChild(button);
                                this._getContainerElement().appendChild(lastPage);
                            }
                        },
