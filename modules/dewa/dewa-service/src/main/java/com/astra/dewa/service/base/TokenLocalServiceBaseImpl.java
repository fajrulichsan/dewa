...
public abstract class TokenLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, TokenLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TokenLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tokenLocalService = (TokenLocalService)aopProxy;
