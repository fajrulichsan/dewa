...
public abstract class KuartalLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, KuartalLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			KuartalLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		kuartalLocalService = (KuartalLocalService)aopProxy;
