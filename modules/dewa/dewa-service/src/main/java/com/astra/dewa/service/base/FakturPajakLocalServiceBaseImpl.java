...
public abstract class FakturPajakLocalServiceBaseImpl
	...
	implements AopService, FakturPajakLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FakturPajakLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		fakturPajakLocalService = (FakturPajakLocalService)aopProxy;
