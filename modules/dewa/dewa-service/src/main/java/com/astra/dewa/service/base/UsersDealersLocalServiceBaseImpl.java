...
public abstract class UsersDealersLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, UsersDealersLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UsersDealersLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		usersDealersLocalService = (UsersDealersLocalService)aopProxy;
