...
public abstract class CabangLocalServiceBaseImpl
	...
	implements AopService, CabangLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CabangLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		cabangLocalService = (CabangLocalService)aopProxy;
