...
public abstract class TahunLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, TahunLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TahunLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tahunLocalService = (TahunLocalService)aopProxy;
