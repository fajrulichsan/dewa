...
public abstract class CalenderEventLocalServiceBaseImpl
	...
	implements AopService, CalenderEventLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CalenderEventLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		calenderEventLocalService = (CalenderEventLocalService)aopProxy;
