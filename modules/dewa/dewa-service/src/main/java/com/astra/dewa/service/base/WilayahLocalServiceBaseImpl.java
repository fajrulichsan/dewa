...
public abstract class WilayahLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, WilayahLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WilayahLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		wilayahLocalService = (WilayahLocalService)aopProxy;
