...
public abstract class UserRoleTypeLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, UserRoleTypeLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserRoleTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		userRoleTypeLocalService = (UserRoleTypeLocalService)aopProxy;
