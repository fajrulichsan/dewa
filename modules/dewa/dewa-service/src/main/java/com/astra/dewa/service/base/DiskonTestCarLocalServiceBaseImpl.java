...
public abstract class DiskonTestCarLocalServiceBaseImpl
	...
	implements AopService, DiskonTestCarLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiskonTestCarLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		diskonTestCarLocalService = (DiskonTestCarLocalService)aopProxy;
