...
public abstract class ESrutLocalServiceBaseImpl
	...
	implements AopService, ESrutLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ESrutLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		eSrutLocalService = (ESrutLocalService)aopProxy;
