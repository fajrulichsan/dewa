...
public abstract class SkIrisLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, SkIrisLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SkIrisLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		skIrisLocalService = (SkIrisLocalService)aopProxy;
