...
public abstract class DiskonFleetLocalServiceBaseImpl
	...
	implements AopService, DiskonFleetLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiskonFleetLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		diskonFleetLocalService = (DiskonFleetLocalService)aopProxy;
