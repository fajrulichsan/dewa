...
public abstract class SettingLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, SettingLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SettingLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		settingLocalService = (SettingLocalService)aopProxy;
