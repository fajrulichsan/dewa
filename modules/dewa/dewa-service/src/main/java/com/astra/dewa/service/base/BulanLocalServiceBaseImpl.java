...
public abstract class BulanLocalServiceBaseImpl
	...
	implements AopService, BulanLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BulanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		bulanLocalService = (BulanLocalService)aopProxy;
