...
public abstract class DiskonOtherLocalServiceBaseImpl
	...
	implements AopService, DiskonOtherLocalService, IdentifiableOSGiService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiskonOtherLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		diskonOtherLocalService = (DiskonOtherLocalService)aopProxy;
