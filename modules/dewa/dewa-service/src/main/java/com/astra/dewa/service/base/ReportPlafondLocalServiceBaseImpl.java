...
public abstract class ReportPlafondLocalServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, ReportPlafondLocalService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReportPlafondLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		reportPlafondLocalService = (ReportPlafondLocalService)aopProxy;
