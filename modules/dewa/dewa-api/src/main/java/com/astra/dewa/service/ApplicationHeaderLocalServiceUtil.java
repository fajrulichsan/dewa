...
/**
 * Provides the local service utility for ApplicationHeader. This utility wraps
 * <code>com.astra.dewa.service.impl.ApplicationHeaderLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ApplicationHeaderLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ApplicationHeaderLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ApplicationHeader addApplicationHeader(
		ApplicationHeader applicationHeader) {

		return getService().addApplicationHeader(applicationHeader);
	}
	 ...
	 */
	public static ApplicationHeader createApplicationHeader(int Id) {
		return getService().createApplicationHeader(Id);
	}
	 ...
	 */
	public static ApplicationHeader deleteApplicationHeader(
		ApplicationHeader applicationHeader) {

		return getService().deleteApplicationHeader(applicationHeader);
	}
	 ...
	 */
	public static ApplicationHeader deleteApplicationHeader(int Id)
		throws PortalException {

		return getService().deleteApplicationHeader(Id);
	}
	...
	public static ApplicationHeader fetchApplicationHeader(int Id) {
		return getService().fetchApplicationHeader(Id);
	}
	 ...
	 * @throws PortalException if a application header with the primary key could not be found
	 */
	public static ApplicationHeader getApplicationHeader(int Id)
		throws PortalException {

		return getService().getApplicationHeader(Id);
	}
	 ...
	 */
	public static List<ApplicationHeader> getApplicationHeaders(
		int start, int end) {

		return getService().getApplicationHeaders(start, end);
	}
	 ...
	 */
	public static int getApplicationHeadersCount() {
		return getService().getApplicationHeadersCount();
	}
	 ...
	 */
	public static ApplicationHeader updateApplicationHeader(
		ApplicationHeader applicationHeader) {

		return getService().updateApplicationHeader(applicationHeader);
	}

	public static ApplicationHeaderLocalService getService() {
		return _service;
	}

	private static volatile ApplicationHeaderLocalService _service;
