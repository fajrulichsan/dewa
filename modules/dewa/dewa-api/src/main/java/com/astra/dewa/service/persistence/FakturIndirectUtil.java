...
/**
 * The persistence utility for the faktur indirect service. This utility wraps <code>com.astra.dewa.service.persistence.impl.FakturIndirectPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FakturIndirectPersistence
 * @generated
 */
public class FakturIndirectUtil {
	 ...
	 */
	public static void clearCache(FakturIndirect fakturIndirect) {
		getPersistence().clearCache(fakturIndirect);
	}
	 ...
	 */
	public static Map<Serializable, FakturIndirect> fetchByPrimaryKeys(
	 ...
	 */
	public static List<FakturIndirect> findWithDynamicQuery(
	 ...
	 */
	public static FakturIndirect update(FakturIndirect fakturIndirect) {
		return getPersistence().update(fakturIndirect);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static FakturIndirect update(
		FakturIndirect fakturIndirect, ServiceContext serviceContext) {

		return getPersistence().update(fakturIndirect, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(FakturIndirect fakturIndirect) {
		getPersistence().cacheResult(fakturIndirect);
	}
	 ...
	 */
	public static void cacheResult(List<FakturIndirect> fakturIndirects) {
		getPersistence().cacheResult(fakturIndirects);
	}
	 ...
	 */
	public static FakturIndirect create(int Id) {
	 ...
	 */
	public static FakturIndirect remove(int Id)
		throws com.astra.dewa.exception.NoSuchFakturIndirectException {

		return getPersistence().remove(Id);
	}

	public static FakturIndirect updateImpl(FakturIndirect fakturIndirect) {
		return getPersistence().updateImpl(fakturIndirect);
	}
	 ...
	 * @throws NoSuchFakturIndirectException if a faktur indirect with the primary key could not be found
	 */
	public static FakturIndirect findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchFakturIndirectException {
	 ...
	 */
	public static FakturIndirect fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<FakturIndirect> findAll() {
	 ...
	 */
	public static List<FakturIndirect> findAll(int start, int end) {
	...
	public static FakturIndirectPersistence getPersistence() {
		return _persistence;
	}

	private static volatile FakturIndirectPersistence _persistence;
