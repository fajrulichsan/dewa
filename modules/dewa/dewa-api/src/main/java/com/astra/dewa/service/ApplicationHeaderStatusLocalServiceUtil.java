...
/**
 * Provides the local service utility for ApplicationHeaderStatus. This utility wraps
 * <code>com.astra.dewa.service.impl.ApplicationHeaderStatusLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ApplicationHeaderStatusLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ApplicationHeaderStatusLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ApplicationHeaderStatus addApplicationHeaderStatus(
		ApplicationHeaderStatus applicationHeaderStatus) {

		return getService().addApplicationHeaderStatus(applicationHeaderStatus);
	}
	 ...
	 */
	public static ApplicationHeaderStatus createApplicationHeaderStatus(
		int Id) {

		return getService().createApplicationHeaderStatus(Id);
	}
	 ...
	 */
	public static ApplicationHeaderStatus deleteApplicationHeaderStatus(
		ApplicationHeaderStatus applicationHeaderStatus) {

		return getService().deleteApplicationHeaderStatus(
	 ...
	 */
	public static ApplicationHeaderStatus deleteApplicationHeaderStatus(int Id)
		throws PortalException {

		return getService().deleteApplicationHeaderStatus(Id);
	}
	...
	public static ApplicationHeaderStatus fetchApplicationHeaderStatus(int Id) {
		return getService().fetchApplicationHeaderStatus(Id);
	}
	 ...
	 * @throws PortalException if a application header status with the primary key could not be found
	 */
	public static ApplicationHeaderStatus getApplicationHeaderStatus(int Id)
		throws PortalException {

		return getService().getApplicationHeaderStatus(Id);
	}
	 ...
	 */
	public static List<ApplicationHeaderStatus> getApplicationHeaderStatuses(
		int start, int end) {

		return getService().getApplicationHeaderStatuses(start, end);
	}
	 ...
	 */
	public static int getApplicationHeaderStatusesCount() {
		return getService().getApplicationHeaderStatusesCount();
	}
	 ...
	 */
	public static ApplicationHeaderStatus updateApplicationHeaderStatus(
		ApplicationHeaderStatus applicationHeaderStatus) {

		return getService().updateApplicationHeaderStatus(
			applicationHeaderStatus);
	}

	public static ApplicationHeaderStatusLocalService getService() {
		return _service;
	}

	private static volatile ApplicationHeaderStatusLocalService _service;
