...
/**
 * Provides the local service utility for ApprovalHistoryUser. This utility wraps
 * <code>com.astra.dewa.service.impl.ApprovalHistoryUserLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ApprovalHistoryUserLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ApprovalHistoryUserLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ApprovalHistoryUser addApprovalHistoryUser(
		ApprovalHistoryUser approvalHistoryUser) {

		return getService().addApprovalHistoryUser(approvalHistoryUser);
	}
	 ...
	 */
	public static ApprovalHistoryUser createApprovalHistoryUser(int Id) {
		return getService().createApprovalHistoryUser(Id);
	}
	 ...
	 */
	public static ApprovalHistoryUser deleteApprovalHistoryUser(
		ApprovalHistoryUser approvalHistoryUser) {

		return getService().deleteApprovalHistoryUser(approvalHistoryUser);
	}
	 ...
	 */
	public static ApprovalHistoryUser deleteApprovalHistoryUser(int Id)
		throws PortalException {

		return getService().deleteApprovalHistoryUser(Id);
	}
	...
	public static ApprovalHistoryUser fetchApprovalHistoryUser(int Id) {
		return getService().fetchApprovalHistoryUser(Id);
	}
	 ...
	 * @throws PortalException if a approval history user with the primary key could not be found
	 */
	public static ApprovalHistoryUser getApprovalHistoryUser(int Id)
		throws PortalException {

		return getService().getApprovalHistoryUser(Id);
	}
	 ...
	 */
	public static List<ApprovalHistoryUser> getApprovalHistoryUsers(
		int start, int end) {

		return getService().getApprovalHistoryUsers(start, end);
	}
	 ...
	 */
	public static int getApprovalHistoryUsersCount() {
		return getService().getApprovalHistoryUsersCount();
	}
	 ...
	 */
	public static ApprovalHistoryUser updateApprovalHistoryUser(
		ApprovalHistoryUser approvalHistoryUser) {

		return getService().updateApprovalHistoryUser(approvalHistoryUser);
	}

	public static ApprovalHistoryUserLocalService getService() {
		return _service;
	}

	private static volatile ApprovalHistoryUserLocalService _service;
