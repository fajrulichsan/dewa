...
/**
 * The persistence utility for the ticket service. This utility wraps <code>com.astra.dewa.service.persistence.impl.TicketPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TicketUtil {
	 ...
	 */
	public static Ticket remove(String Id)
		throws com.astra.dewa.exception.NoSuchTicketException {
	 ...
	 * @throws NoSuchTicketException if a ticket with the primary key could not be found
	 */
	public static Ticket findByPrimaryKey(String Id)
		throws com.astra.dewa.exception.NoSuchTicketException {
	 ...
	 */
	public static Ticket fetchByPrimaryKey(String Id) {
