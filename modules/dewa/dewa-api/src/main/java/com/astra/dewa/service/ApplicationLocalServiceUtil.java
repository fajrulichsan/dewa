 ...
 * <code>com.astra.dewa.service.impl.ApplicationLocalServiceImpl</code> and
...
public class ApplicationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ApplicationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Application createApplication(int Id) {
		return getService().createApplication(Id);
	}
	 ...
	 */
	public static Application deleteApplication(int Id) throws PortalException {
		return getService().deleteApplication(Id);
	}
	...
	public static Application fetchApplication(int Id) {
		return getService().fetchApplication(Id);
	}
	 ...
	 * @throws PortalException if a application with the primary key could not be found
	 */
	public static Application getApplication(int Id) throws PortalException {
		return getService().getApplication(Id);
	}
