...
/**
 * Provides the local service utility for SalesReport. This utility wraps
 * <code>com.astra.dewa.service.impl.SalesReportLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SalesReportLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.SalesReportLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SalesReport addSalesReport(SalesReport salesReport) {
		return getService().addSalesReport(salesReport);
	}
	 ...
	 */
	public static SalesReport createSalesReport(int Id) {
		return getService().createSalesReport(Id);
	}
	 ...
	 */
	public static SalesReport deleteSalesReport(int Id) throws PortalException {
		return getService().deleteSalesReport(Id);
	}
	 ...
	 * @return the sales report that was removed
	 */
	public static SalesReport deleteSalesReport(SalesReport salesReport) {
		return getService().deleteSalesReport(salesReport);
	}
	...
	public static SalesReport fetchSalesReport(int Id) {
		return getService().fetchSalesReport(Id);
	}
	 ...
	 * @throws PortalException if a sales report with the primary key could not be found
	 */
	public static SalesReport getSalesReport(int Id) throws PortalException {
		return getService().getSalesReport(Id);
	}
	 ...
	 */
	public static List<SalesReport> getSalesReports(int start, int end) {
		return getService().getSalesReports(start, end);
	}
	 ...
	 */
	public static int getSalesReportsCount() {
		return getService().getSalesReportsCount();
	}
	 ...
	 */
	public static SalesReport updateSalesReport(SalesReport salesReport) {
		return getService().updateSalesReport(salesReport);
	}

	public static SalesReportLocalService getService() {
		return _service;
	}

	private static volatile SalesReportLocalService _service;
