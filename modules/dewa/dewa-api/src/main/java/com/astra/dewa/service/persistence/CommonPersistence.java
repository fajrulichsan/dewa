...
/**
 * The persistence interface for the common service.
 *
 * <p>
 ...
 */
@ProviderType
public interface CommonPersistence extends BasePersistence<Common> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommonUtil} to access the common persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Common> commons);
	 ...
	 * @return the commons
	 */
	public java.util.List<Common> findAll();
	 ...
	 */
	public java.util.List<Common> findAll(int start, int end);
	...
	public java.util.List<Common> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Common>
			orderByComparator);
