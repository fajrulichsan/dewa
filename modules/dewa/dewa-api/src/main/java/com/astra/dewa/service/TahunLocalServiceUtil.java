...
/**
 * Provides the local service utility for Tahun. This utility wraps
 * <code>com.astra.dewa.service.impl.TahunLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TahunLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.TahunLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Tahun addTahun(Tahun tahun) {
		return getService().addTahun(tahun);
	}
	 ...
	 */
	public static Tahun createTahun(String Id) {
		return getService().createTahun(Id);
	}
	 ...
	 */
	public static Tahun deleteTahun(String Id) throws PortalException {
		return getService().deleteTahun(Id);
	}
	 ...
	 * @return the tahun that was removed
	 */
	public static Tahun deleteTahun(Tahun tahun) {
		return getService().deleteTahun(tahun);
	}
	...
	public static Tahun fetchTahun(String Id) {
		return getService().fetchTahun(Id);
	}
	 ...
	 * @throws PortalException if a tahun with the primary key could not be found
	 */
	public static Tahun getTahun(String Id) throws PortalException {
		return getService().getTahun(Id);
	}
	 ...
	 */
	public static List<Tahun> getTahuns(int start, int end) {
		return getService().getTahuns(start, end);
	}
	 ...
	 */
	public static int getTahunsCount() {
		return getService().getTahunsCount();
	}
	 ...
	 */
	public static Tahun updateTahun(Tahun tahun) {
		return getService().updateTahun(tahun);
	}

	public static TahunLocalService getService() {
		return _service;
	}

	private static volatile TahunLocalService _service;
