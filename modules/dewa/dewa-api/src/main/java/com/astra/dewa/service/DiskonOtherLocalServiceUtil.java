...
/**
 * Provides the local service utility for DiskonOther. This utility wraps
 * <code>com.astra.dewa.service.impl.DiskonOtherLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DiskonOtherLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.DiskonOtherLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DiskonOther addDiskonOther(DiskonOther diskonOther) {
		return getService().addDiskonOther(diskonOther);
	}
	 ...
	 */
	public static DiskonOther createDiskonOther(long diskonOtherId) {
		return getService().createDiskonOther(diskonOtherId);
	}
	 ...
	 */
	public static DiskonOther deleteDiskonOther(DiskonOther diskonOther) {
		return getService().deleteDiskonOther(diskonOther);
	}
	 ...
	 */
	public static DiskonOther deleteDiskonOther(long diskonOtherId)
		throws PortalException {

		return getService().deleteDiskonOther(diskonOtherId);
	}
	...
	public static DiskonOther fetchDiskonOther(long diskonOtherId) {
		return getService().fetchDiskonOther(diskonOtherId);
	}
	 ...
	 * @throws PortalException if a diskon other with the primary key could not be found
	 */
	public static DiskonOther getDiskonOther(long diskonOtherId)
		throws PortalException {

		return getService().getDiskonOther(diskonOtherId);
	}
	 ...
	 */
	public static List<DiskonOther> getDiskonOthers(int start, int end) {
		return getService().getDiskonOthers(start, end);
	}
	 ...
	 */
	public static int getDiskonOthersCount() {
		return getService().getDiskonOthersCount();
	}
	 ...
	 */
	public static DiskonOther updateDiskonOther(DiskonOther diskonOther) {
		return getService().updateDiskonOther(diskonOther);
	}

	public static DiskonOtherLocalService getService() {
		return _service;
	}

	private static volatile DiskonOtherLocalService _service;
