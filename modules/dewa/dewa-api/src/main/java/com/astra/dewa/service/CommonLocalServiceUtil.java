...
/**
 * Provides the local service utility for Common. This utility wraps
 * <code>com.astra.dewa.service.impl.CommonLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CommonLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.CommonLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Common addCommon(Common common) {
		return getService().addCommon(common);
	}
	 ...
	 */
	public static Common createCommon(String CommonKey) {
		return getService().createCommon(CommonKey);
	}
	 ...
	 */
	public static Common deleteCommon(Common common) {
		return getService().deleteCommon(common);
	}
	 ...
	 */
	public static Common deleteCommon(String CommonKey) throws PortalException {
		return getService().deleteCommon(CommonKey);
	}
	...
	public static Common fetchCommon(String CommonKey) {
		return getService().fetchCommon(CommonKey);
	}
	 ...
	 * @throws PortalException if a common with the primary key could not be found
	 */
	public static Common getCommon(String CommonKey) throws PortalException {
		return getService().getCommon(CommonKey);
	}
	 ...
	 */
	public static List<Common> getCommons(int start, int end) {
		return getService().getCommons(start, end);
	}
	 ...
	 */
	public static int getCommonsCount() {
		return getService().getCommonsCount();
	}
	 ...
	 */
	public static Common updateCommon(Common common) {
		return getService().updateCommon(common);
	}

	public static CommonLocalService getService() {
		return _service;
	}

	private static volatile CommonLocalService _service;
