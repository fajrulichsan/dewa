...
/**
 * Provides the local service utility for ReportPlafond. This utility wraps
 * <code>com.astra.dewa.service.impl.ReportPlafondLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ReportPlafondLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ReportPlafondLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ReportPlafond addReportPlafond(ReportPlafond reportPlafond) {
		return getService().addReportPlafond(reportPlafond);
	}
	 ...
	 */
	public static ReportPlafond createReportPlafond(int Id) {
		return getService().createReportPlafond(Id);
	}
	 ...
	 */
	public static ReportPlafond deleteReportPlafond(int Id)
		throws PortalException {

		return getService().deleteReportPlafond(Id);
	}
	 ...
	 * @return the report plafond that was removed
	 */
	public static ReportPlafond deleteReportPlafond(
		ReportPlafond reportPlafond) {

		return getService().deleteReportPlafond(reportPlafond);
	}
	...
	public static ReportPlafond fetchReportPlafond(int Id) {
		return getService().fetchReportPlafond(Id);
	}
	 ...
	 * @throws PortalException if a report plafond with the primary key could not be found
	 */
	public static ReportPlafond getReportPlafond(int Id)
		throws PortalException {

		return getService().getReportPlafond(Id);
	}
	 ...
	 */
	public static List<ReportPlafond> getReportPlafonds(int start, int end) {
		return getService().getReportPlafonds(start, end);
	}
	 ...
	 */
	public static int getReportPlafondsCount() {
		return getService().getReportPlafondsCount();
	}
	 ...
	 */
	public static ReportPlafond updateReportPlafond(
		ReportPlafond reportPlafond) {

		return getService().updateReportPlafond(reportPlafond);
	}

	public static ReportPlafondLocalService getService() {
		return _service;
	}

	private static volatile ReportPlafondLocalService _service;
