...
/**
 * Provides the local service utility for Cabang. This utility wraps
 * <code>com.astra.dewa.service.impl.CabangLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CabangLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.CabangLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Cabang addCabang(Cabang cabang) {
		return getService().addCabang(cabang);
	}
	 ...
	 */
	public static Cabang createCabang(int Id) {
		return getService().createCabang(Id);
	}
	 ...
	 */
	public static Cabang deleteCabang(Cabang cabang) {
		return getService().deleteCabang(cabang);
	}
	 ...
	 */
	public static Cabang deleteCabang(int Id) throws PortalException {
		return getService().deleteCabang(Id);
	}
	...
	public static Cabang fetchCabang(int Id) {
		return getService().fetchCabang(Id);
	}
	 ...
	 * @throws PortalException if a cabang with the primary key could not be found
	 */
	public static Cabang getCabang(int Id) throws PortalException {
		return getService().getCabang(Id);
	}
	 ...
	 */
	public static List<Cabang> getCabangs(int start, int end) {
		return getService().getCabangs(start, end);
	}
	 ...
	 */
	public static int getCabangsCount() {
		return getService().getCabangsCount();
	}
	 ...
	 */
	public static Cabang updateCabang(Cabang cabang) {
		return getService().updateCabang(cabang);
	}

	public static CabangLocalService getService() {
		return _service;
	}

	private static volatile CabangLocalService _service;
