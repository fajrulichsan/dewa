...
/**
 * Provides the local service utility for MenuAuthorization. This utility wraps
 * <code>com.astra.dewa.service.impl.MenuAuthorizationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MenuAuthorizationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.MenuAuthorizationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MenuAuthorization addMenuAuthorization(
		MenuAuthorization menuAuthorization) {

		return getService().addMenuAuthorization(menuAuthorization);
	}
	 ...
	 */
	public static MenuAuthorization createMenuAuthorization(int Id) {
		return getService().createMenuAuthorization(Id);
	}
	 ...
	 */
	public static MenuAuthorization deleteMenuAuthorization(int Id)
		throws PortalException {

		return getService().deleteMenuAuthorization(Id);
	}
	 ...
	 * @return the menu authorization that was removed
	 */
	public static MenuAuthorization deleteMenuAuthorization(
		MenuAuthorization menuAuthorization) {

		return getService().deleteMenuAuthorization(menuAuthorization);
	}
	...
	public static MenuAuthorization fetchMenuAuthorization(int Id) {
		return getService().fetchMenuAuthorization(Id);
	}
	 ...
	 * @throws PortalException if a menu authorization with the primary key could not be found
	 */
	public static MenuAuthorization getMenuAuthorization(int Id)
		throws PortalException {

		return getService().getMenuAuthorization(Id);
	}
	 ...
	 */
	public static List<MenuAuthorization> getMenuAuthorizations(
		int start, int end) {

		return getService().getMenuAuthorizations(start, end);
	}
	 ...
	 */
	public static int getMenuAuthorizationsCount() {
		return getService().getMenuAuthorizationsCount();
	}
	 ...
	 */
	public static MenuAuthorization updateMenuAuthorization(
		MenuAuthorization menuAuthorization) {

		return getService().updateMenuAuthorization(menuAuthorization);
	}

	public static MenuAuthorizationLocalService getService() {
		return _service;
	}

	private static volatile MenuAuthorizationLocalService _service;
