...
/**
 * Provides the local service utility for UserRoleType. This utility wraps
 * <code>com.astra.dewa.service.impl.UserRoleTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserRoleTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.UserRoleTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static UserRoleType addUserRoleType(UserRoleType userRoleType) {
		return getService().addUserRoleType(userRoleType);
	}
	 ...
	 */
	public static UserRoleType createUserRoleType(int Id) {
		return getService().createUserRoleType(Id);
	}
	 ...
	 */
	public static UserRoleType deleteUserRoleType(int Id)
		throws PortalException {

		return getService().deleteUserRoleType(Id);
	}
	 ...
	 * @return the user role type that was removed
	 */
	public static UserRoleType deleteUserRoleType(UserRoleType userRoleType) {
		return getService().deleteUserRoleType(userRoleType);
	}
	...
	public static UserRoleType fetchUserRoleType(int Id) {
		return getService().fetchUserRoleType(Id);
	}
	 ...
	 * @throws PortalException if a user role type with the primary key could not be found
	 */
	public static UserRoleType getUserRoleType(int Id) throws PortalException {
		return getService().getUserRoleType(Id);
	}
	 ...
	 */
	public static List<UserRoleType> getUserRoleTypes(int start, int end) {
		return getService().getUserRoleTypes(start, end);
	}
	 ...
	 */
	public static int getUserRoleTypesCount() {
		return getService().getUserRoleTypesCount();
	}
	 ...
	 */
	public static UserRoleType updateUserRoleType(UserRoleType userRoleType) {
		return getService().updateUserRoleType(userRoleType);
	}

	public static UserRoleTypeLocalService getService() {
		return _service;
	}

	private static volatile UserRoleTypeLocalService _service;
