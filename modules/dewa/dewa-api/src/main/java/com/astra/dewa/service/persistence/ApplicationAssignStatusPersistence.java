...
/**
 * The persistence interface for the application assign status service.
 *
 * <p>
 ...
 * @see ApplicationAssignStatusUtil
 * @generated
 */
@ProviderType
public interface ApplicationAssignStatusPersistence
	extends BasePersistence<ApplicationAssignStatus> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApplicationAssignStatusUtil} to access the application assign status persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<ApplicationAssignStatus> applicationAssignStatuses);
	 ...
	 */
	public java.util.List<ApplicationAssignStatus> findAll();
	 ...
	 */
	public java.util.List<ApplicationAssignStatus> findAll(int start, int end);
	...
	public java.util.List<ApplicationAssignStatus> findAll(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<ApplicationAssignStatus> orderByComparator);
