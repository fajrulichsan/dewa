...
/**
 * The persistence interface for the kuartal service.
 *
 * <p>
 ...
 */
@ProviderType
public interface KuartalPersistence extends BasePersistence<Kuartal> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KuartalUtil} to access the kuartal persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Kuartal> kuartals);
	 ...
	 * @return the kuartals
	 */
	public java.util.List<Kuartal> findAll();
	 ...
	 */
	public java.util.List<Kuartal> findAll(int start, int end);
	...
	public java.util.List<Kuartal> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Kuartal>
			orderByComparator);
