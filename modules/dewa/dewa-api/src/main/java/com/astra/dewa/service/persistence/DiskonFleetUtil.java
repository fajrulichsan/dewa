...
/**
 * The persistence utility for the diskon fleet service. This utility wraps <code>com.astra.dewa.service.persistence.impl.DiskonFleetPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see DiskonFleetPersistence
 * @generated
 */
public class DiskonFleetUtil {
	 ...
	 */
	public static void clearCache(DiskonFleet diskonFleet) {
		getPersistence().clearCache(diskonFleet);
	}
	 ...
	 */
	public static Map<Serializable, DiskonFleet> fetchByPrimaryKeys(
	 ...
	 */
	public static List<DiskonFleet> findWithDynamicQuery(
	...
	public static List<DiskonFleet> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<DiskonFleet> orderByComparator) {
	 ...
	 */
	public static DiskonFleet update(DiskonFleet diskonFleet) {
		return getPersistence().update(diskonFleet);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static DiskonFleet update(
		DiskonFleet diskonFleet, ServiceContext serviceContext) {

		return getPersistence().update(diskonFleet, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(DiskonFleet diskonFleet) {
		getPersistence().cacheResult(diskonFleet);
	}
	 ...
	 */
	public static void cacheResult(List<DiskonFleet> diskonFleets) {
		getPersistence().cacheResult(diskonFleets);
	}
	 ...
	 */
	public static DiskonFleet create(int Id) {
	 ...
	 */
	public static DiskonFleet remove(int Id)
		throws com.astra.dewa.exception.NoSuchDiskonFleetException {

		return getPersistence().remove(Id);
	}

	public static DiskonFleet updateImpl(DiskonFleet diskonFleet) {
		return getPersistence().updateImpl(diskonFleet);
	}
	 ...
	 * @throws NoSuchDiskonFleetException if a diskon fleet with the primary key could not be found
	 */
	public static DiskonFleet findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchDiskonFleetException {
	 ...
	 */
	public static DiskonFleet fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<DiskonFleet> findAll() {
	 ...
	 */
	public static List<DiskonFleet> findAll(int start, int end) {
	...
	public static DiskonFleetPersistence getPersistence() {
		return _persistence;
	}

	private static volatile DiskonFleetPersistence _persistence;
