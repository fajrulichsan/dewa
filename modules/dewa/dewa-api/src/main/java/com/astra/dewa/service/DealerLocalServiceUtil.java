 ...
 * <code>com.astra.dewa.service.impl.DealerLocalServiceImpl</code> and
...
public class DealerLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.DealerLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Dealer createDealer(int Id) {
		return getService().createDealer(Id);
	}
	 ...
	 */
	public static Dealer deleteDealer(int Id) throws PortalException {
		return getService().deleteDealer(Id);
	}
	...
	public static Dealer fetchDealer(int Id) {
		return getService().fetchDealer(Id);
	}
	 ...
	 * @throws PortalException if a dealer with the primary key could not be found
	 */
	public static Dealer getDealer(int Id) throws PortalException {
		return getService().getDealer(Id);
	}
