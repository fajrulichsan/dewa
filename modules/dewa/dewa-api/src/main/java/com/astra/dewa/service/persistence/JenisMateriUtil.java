...
/**
 * The persistence utility for the jenis materi service. This utility wraps <code>com.astra.dewa.service.persistence.impl.JenisMateriPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see JenisMateriPersistence
 * @generated
 */
public class JenisMateriUtil {
	 ...
	 */
	public static void clearCache(JenisMateri jenisMateri) {
		getPersistence().clearCache(jenisMateri);
	}
	 ...
	 */
	public static Map<Serializable, JenisMateri> fetchByPrimaryKeys(
	 ...
	 */
	public static List<JenisMateri> findWithDynamicQuery(
	...
	public static List<JenisMateri> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<JenisMateri> orderByComparator) {
	 ...
	 */
	public static JenisMateri update(JenisMateri jenisMateri) {
		return getPersistence().update(jenisMateri);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static JenisMateri update(
		JenisMateri jenisMateri, ServiceContext serviceContext) {

		return getPersistence().update(jenisMateri, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(JenisMateri jenisMateri) {
		getPersistence().cacheResult(jenisMateri);
	}
	 ...
	 */
	public static void cacheResult(List<JenisMateri> jenisMateris) {
		getPersistence().cacheResult(jenisMateris);
	}
	 ...
	 */
	public static JenisMateri create(int Id) {
	 ...
	 */
	public static JenisMateri remove(int Id)
		throws com.astra.dewa.exception.NoSuchJenisMateriException {

		return getPersistence().remove(Id);
	}

	public static JenisMateri updateImpl(JenisMateri jenisMateri) {
		return getPersistence().updateImpl(jenisMateri);
	}
	 ...
	 * @throws NoSuchJenisMateriException if a jenis materi with the primary key could not be found
	 */
	public static JenisMateri findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchJenisMateriException {
	 ...
	 */
	public static JenisMateri fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<JenisMateri> findAll() {
	 ...
	 */
	public static List<JenisMateri> findAll(int start, int end) {
	...
	public static JenisMateriPersistence getPersistence() {
		return _persistence;
	}

	private static volatile JenisMateriPersistence _persistence;
