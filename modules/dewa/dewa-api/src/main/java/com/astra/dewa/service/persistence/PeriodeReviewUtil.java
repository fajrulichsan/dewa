...
/**
 * The persistence utility for the periode review service. This utility wraps <code>com.astra.dewa.service.persistence.impl.PeriodeReviewPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see PeriodeReviewPersistence
 * @generated
 */
public class PeriodeReviewUtil {
	 ...
	 */
	public static void clearCache(PeriodeReview periodeReview) {
		getPersistence().clearCache(periodeReview);
	}
	 ...
	 */
	public static Map<Serializable, PeriodeReview> fetchByPrimaryKeys(
	 ...
	 */
	public static List<PeriodeReview> findWithDynamicQuery(
	 ...
	 */
	public static PeriodeReview update(PeriodeReview periodeReview) {
		return getPersistence().update(periodeReview);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static PeriodeReview update(
		PeriodeReview periodeReview, ServiceContext serviceContext) {

		return getPersistence().update(periodeReview, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(PeriodeReview periodeReview) {
		getPersistence().cacheResult(periodeReview);
	}
	 ...
	 */
	public static void cacheResult(List<PeriodeReview> periodeReviews) {
		getPersistence().cacheResult(periodeReviews);
	}
	 ...
	 */
	public static PeriodeReview create(String Id) {
	 ...
	 */
	public static PeriodeReview remove(String Id)
		throws com.astra.dewa.exception.NoSuchPeriodeReviewException {

		return getPersistence().remove(Id);
	}

	public static PeriodeReview updateImpl(PeriodeReview periodeReview) {
		return getPersistence().updateImpl(periodeReview);
	}
	 ...
	 * @throws NoSuchPeriodeReviewException if a periode review with the primary key could not be found
	 */
	public static PeriodeReview findByPrimaryKey(String Id)
		throws com.astra.dewa.exception.NoSuchPeriodeReviewException {
	 ...
	 */
	public static PeriodeReview fetchByPrimaryKey(String Id) {
	 ...
	 */
	public static List<PeriodeReview> findAll() {
	 ...
	 */
	public static List<PeriodeReview> findAll(int start, int end) {
	...
	public static PeriodeReviewPersistence getPersistence() {
		return _persistence;
	}

	private static volatile PeriodeReviewPersistence _persistence;
