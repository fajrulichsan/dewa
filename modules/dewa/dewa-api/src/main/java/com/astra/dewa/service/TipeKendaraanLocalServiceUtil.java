...
/**
 * Provides the local service utility for TipeKendaraan. This utility wraps
 * <code>com.astra.dewa.service.impl.TipeKendaraanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TipeKendaraanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.TipeKendaraanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TipeKendaraan addTipeKendaraan(TipeKendaraan tipeKendaraan) {
		return getService().addTipeKendaraan(tipeKendaraan);
	}
	 ...
	 */
	public static TipeKendaraan createTipeKendaraan(int Id) {
		return getService().createTipeKendaraan(Id);
	}
	 ...
	 */
	public static TipeKendaraan deleteTipeKendaraan(int Id)
		throws PortalException {

		return getService().deleteTipeKendaraan(Id);
	}
	 ...
	 * @return the tipe kendaraan that was removed
	 */
	public static TipeKendaraan deleteTipeKendaraan(
		TipeKendaraan tipeKendaraan) {

		return getService().deleteTipeKendaraan(tipeKendaraan);
	}
	...
	public static TipeKendaraan fetchTipeKendaraan(int Id) {
		return getService().fetchTipeKendaraan(Id);
	}
	 ...
	 * @throws PortalException if a tipe kendaraan with the primary key could not be found
	 */
	public static TipeKendaraan getTipeKendaraan(int Id)
		throws PortalException {

		return getService().getTipeKendaraan(Id);
	}
	 ...
	 */
	public static List<TipeKendaraan> getTipeKendaraans(int start, int end) {
		return getService().getTipeKendaraans(start, end);
	}
	 ...
	 */
	public static int getTipeKendaraansCount() {
		return getService().getTipeKendaraansCount();
	}
	 ...
	 */
	public static TipeKendaraan updateTipeKendaraan(
		TipeKendaraan tipeKendaraan) {

		return getService().updateTipeKendaraan(tipeKendaraan);
	}

	public static TipeKendaraanLocalService getService() {
		return _service;
	}

	private static volatile TipeKendaraanLocalService _service;
