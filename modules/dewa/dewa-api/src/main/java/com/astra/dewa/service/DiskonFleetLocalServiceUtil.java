...
/**
 * Provides the local service utility for DiskonFleet. This utility wraps
 * <code>com.astra.dewa.service.impl.DiskonFleetLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DiskonFleetLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.DiskonFleetLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DiskonFleet addDiskonFleet(DiskonFleet diskonFleet) {
		return getService().addDiskonFleet(diskonFleet);
	}
	 ...
	 */
	public static DiskonFleet createDiskonFleet(int Id) {
		return getService().createDiskonFleet(Id);
	}
	 ...
	 */
	public static DiskonFleet deleteDiskonFleet(DiskonFleet diskonFleet) {
		return getService().deleteDiskonFleet(diskonFleet);
	}
	 ...
	 */
	public static DiskonFleet deleteDiskonFleet(int Id) throws PortalException {
		return getService().deleteDiskonFleet(Id);
	}
	...
	public static DiskonFleet fetchDiskonFleet(int Id) {
		return getService().fetchDiskonFleet(Id);
	}
	 ...
	 * @throws PortalException if a diskon fleet with the primary key could not be found
	 */
	public static DiskonFleet getDiskonFleet(int Id) throws PortalException {
		return getService().getDiskonFleet(Id);
	}
	 ...
	 */
	public static List<DiskonFleet> getDiskonFleets(int start, int end) {
		return getService().getDiskonFleets(start, end);
	}
	 ...
	 */
	public static int getDiskonFleetsCount() {
		return getService().getDiskonFleetsCount();
	}
	 ...
	 */
	public static DiskonFleet updateDiskonFleet(DiskonFleet diskonFleet) {
		return getService().updateDiskonFleet(diskonFleet);
	}

	public static DiskonFleetLocalService getService() {
		return _service;
	}

	private static volatile DiskonFleetLocalService _service;
