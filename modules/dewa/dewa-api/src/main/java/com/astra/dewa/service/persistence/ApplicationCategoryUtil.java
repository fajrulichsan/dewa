...
/**
 * The persistence utility for the application category service. This utility wraps <code>com.astra.dewa.service.persistence.impl.ApplicationCategoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ApplicationCategoryPersistence
 * @generated
 */
public class ApplicationCategoryUtil {
	 ...
	 */
	public static void clearCache(ApplicationCategory applicationCategory) {
		getPersistence().clearCache(applicationCategory);
	}
	 ...
	 */
	public static Map<Serializable, ApplicationCategory> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ApplicationCategory> findWithDynamicQuery(
	 ...
	 */
	public static ApplicationCategory update(
		ApplicationCategory applicationCategory) {

		return getPersistence().update(applicationCategory);
	}
	...
	public static ApplicationCategory update(
		...
		return getPersistence().update(applicationCategory, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(ApplicationCategory applicationCategory) {
		getPersistence().cacheResult(applicationCategory);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(applicationCategories);
	}
	 ...
	 */
	public static ApplicationCategory create(int Id) {
	 ...
	 */
	public static ApplicationCategory remove(int Id)
		throws com.astra.dewa.exception.NoSuchApplicationCategoryException {

		return getPersistence().remove(Id);
	}

	public static ApplicationCategory updateImpl(
		ApplicationCategory applicationCategory) {

		return getPersistence().updateImpl(applicationCategory);
	}
	 ...
	 * @throws NoSuchApplicationCategoryException if a application category with the primary key could not be found
	 */
	public static ApplicationCategory findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchApplicationCategoryException {
	 ...
	 */
	public static ApplicationCategory fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<ApplicationCategory> findAll(int start, int end) {
	...
	public static ApplicationCategoryPersistence getPersistence() {
		return _persistence;
	}

	private static volatile ApplicationCategoryPersistence _persistence;
