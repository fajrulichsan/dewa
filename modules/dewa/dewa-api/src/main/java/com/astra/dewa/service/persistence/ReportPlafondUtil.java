...
/**
 * The persistence utility for the report plafond service. This utility wraps <code>com.astra.dewa.service.persistence.impl.ReportPlafondPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ReportPlafondPersistence
 * @generated
 */
public class ReportPlafondUtil {
	 ...
	 */
	public static void clearCache(ReportPlafond reportPlafond) {
		getPersistence().clearCache(reportPlafond);
	}
	 ...
	 */
	public static Map<Serializable, ReportPlafond> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ReportPlafond> findWithDynamicQuery(
	 ...
	 */
	public static ReportPlafond update(ReportPlafond reportPlafond) {
		return getPersistence().update(reportPlafond);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static ReportPlafond update(
		ReportPlafond reportPlafond, ServiceContext serviceContext) {

		return getPersistence().update(reportPlafond, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(ReportPlafond reportPlafond) {
		getPersistence().cacheResult(reportPlafond);
	}
	 ...
	 */
	public static void cacheResult(List<ReportPlafond> reportPlafonds) {
		getPersistence().cacheResult(reportPlafonds);
	}
	 ...
	 */
	public static ReportPlafond create(int Id) {
	 ...
	 */
	public static ReportPlafond remove(int Id)
		throws com.astra.dewa.exception.NoSuchReportPlafondException {

		return getPersistence().remove(Id);
	}

	public static ReportPlafond updateImpl(ReportPlafond reportPlafond) {
		return getPersistence().updateImpl(reportPlafond);
	}
	 ...
	 * @throws NoSuchReportPlafondException if a report plafond with the primary key could not be found
	 */
	public static ReportPlafond findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchReportPlafondException {
	 ...
	 */
	public static ReportPlafond fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<ReportPlafond> findAll() {
	 ...
	 */
	public static List<ReportPlafond> findAll(int start, int end) {
	...
	public static ReportPlafondPersistence getPersistence() {
		return _persistence;
	}

	private static volatile ReportPlafondPersistence _persistence;
