...
/**
 * Provides the local service utility for MasterApprovalJournal. This utility wraps
 * <code>com.astra.dewa.service.impl.MasterApprovalJournalLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MasterApprovalJournalLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.MasterApprovalJournalLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MasterApprovalJournal addMasterApprovalJournal(
		MasterApprovalJournal masterApprovalJournal) {

		return getService().addMasterApprovalJournal(masterApprovalJournal);
	}
	 ...
	 */
	public static MasterApprovalJournal createMasterApprovalJournal(int Id) {
		return getService().createMasterApprovalJournal(Id);
	}
	 ...
	 */
	public static MasterApprovalJournal deleteMasterApprovalJournal(int Id)
		throws PortalException {

		return getService().deleteMasterApprovalJournal(Id);
	}
	 ...
	 * @return the master approval journal that was removed
	 */
	public static MasterApprovalJournal deleteMasterApprovalJournal(
		MasterApprovalJournal masterApprovalJournal) {

		return getService().deleteMasterApprovalJournal(masterApprovalJournal);
	}
	...
	public static MasterApprovalJournal fetchMasterApprovalJournal(int Id) {
		return getService().fetchMasterApprovalJournal(Id);
	}
	 ...
	 * @throws PortalException if a master approval journal with the primary key could not be found
	 */
	public static MasterApprovalJournal getMasterApprovalJournal(int Id)
		throws PortalException {

		return getService().getMasterApprovalJournal(Id);
	}
	 ...
	 */
	public static List<MasterApprovalJournal> getMasterApprovalJournals(
		int start, int end) {

		return getService().getMasterApprovalJournals(start, end);
	}
	 ...
	 */
	public static int getMasterApprovalJournalsCount() {
		return getService().getMasterApprovalJournalsCount();
	}
	 ...
	 */
	public static MasterApprovalJournal updateMasterApprovalJournal(
		MasterApprovalJournal masterApprovalJournal) {

		return getService().updateMasterApprovalJournal(masterApprovalJournal);
	}

	public static MasterApprovalJournalLocalService getService() {
		return _service;
	}

	private static volatile MasterApprovalJournalLocalService _service;
