...
/**
 * Provides the local service utility for ApplicationAssignStatus. This utility wraps
 * <code>com.astra.dewa.service.impl.ApplicationAssignStatusLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ApplicationAssignStatusLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ApplicationAssignStatusLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ApplicationAssignStatus addApplicationAssignStatus(
		ApplicationAssignStatus applicationAssignStatus) {

		return getService().addApplicationAssignStatus(applicationAssignStatus);
	}
	 ...
	 */
	public static ApplicationAssignStatus createApplicationAssignStatus(
		int Id) {

		return getService().createApplicationAssignStatus(Id);
	}
	 ...
	 */
	public static ApplicationAssignStatus deleteApplicationAssignStatus(
		ApplicationAssignStatus applicationAssignStatus) {

		return getService().deleteApplicationAssignStatus(
	 ...
	 */
	public static ApplicationAssignStatus deleteApplicationAssignStatus(int Id)
		throws PortalException {

		return getService().deleteApplicationAssignStatus(Id);
	}
	...
	public static ApplicationAssignStatus fetchApplicationAssignStatus(int Id) {
		return getService().fetchApplicationAssignStatus(Id);
	}
	 ...
	 * @throws PortalException if a application assign status with the primary key could not be found
	 */
	public static ApplicationAssignStatus getApplicationAssignStatus(int Id)
		throws PortalException {

		return getService().getApplicationAssignStatus(Id);
	}
	 ...
	 */
	public static List<ApplicationAssignStatus> getApplicationAssignStatuses(
		int start, int end) {

		return getService().getApplicationAssignStatuses(start, end);
	}
	 ...
	 */
	public static int getApplicationAssignStatusesCount() {
		return getService().getApplicationAssignStatusesCount();
	}
	 ...
	 */
	public static ApplicationAssignStatus updateApplicationAssignStatus(
		ApplicationAssignStatus applicationAssignStatus) {

		return getService().updateApplicationAssignStatus(
			applicationAssignStatus);
	}

	public static ApplicationAssignStatusLocalService getService() {
		return _service;
	}

	private static volatile ApplicationAssignStatusLocalService _service;
