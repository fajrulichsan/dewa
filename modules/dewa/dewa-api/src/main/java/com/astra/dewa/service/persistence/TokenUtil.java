...
/**
 * The persistence utility for the token service. This utility wraps <code>com.astra.dewa.service.persistence.impl.TokenPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TokenUtil {
	 ...
	 */
	public static Map<Serializable, Token> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Token> findWithDynamicQuery(
	 ...
	 */
	public static Token remove(int Id)
		throws com.astra.dewa.exception.NoSuchTokenException {
	 ...
	 * @throws NoSuchTokenException if a token with the primary key could not be found
	 */
	public static Token findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchTokenException {
	 ...
	 */
	public static Token fetchByPrimaryKey(int Id) {
	...
	private static volatile TokenPersistence _persistence;
