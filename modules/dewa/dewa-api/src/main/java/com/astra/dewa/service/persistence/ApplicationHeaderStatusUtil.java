...
/**
 * The persistence utility for the application header status service. This utility wraps <code>com.astra.dewa.service.persistence.impl.ApplicationHeaderStatusPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ApplicationHeaderStatusPersistence
 * @generated
 */
public class ApplicationHeaderStatusUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(applicationHeaderStatus);
	}
	 ...
	 */
	public static Map<Serializable, ApplicationHeaderStatus> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ApplicationHeaderStatus> findWithDynamicQuery(
	 ...
	 */
	public static ApplicationHeaderStatus update(
		ApplicationHeaderStatus applicationHeaderStatus) {

		return getPersistence().update(applicationHeaderStatus);
	}
	...
	public static ApplicationHeaderStatus update(
		...
		return getPersistence().update(applicationHeaderStatus, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(applicationHeaderStatus);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(applicationHeaderStatuses);
	}
	 ...
	 */
	public static ApplicationHeaderStatus create(int Id) {
	 ...
	 */
	public static ApplicationHeaderStatus remove(int Id)
		throws com.astra.dewa.exception.NoSuchApplicationHeaderStatusException {

		return getPersistence().remove(Id);
	}

	public static ApplicationHeaderStatus updateImpl(
		ApplicationHeaderStatus applicationHeaderStatus) {

		return getPersistence().updateImpl(applicationHeaderStatus);
	}
	 ...
	 * @throws NoSuchApplicationHeaderStatusException if a application header status with the primary key could not be found
	 */
	public static ApplicationHeaderStatus findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchApplicationHeaderStatusException {
	 ...
	 */
	public static ApplicationHeaderStatus fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<ApplicationHeaderStatus> findAll() {
	 ...
	 */
	public static List<ApplicationHeaderStatus> findAll(int start, int end) {
	...
	public static ApplicationHeaderStatusPersistence getPersistence() {
		return _persistence;
	}

	private static volatile ApplicationHeaderStatusPersistence _persistence;
