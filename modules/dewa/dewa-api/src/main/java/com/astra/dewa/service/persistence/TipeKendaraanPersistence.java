...
/**
 * The persistence interface for the tipe kendaraan service.
 *
 * <p>
 ...
 * @see TipeKendaraanUtil
 * @generated
 */
@ProviderType
public interface TipeKendaraanPersistence
	extends BasePersistence<TipeKendaraan> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TipeKendaraanUtil} to access the tipe kendaraan persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<TipeKendaraan> tipeKendaraans);
	 ...
	 */
	public java.util.List<TipeKendaraan> findAll();
	 ...
	 */
	public java.util.List<TipeKendaraan> findAll(int start, int end);
	...
	public java.util.List<TipeKendaraan> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<TipeKendaraan>
			orderByComparator);
