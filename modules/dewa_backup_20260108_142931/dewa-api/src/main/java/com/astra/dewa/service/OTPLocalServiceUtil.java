 ...
 * <code>com.astra.dewa.service.impl.OTPLocalServiceImpl</code> and
...
public class OTPLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.OTPLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 * @return the new otp
	 */
	public static OTP createOTP(int Id) {
		return getService().createOTP(Id);
	}
	 ...
	 */
	public static OTP deleteOTP(int Id) throws PortalException {
		return getService().deleteOTP(Id);
	}
	...
	public static OTP fetchOTP(int Id) {
		return getService().fetchOTP(Id);
	}
	 ...
	 * @throws PortalException if a otp with the primary key could not be found
	 */
	public static OTP getOTP(int Id) throws PortalException {
		return getService().getOTP(Id);
	}
