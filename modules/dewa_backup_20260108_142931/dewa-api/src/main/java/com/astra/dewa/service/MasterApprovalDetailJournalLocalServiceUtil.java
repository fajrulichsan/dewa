...
/**
 * Provides the local service utility for MasterApprovalDetailJournal. This utility wraps
 * <code>com.astra.dewa.service.impl.MasterApprovalDetailJournalLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MasterApprovalDetailJournalLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.MasterApprovalDetailJournalLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MasterApprovalDetailJournal addMasterApprovalDetailJournal(
		MasterApprovalDetailJournal masterApprovalDetailJournal) {

		return getService().addMasterApprovalDetailJournal(
	 ...
	 */
	public static MasterApprovalDetailJournal createMasterApprovalDetailJournal(
		int Id) {

		return getService().createMasterApprovalDetailJournal(Id);
	}
	 ...
	 */
	public static MasterApprovalDetailJournal deleteMasterApprovalDetailJournal(
			int Id)
		throws PortalException {

		return getService().deleteMasterApprovalDetailJournal(Id);
	}
	...
	public static MasterApprovalDetailJournal deleteMasterApprovalDetailJournal(
		...
		return getService().deleteMasterApprovalDetailJournal(
			masterApprovalDetailJournal);
	}
	...
	public static MasterApprovalDetailJournal fetchMasterApprovalDetailJournal(
		int Id) {

		return getService().fetchMasterApprovalDetailJournal(Id);
	}
	 ...
	 * @throws PortalException if a master approval detail journal with the primary key could not be found
	 */
	public static MasterApprovalDetailJournal getMasterApprovalDetailJournal(
			int Id)
		throws PortalException {

		return getService().getMasterApprovalDetailJournal(Id);
	}
	 ...
	 */
	public static List<MasterApprovalDetailJournal>
		getMasterApprovalDetailJournals(int start, int end) {

		return getService().getMasterApprovalDetailJournals(start, end);
	}
	 ...
	 */
	public static int getMasterApprovalDetailJournalsCount() {
		return getService().getMasterApprovalDetailJournalsCount();
	}
	 ...
	 */
	public static MasterApprovalDetailJournal updateMasterApprovalDetailJournal(
		MasterApprovalDetailJournal masterApprovalDetailJournal) {

		return getService().updateMasterApprovalDetailJournal(
			masterApprovalDetailJournal);
	}

	public static MasterApprovalDetailJournalLocalService getService() {
		return _service;
	}

	private static volatile MasterApprovalDetailJournalLocalService _service;
