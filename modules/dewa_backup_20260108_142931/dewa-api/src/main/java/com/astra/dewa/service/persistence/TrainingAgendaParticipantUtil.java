...
/**
 * The persistence utility for the training agenda participant service. This utility wraps <code>com.astra.dewa.service.persistence.impl.TrainingAgendaParticipantPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TrainingAgendaParticipantPersistence
 * @generated
 */
public class TrainingAgendaParticipantUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(trainingAgendaParticipant);
	}
	 ...
	 */
	public static Map<Serializable, TrainingAgendaParticipant>
	 ...
	 */
	public static List<TrainingAgendaParticipant> findWithDynamicQuery(
	 ...
	 */
	public static TrainingAgendaParticipant update(
		TrainingAgendaParticipant trainingAgendaParticipant) {

		return getPersistence().update(trainingAgendaParticipant);
	}
	...
	public static TrainingAgendaParticipant update(
		...
		return getPersistence().update(
			trainingAgendaParticipant, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(trainingAgendaParticipant);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(trainingAgendaParticipants);
	}
	 ...
	 */
	public static TrainingAgendaParticipant create(int Id) {
	 ...
	 */
	public static TrainingAgendaParticipant remove(int Id)
		throws com.astra.dewa.exception.
			NoSuchTrainingAgendaParticipantException {

		return getPersistence().remove(Id);
	}

	public static TrainingAgendaParticipant updateImpl(
		TrainingAgendaParticipant trainingAgendaParticipant) {

		return getPersistence().updateImpl(trainingAgendaParticipant);
	}
	 ...
	 * @throws NoSuchTrainingAgendaParticipantException if a training agenda participant with the primary key could not be found
	 */
	public static TrainingAgendaParticipant findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.
			NoSuchTrainingAgendaParticipantException {
	 ...
	 */
	public static TrainingAgendaParticipant fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<TrainingAgendaParticipant> findAll() {
	 ...
	 */
	public static List<TrainingAgendaParticipant> findAll(int start, int end) {
	...
	public static TrainingAgendaParticipantPersistence getPersistence() {
		return _persistence;
	}

	private static volatile TrainingAgendaParticipantPersistence _persistence;
