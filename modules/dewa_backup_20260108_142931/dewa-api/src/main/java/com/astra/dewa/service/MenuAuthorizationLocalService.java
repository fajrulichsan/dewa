...
/**
 * Provides the local service interface for MenuAuthorization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MenuAuthorizationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MenuAuthorizationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.astra.dewa.service.impl.MenuAuthorizationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the menu authorization local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MenuAuthorizationLocalServiceUtil} if injection and service tracking are not available.
	 */
