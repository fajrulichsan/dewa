...
/**
 * The persistence utility for the training agenda participant uf service. This utility wraps <code>com.astra.dewa.service.persistence.impl.TrainingAgendaParticipantUfPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TrainingAgendaParticipantUfPersistence
 * @generated
 */
public class TrainingAgendaParticipantUfUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(trainingAgendaParticipantUf);
	}
	 ...
	 */
	public static Map<Serializable, TrainingAgendaParticipantUf>
	 ...
	 */
	public static List<TrainingAgendaParticipantUf> findWithDynamicQuery(
	 ...
	 */
	public static TrainingAgendaParticipantUf update(
		TrainingAgendaParticipantUf trainingAgendaParticipantUf) {

		return getPersistence().update(trainingAgendaParticipantUf);
	}
	...
	public static TrainingAgendaParticipantUf update(
		...
		return getPersistence().update(
			trainingAgendaParticipantUf, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(trainingAgendaParticipantUf);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(trainingAgendaParticipantUfs);
	}
	 ...
	 */
	public static TrainingAgendaParticipantUf create(int Id) {
	 ...
	 */
	public static TrainingAgendaParticipantUf remove(int Id)
		throws com.astra.dewa.exception.
			NoSuchTrainingAgendaParticipantUfException {

		return getPersistence().remove(Id);
	}

	public static TrainingAgendaParticipantUf updateImpl(
		TrainingAgendaParticipantUf trainingAgendaParticipantUf) {

		return getPersistence().updateImpl(trainingAgendaParticipantUf);
	}
	 ...
	 * @throws NoSuchTrainingAgendaParticipantUfException if a training agenda participant uf with the primary key could not be found
	 */
	public static TrainingAgendaParticipantUf findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.
			NoSuchTrainingAgendaParticipantUfException {
	 ...
	 */
	public static TrainingAgendaParticipantUf fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<TrainingAgendaParticipantUf> findAll() {
	...
	public static TrainingAgendaParticipantUfPersistence getPersistence() {
		return _persistence;
	}

	private static volatile TrainingAgendaParticipantUfPersistence _persistence;
