...
/**
 * Provides the local service interface for TrainingMateriLampiran. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TrainingMateriLampiranLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TrainingMateriLampiranLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.astra.dewa.service.impl.TrainingMateriLampiranLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the training materi lampiran local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TrainingMateriLampiranLocalServiceUtil} if injection and service tracking are not available.
	 */
