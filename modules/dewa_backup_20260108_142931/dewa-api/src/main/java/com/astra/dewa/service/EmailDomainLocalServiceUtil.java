...
/**
 * Provides the local service utility for EmailDomain. This utility wraps
 * <code>com.astra.dewa.service.impl.EmailDomainLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EmailDomainLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.EmailDomainLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EmailDomain addEmailDomain(EmailDomain emailDomain) {
		return getService().addEmailDomain(emailDomain);
	}
	 ...
	 */
	public static EmailDomain createEmailDomain(int Id) {
		return getService().createEmailDomain(Id);
	}
	 ...
	 */
	public static EmailDomain deleteEmailDomain(EmailDomain emailDomain) {
		return getService().deleteEmailDomain(emailDomain);
	}
	 ...
	 */
	public static EmailDomain deleteEmailDomain(int Id) throws PortalException {
		return getService().deleteEmailDomain(Id);
	}
	...
	public static EmailDomain fetchEmailDomain(int Id) {
		return getService().fetchEmailDomain(Id);
	}
	 ...
	 * @throws PortalException if a email domain with the primary key could not be found
	 */
	public static EmailDomain getEmailDomain(int Id) throws PortalException {
		return getService().getEmailDomain(Id);
	}
	 ...
	 */
	public static List<EmailDomain> getEmailDomains(int start, int end) {
		return getService().getEmailDomains(start, end);
	}
	 ...
	 */
	public static int getEmailDomainsCount() {
		return getService().getEmailDomainsCount();
	}
	 ...
	 */
	public static EmailDomain updateEmailDomain(EmailDomain emailDomain) {
		return getService().updateEmailDomain(emailDomain);
	}

	public static EmailDomainLocalService getService() {
		return _service;
	}

	private static volatile EmailDomainLocalService _service;
