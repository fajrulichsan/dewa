...
/**
 * Provides the local service utility for DiskonTestCar. This utility wraps
 * <code>com.astra.dewa.service.impl.DiskonTestCarLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DiskonTestCarLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.DiskonTestCarLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DiskonTestCar addDiskonTestCar(DiskonTestCar diskonTestCar) {
		return getService().addDiskonTestCar(diskonTestCar);
	}
	 ...
	 */
	public static DiskonTestCar createDiskonTestCar(int Id) {
		return getService().createDiskonTestCar(Id);
	}
	 ...
	 */
	public static DiskonTestCar deleteDiskonTestCar(
		DiskonTestCar diskonTestCar) {

		return getService().deleteDiskonTestCar(diskonTestCar);
	}
	 ...
	 */
	public static DiskonTestCar deleteDiskonTestCar(int Id)
		throws PortalException {

		return getService().deleteDiskonTestCar(Id);
	}
	...
	public static DiskonTestCar fetchDiskonTestCar(int Id) {
		return getService().fetchDiskonTestCar(Id);
	}
	 ...
	 * @throws PortalException if a diskon test car with the primary key could not be found
	 */
	public static DiskonTestCar getDiskonTestCar(int Id)
		throws PortalException {

		return getService().getDiskonTestCar(Id);
	}
	 ...
	 */
	public static List<DiskonTestCar> getDiskonTestCars(int start, int end) {
		return getService().getDiskonTestCars(start, end);
	}
	 ...
	 */
	public static int getDiskonTestCarsCount() {
		return getService().getDiskonTestCarsCount();
	}
	 ...
	 */
	public static DiskonTestCar updateDiskonTestCar(
		DiskonTestCar diskonTestCar) {

		return getService().updateDiskonTestCar(diskonTestCar);
	}

	public static DiskonTestCarLocalService getService() {
		return _service;
	}

	private static volatile DiskonTestCarLocalService _service;
