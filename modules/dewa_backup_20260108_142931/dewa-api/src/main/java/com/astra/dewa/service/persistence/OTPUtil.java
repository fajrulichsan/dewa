...
public class OTPUtil {
	 ...
	 * @return the new otp
	 */
	public static OTP create(int Id) {
	 ...
	 */
	public static OTP remove(int Id)
		throws com.astra.dewa.exception.NoSuchOTPException {
	 ...
	 * @throws NoSuchOTPException if a otp with the primary key could not be found
	 */
	public static OTP findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchOTPException {
	 ...
	 */
	public static OTP fetchByPrimaryKey(int Id) {
	...
	private static volatile OTPPersistence _persistence;
