...
/**
 * Provides the local service utility for ESrut. This utility wraps
 * <code>com.astra.dewa.service.impl.ESrutLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ESrutLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.ESrutLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ESrut addESrut(ESrut eSrut) {
		return getService().addESrut(eSrut);
	}
	 ...
	 */
	public static ESrut createESrut(int Id) {
		return getService().createESrut(Id);
	}
	 ...
	 */
	public static ESrut deleteESrut(ESrut eSrut) {
		return getService().deleteESrut(eSrut);
	}
	 ...
	 */
	public static ESrut deleteESrut(int Id) throws PortalException {
		return getService().deleteESrut(Id);
	}
	...
	public static ESrut fetchESrut(int Id) {
		return getService().fetchESrut(Id);
	}
	 ...
	 * @throws PortalException if a e srut with the primary key could not be found
	 */
	public static ESrut getESrut(int Id) throws PortalException {
		return getService().getESrut(Id);
	}
	 ...
	 */
	public static List<ESrut> getESruts(int start, int end) {
		return getService().getESruts(start, end);
	}
	 ...
	 */
	public static int getESrutsCount() {
		return getService().getESrutsCount();
	}
	 ...
	 */
	public static ESrut updateESrut(ESrut eSrut) {
		return getService().updateESrut(eSrut);
	}

	public static ESrutLocalService getService() {
		return _service;
	}

	private static volatile ESrutLocalService _service;
