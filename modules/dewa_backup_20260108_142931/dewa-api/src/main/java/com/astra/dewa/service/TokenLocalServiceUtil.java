 ...
 * <code>com.astra.dewa.service.impl.TokenLocalServiceImpl</code> and
...
public class TokenLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.TokenLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Token createToken(int Id) {
		return getService().createToken(Id);
	}
	 ...
	 */
	public static Token deleteToken(int Id) throws PortalException {
		return getService().deleteToken(Id);
	}
	 ...
	 * @return the token that was removed
	 */
	public static Token deleteToken(Token token) {
	...
	public static Token fetchToken(int Id) {
		return getService().fetchToken(Id);
	}
	 ...
	 * @throws PortalException if a token with the primary key could not be found
	 */
	public static Token getToken(int Id) throws PortalException {
		return getService().getToken(Id);
	}
	 ...
	 */
	public static List<Token> getTokens(int start, int end) {
	...
	private static volatile TokenLocalService _service;
