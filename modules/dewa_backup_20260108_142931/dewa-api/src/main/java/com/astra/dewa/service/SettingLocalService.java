...
/**
 * Provides the local service interface for Setting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SettingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SettingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.astra.dewa.service.impl.SettingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the setting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SettingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Setting findCredential(String KeySetting, String code)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Setting> getMailKey(String KeySetting)
		throws NoSuchSettingException;
