...
/**
 * Provides the local service utility for Setting. This utility wraps
 * <code>com.astra.dewa.service.impl.SettingLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SettingLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.SettingLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Setting addSetting(Setting setting) {
		return getService().addSetting(setting);
	}
	...
	public static Setting createSetting(int Id) {
		return getService().createSetting(Id);
	}
	 ...
	 */
	public static Setting deleteSetting(int Id) throws PortalException {
		return getService().deleteSetting(Id);
	}
	 ...
	 * @return the setting that was removed
	 */
	public static Setting deleteSetting(Setting setting) {
		return getService().deleteSetting(setting);
	}
	...
	public static Setting fetchSetting(int Id) {
		return getService().fetchSetting(Id);
	}

	public static Setting findCredential(String KeySetting, String code)
		throws com.astra.dewa.exception.NoSuchSettingException {

		return getService().findCredential(KeySetting, code);
	}
	...
	public static List<Setting> getMailKey(String KeySetting)
		throws com.astra.dewa.exception.NoSuchSettingException {

		return getService().getMailKey(KeySetting);
	}
	 ...
	 * @throws PortalException if a setting with the primary key could not be found
	 */
	public static Setting getSetting(int Id) throws PortalException {
		return getService().getSetting(Id);
	}
	 ...
	 */
	public static List<Setting> getSettings(int start, int end) {
		return getService().getSettings(start, end);
	}
	...
	public static int getSettingsCount() {
		return getService().getSettingsCount();
	}
	 ...
	 */
	public static Setting updateSetting(Setting setting) {
		return getService().updateSetting(setting);
	}

	public static SettingLocalService getService() {
		return _service;
	}

	private static volatile SettingLocalService _service;
