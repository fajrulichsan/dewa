...
/**
 * Provides the local service interface for UsersDealers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UsersDealersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UsersDealersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.astra.dewa.service.impl.UsersDealersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the users dealers local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UsersDealersLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UsersDealers createDealerUserWithRoles(
	...
	@Transactional(rollbackFor = Exception.class)
	public UsersDealers deleteDealerUserWithRoles(UsersDealers dealerUser)
		throws SystemException;
	...
	public UsersDealers findUsersDealersIdFromUserId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UsersDealers> getDealerUsers(
