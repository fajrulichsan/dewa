...
/**
 * The persistence utility for the menu authorization service. This utility wraps <code>com.astra.dewa.service.persistence.impl.MenuAuthorizationPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see MenuAuthorizationPersistence
 * @generated
 */
public class MenuAuthorizationUtil {
	 ...
	 */
	public static void clearCache(MenuAuthorization menuAuthorization) {
		getPersistence().clearCache(menuAuthorization);
	}
	 ...
	 */
	public static Map<Serializable, MenuAuthorization> fetchByPrimaryKeys(
	 ...
	 */
	public static List<MenuAuthorization> findWithDynamicQuery(
	 ...
	 */
	public static MenuAuthorization update(
		MenuAuthorization menuAuthorization) {

		return getPersistence().update(menuAuthorization);
	}
	 ...
	 */
	public static MenuAuthorization update(
		MenuAuthorization menuAuthorization, ServiceContext serviceContext) {

		return getPersistence().update(menuAuthorization, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(MenuAuthorization menuAuthorization) {
		getPersistence().cacheResult(menuAuthorization);
	}
	 ...
	 */
	public static void cacheResult(List<MenuAuthorization> menuAuthorizations) {
		getPersistence().cacheResult(menuAuthorizations);
	}
	 ...
	 */
	public static MenuAuthorization create(int Id) {
	 ...
	 */
	public static MenuAuthorization remove(int Id)
		throws com.astra.dewa.exception.NoSuchMenuAuthorizationException {

		return getPersistence().remove(Id);
	}

	public static MenuAuthorization updateImpl(
		MenuAuthorization menuAuthorization) {

		return getPersistence().updateImpl(menuAuthorization);
	}
	 ...
	 * @throws NoSuchMenuAuthorizationException if a menu authorization with the primary key could not be found
	 */
	public static MenuAuthorization findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchMenuAuthorizationException {
	 ...
	 */
	public static MenuAuthorization fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<MenuAuthorization> findAll() {
	 ...
	 */
	public static List<MenuAuthorization> findAll(int start, int end) {
	...
	public static MenuAuthorizationPersistence getPersistence() {
		return _persistence;
	}

	private static volatile MenuAuthorizationPersistence _persistence;
