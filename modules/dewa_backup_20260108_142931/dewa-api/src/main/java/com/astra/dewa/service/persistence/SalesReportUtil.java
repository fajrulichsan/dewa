...
/**
 * The persistence utility for the sales report service. This utility wraps <code>com.astra.dewa.service.persistence.impl.SalesReportPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SalesReportUtil {
	 ...
	 */
	public static void clearCache(SalesReport salesReport) {
		getPersistence().clearCache(salesReport);
	}
	 ...
	 */
	public static Map<Serializable, SalesReport> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SalesReport> findWithDynamicQuery(
	...
	public static List<SalesReport> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<SalesReport> orderByComparator) {
	 ...
	 */
	public static SalesReport update(SalesReport salesReport) {
		return getPersistence().update(salesReport);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static SalesReport update(
		SalesReport salesReport, ServiceContext serviceContext) {

		return getPersistence().update(salesReport, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(SalesReport salesReport) {
		getPersistence().cacheResult(salesReport);
	}
	 ...
	 */
	public static void cacheResult(List<SalesReport> salesReports) {
		getPersistence().cacheResult(salesReports);
	}
	 ...
	 */
	public static SalesReport create(int Id) {
	 ...
	 */
	public static SalesReport remove(int Id)
		throws com.astra.dewa.exception.NoSuchSalesReportException {

		return getPersistence().remove(Id);
	}

	public static SalesReport updateImpl(SalesReport salesReport) {
		return getPersistence().updateImpl(salesReport);
	}
	 ...
	 * @throws NoSuchSalesReportException if a sales report with the primary key could not be found
	 */
	public static SalesReport findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchSalesReportException {
	 ...
	 */
	public static SalesReport fetchByPrimaryKey(int Id) {
	 ...
	 */
	public static List<SalesReport> findAll() {
	 ...
	 */
	public static List<SalesReport> findAll(int start, int end) {
	...
	public static SalesReportPersistence getPersistence() {
		return _persistence;
	}

	private static volatile SalesReportPersistence _persistence;
