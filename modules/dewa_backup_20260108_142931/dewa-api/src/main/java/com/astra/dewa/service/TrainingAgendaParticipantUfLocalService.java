...
/**
 * Provides the local service interface for TrainingAgendaParticipantUf. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TrainingAgendaParticipantUfLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TrainingAgendaParticipantUfLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.astra.dewa.service.impl.TrainingAgendaParticipantUfLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the training agenda participant uf local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TrainingAgendaParticipantUfLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TrainingAgendaParticipantUf fetchTrainingAgendaParticipantUf(int Id);
