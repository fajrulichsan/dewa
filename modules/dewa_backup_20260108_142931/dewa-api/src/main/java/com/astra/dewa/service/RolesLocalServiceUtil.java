...
/**
 * Provides the local service utility for Roles. This utility wraps
 * <code>com.astra.dewa.service.impl.RolesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RolesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.RolesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Roles addRoles(Roles roles) {
		return getService().addRoles(roles);
	}
	...
	public static Roles createRoles(int Id) {
		return getService().createRoles(Id);
	}
	 ...
	 */
	public static Roles deleteRoles(int Id) throws PortalException {
		return getService().deleteRoles(Id);
	}
	 ...
	 * @return the roles that was removed
	 */
	public static Roles deleteRoles(Roles roles) {
		return getService().deleteRoles(roles);
	}
	...
	public static Roles fetchRoles(int Id) {
		return getService().fetchRoles(Id);
	}
	 ...
	 * @throws PortalException if a roles with the primary key could not be found
	 */
	public static Roles getRoles(int Id) throws PortalException {
		return getService().getRoles(Id);
	}
	 ...
	 */
	public static List<Roles> getRoleses(int start, int end) {
		return getService().getRoleses(start, end);
	}
	 ...
	 */
	public static int getRolesesCount() {
		return getService().getRolesesCount();
	}
	 ...
	 */
	public static Roles updateRoles(Roles roles) {
		return getService().updateRoles(roles);
	}

	public static RolesLocalService getService() {
		return _service;
	}

	private static volatile RolesLocalService _service;
