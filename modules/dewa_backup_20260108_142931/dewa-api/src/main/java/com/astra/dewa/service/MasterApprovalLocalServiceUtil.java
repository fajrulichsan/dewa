...
/**
 * Provides the local service utility for MasterApproval. This utility wraps
 * <code>com.astra.dewa.service.impl.MasterApprovalLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MasterApprovalLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.MasterApprovalLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MasterApproval addMasterApproval(
		MasterApproval masterApproval) {

		return getService().addMasterApproval(masterApproval);
	}
	 ...
	 */
	public static MasterApproval createMasterApproval(int Id) {
		return getService().createMasterApproval(Id);
	}
	 ...
	 */
	public static MasterApproval deleteMasterApproval(int Id)
		throws PortalException {

		return getService().deleteMasterApproval(Id);
	}
	 ...
	 * @return the master approval that was removed
	 */
	public static MasterApproval deleteMasterApproval(
		MasterApproval masterApproval) {

		return getService().deleteMasterApproval(masterApproval);
	}
	...
	public static MasterApproval fetchMasterApproval(int Id) {
		return getService().fetchMasterApproval(Id);
	}
	 ...
	 * @throws PortalException if a master approval with the primary key could not be found
	 */
	public static MasterApproval getMasterApproval(int Id)
		throws PortalException {

		return getService().getMasterApproval(Id);
	}
	 ...
	 */
	public static List<MasterApproval> getMasterApprovals(int start, int end) {
		return getService().getMasterApprovals(start, end);
	}
	 ...
	 */
	public static int getMasterApprovalsCount() {
		return getService().getMasterApprovalsCount();
	}
	 ...
	 */
	public static MasterApproval updateMasterApproval(
		MasterApproval masterApproval) {

		return getService().updateMasterApproval(masterApproval);
	}

	public static MasterApprovalLocalService getService() {
		return _service;
	}

	private static volatile MasterApprovalLocalService _service;
