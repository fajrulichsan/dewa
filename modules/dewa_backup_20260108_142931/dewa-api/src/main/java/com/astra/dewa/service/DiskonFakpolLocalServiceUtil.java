...
/**
 * Provides the local service utility for DiskonFakpol. This utility wraps
 * <code>com.astra.dewa.service.impl.DiskonFakpolLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DiskonFakpolLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.DiskonFakpolLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DiskonFakpol addDiskonFakpol(DiskonFakpol diskonFakpol) {
		return getService().addDiskonFakpol(diskonFakpol);
	}
	 ...
	 */
	public static DiskonFakpol createDiskonFakpol(int Id) {
		return getService().createDiskonFakpol(Id);
	}
	 ...
	 */
	public static DiskonFakpol deleteDiskonFakpol(DiskonFakpol diskonFakpol) {
		return getService().deleteDiskonFakpol(diskonFakpol);
	}
	 ...
	 */
	public static DiskonFakpol deleteDiskonFakpol(int Id)
		throws PortalException {

		return getService().deleteDiskonFakpol(Id);
	}
	...
	public static DiskonFakpol fetchDiskonFakpol(int Id) {
		return getService().fetchDiskonFakpol(Id);
	}
	 ...
	 * @throws PortalException if a diskon fakpol with the primary key could not be found
	 */
	public static DiskonFakpol getDiskonFakpol(int Id) throws PortalException {
		return getService().getDiskonFakpol(Id);
	}
	 ...
	 */
	public static List<DiskonFakpol> getDiskonFakpols(int start, int end) {
		return getService().getDiskonFakpols(start, end);
	}
	 ...
	 */
	public static int getDiskonFakpolsCount() {
		return getService().getDiskonFakpolsCount();
	}
	 ...
	 */
	public static DiskonFakpol updateDiskonFakpol(DiskonFakpol diskonFakpol) {
		return getService().updateDiskonFakpol(diskonFakpol);
	}

	public static DiskonFakpolLocalService getService() {
		return _service;
	}

	private static volatile DiskonFakpolLocalService _service;
