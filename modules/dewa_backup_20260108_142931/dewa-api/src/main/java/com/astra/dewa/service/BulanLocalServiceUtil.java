...
/**
 * Provides the local service utility for Bulan. This utility wraps
 * <code>com.astra.dewa.service.impl.BulanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BulanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.astra.dewa.service.impl.BulanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Bulan addBulan(Bulan bulan) {
		return getService().addBulan(bulan);
	}
	 ...
	 */
	public static Bulan createBulan(String Id) {
		return getService().createBulan(Id);
	}
	 ...
	 */
	public static Bulan deleteBulan(Bulan bulan) {
		return getService().deleteBulan(bulan);
	}
	 ...
	 */
	public static Bulan deleteBulan(String Id) throws PortalException {
		return getService().deleteBulan(Id);
	}
	...
	public static Bulan fetchBulan(String Id) {
		return getService().fetchBulan(Id);
	}
	 ...
	 * @throws PortalException if a bulan with the primary key could not be found
	 */
	public static Bulan getBulan(String Id) throws PortalException {
		return getService().getBulan(Id);
	}
	 ...
	 */
	public static List<Bulan> getBulans(int start, int end) {
		return getService().getBulans(start, end);
	}
	 ...
	 */
	public static int getBulansCount() {
		return getService().getBulansCount();
	}
	 ...
	 */
	public static Bulan updateBulan(Bulan bulan) {
		return getService().updateBulan(bulan);
	}

	public static BulanLocalService getService() {
		return _service;
	}

	private static volatile BulanLocalService _service;
