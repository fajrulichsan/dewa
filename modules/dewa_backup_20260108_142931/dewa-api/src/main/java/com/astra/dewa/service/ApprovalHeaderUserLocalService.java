...
/**
 * Provides the local service interface for ApprovalHeaderUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ApprovalHeaderUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ApprovalHeaderUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.astra.dewa.service.impl.ApprovalHeaderUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the approval header user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ApprovalHeaderUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ApprovalHeaderUser createApprovalHeaderUserWithHistoryAndDetails(
	...
	@Transactional(rollbackFor = Exception.class)
	public ApprovalHeaderUser updateApprovalHeaderUserWithHistory(
			ApprovalHeaderUser approvalHeaderUser)
		throws SystemException;
