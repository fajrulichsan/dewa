...
public class ApplicationUtil {
	 ...
	 */
	public static Application create(int Id) {
	 ...
	 */
	public static Application remove(int Id)
		throws com.astra.dewa.exception.NoSuchApplicationException {
	 ...
	 * @throws NoSuchApplicationException if a application with the primary key could not be found
	 */
	public static Application findByPrimaryKey(int Id)
		throws com.astra.dewa.exception.NoSuchApplicationException {
	 ...
	 */
	public static Application fetchByPrimaryKey(int Id) {
