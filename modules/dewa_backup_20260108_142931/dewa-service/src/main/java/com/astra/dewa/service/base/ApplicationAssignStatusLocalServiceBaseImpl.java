...
import com.astra.dewa.service.ApplicationAssignStatusLocalService;
...
/**
 * Provides the base implementation for the application assign status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationAssignStatusLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationAssignStatusLocalServiceImpl
 * @generated
 */
public abstract class ApplicationAssignStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationAssignStatusLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationAssignStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationAssignStatusLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApplicationAssignStatus addApplicationAssignStatus(
		ApplicationAssignStatus applicationAssignStatus) {

		applicationAssignStatus.setNew(true);

		return applicationAssignStatusPersistence.update(
	...
	public ApplicationAssignStatus createApplicationAssignStatus(int Id) {
		return applicationAssignStatusPersistence.create(Id);
	}
	...
	@Override
	public ApplicationAssignStatus deleteApplicationAssignStatus(int Id)
		throws PortalException {

		return applicationAssignStatusPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationAssignStatus deleteApplicationAssignStatus(
		ApplicationAssignStatus applicationAssignStatus) {

		return applicationAssignStatusPersistence.remove(
			applicationAssignStatus);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationAssignStatusPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationAssignStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationAssignStatusPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationAssignStatusPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApplicationAssignStatus fetchApplicationAssignStatus(int Id) {
		return applicationAssignStatusPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApplicationAssignStatus getApplicationAssignStatus(int Id)
		throws PortalException {

		return applicationAssignStatusPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationAssignStatus.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationAssignStatusPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationAssignStatusLocalServiceImpl#deleteApplicationAssignStatus(ApplicationAssignStatus) to avoid orphaned data");
		}

		return applicationAssignStatusLocalService.
			deleteApplicationAssignStatus(
				(ApplicationAssignStatus)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationAssignStatus> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationAssignStatusPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplicationAssignStatus> getApplicationAssignStatuses(
		int start, int end) {

		return applicationAssignStatusPersistence.findAll(start, end);
	}
	...
	public int getApplicationAssignStatusesCount() {
		return applicationAssignStatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationAssignStatus updateApplicationAssignStatus(
		ApplicationAssignStatus applicationAssignStatus) {
	 ...
	 */
	public ApplicationAssignStatusLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(applicationAssignStatusLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationAssignStatusLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationAssignStatusPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationAssignStatusLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationAssignStatusLocalService);
		}
	...
	@BeanReference(type = ApplicationAssignStatusLocalService.class)
	protected ApplicationAssignStatusLocalService
		applicationAssignStatusLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationAssignStatusLocalServiceBaseImpl.class);
