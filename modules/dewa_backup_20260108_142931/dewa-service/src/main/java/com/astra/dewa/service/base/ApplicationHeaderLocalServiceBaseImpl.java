...
import com.astra.dewa.service.ApplicationHeaderLocalService;
...
/**
 * Provides the base implementation for the application header local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationHeaderLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationHeaderLocalServiceImpl
 * @generated
 */
public abstract class ApplicationHeaderLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationHeaderLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationHeaderLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationHeaderLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApplicationHeader addApplicationHeader(
		ApplicationHeader applicationHeader) {

		applicationHeader.setNew(true);

		return applicationHeaderPersistence.update(applicationHeader);
	}
	...
	public ApplicationHeader createApplicationHeader(int Id) {
		return applicationHeaderPersistence.create(Id);
	}
	...
	@Override
	public ApplicationHeader deleteApplicationHeader(int Id)
		throws PortalException {

		return applicationHeaderPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationHeader deleteApplicationHeader(
		ApplicationHeader applicationHeader) {

		return applicationHeaderPersistence.remove(applicationHeader);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationHeaderPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationHeader.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationHeaderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return applicationHeaderPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationHeaderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return applicationHeaderPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ApplicationHeader fetchApplicationHeader(int Id) {
		return applicationHeaderPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApplicationHeader getApplicationHeader(int Id)
		throws PortalException {

		return applicationHeaderPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationHeader.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ApplicationHeader.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationHeaderPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationHeaderLocalServiceImpl#deleteApplicationHeader(ApplicationHeader) to avoid orphaned data");
		}

		return applicationHeaderLocalService.deleteApplicationHeader(
			(ApplicationHeader)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationHeader> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationHeaderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplicationHeader> getApplicationHeaders(int start, int end) {
		return applicationHeaderPersistence.findAll(start, end);
	}
	...
	public int getApplicationHeadersCount() {
		return applicationHeaderPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationHeader updateApplicationHeader(
		ApplicationHeader applicationHeader) {
	 ...
	 */
	public ApplicationHeaderLocalService getApplicationHeaderLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ApplicationHeader",
			applicationHeaderLocalService);

		_setLocalServiceUtilService(applicationHeaderLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationHeaderLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationHeaderPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationHeaderLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationHeaderLocalService);
		}
	...
	@BeanReference(type = ApplicationHeaderLocalService.class)
	protected ApplicationHeaderLocalService applicationHeaderLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationHeaderLocalServiceBaseImpl.class);
