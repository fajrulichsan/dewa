...
import com.astra.dewa.service.MenuAuthorizationLocalService;
...
/**
 * Provides the base implementation for the menu authorization local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.MenuAuthorizationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.MenuAuthorizationLocalServiceImpl
 * @generated
 */
public abstract class MenuAuthorizationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, MenuAuthorizationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MenuAuthorizationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MenuAuthorizationLocalServiceUtil</code>.
	 */
	...
	@Override
	public MenuAuthorization addMenuAuthorization(
		MenuAuthorization menuAuthorization) {

		menuAuthorization.setNew(true);

		return menuAuthorizationPersistence.update(menuAuthorization);
	}
	...
	public MenuAuthorization createMenuAuthorization(int Id) {
		return menuAuthorizationPersistence.create(Id);
	}
	...
	@Override
	public MenuAuthorization deleteMenuAuthorization(int Id)
		throws PortalException {

		return menuAuthorizationPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MenuAuthorization deleteMenuAuthorization(
		MenuAuthorization menuAuthorization) {

		return menuAuthorizationPersistence.remove(menuAuthorization);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return menuAuthorizationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MenuAuthorization.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return menuAuthorizationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return menuAuthorizationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return menuAuthorizationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return menuAuthorizationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MenuAuthorization fetchMenuAuthorization(int Id) {
		return menuAuthorizationPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public MenuAuthorization getMenuAuthorization(int Id)
		throws PortalException {

		return menuAuthorizationPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MenuAuthorization.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MenuAuthorization.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return menuAuthorizationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MenuAuthorizationLocalServiceImpl#deleteMenuAuthorization(MenuAuthorization) to avoid orphaned data");
		}

		return menuAuthorizationLocalService.deleteMenuAuthorization(
			(MenuAuthorization)persistedModel);
	}

	@Override
	public BasePersistence<MenuAuthorization> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return menuAuthorizationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MenuAuthorization> getMenuAuthorizations(int start, int end) {
		return menuAuthorizationPersistence.findAll(start, end);
	}
	...
	public int getMenuAuthorizationsCount() {
		return menuAuthorizationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MenuAuthorization updateMenuAuthorization(
		MenuAuthorization menuAuthorization) {
	 ...
	 */
	public MenuAuthorizationLocalService getMenuAuthorizationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.MenuAuthorization",
			menuAuthorizationLocalService);

		_setLocalServiceUtilService(menuAuthorizationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MenuAuthorizationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				menuAuthorizationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MenuAuthorizationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, menuAuthorizationLocalService);
		}
	...
	@BeanReference(type = MenuAuthorizationLocalService.class)
	protected MenuAuthorizationLocalService menuAuthorizationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MenuAuthorizationLocalServiceBaseImpl.class);
