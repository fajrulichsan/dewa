...
import com.astra.dewa.service.TrainingMateriLocalService;
...
/**
 * Provides the base implementation for the training materi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TrainingMateriLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TrainingMateriLocalServiceImpl
 * @generated
 */
public abstract class TrainingMateriLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TrainingMateriLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingMateriLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingMateriLocalServiceUtil</code>.
	 */
	...
	@Override
	public TrainingMateri addTrainingMateri(TrainingMateri trainingMateri) {
		trainingMateri.setNew(true);

		return trainingMateriPersistence.update(trainingMateri);
	}
	...
	public TrainingMateri createTrainingMateri(int Id) {
		return trainingMateriPersistence.create(Id);
	}
	...
	@Override
	public TrainingMateri deleteTrainingMateri(int Id) throws PortalException {
		return trainingMateriPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingMateri deleteTrainingMateri(TrainingMateri trainingMateri) {
		return trainingMateriPersistence.remove(trainingMateri);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return trainingMateriPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingMateri.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingMateriPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return trainingMateriPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingMateriPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return trainingMateriPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TrainingMateri fetchTrainingMateri(int Id) {
		return trainingMateriPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public TrainingMateri getTrainingMateri(int Id) throws PortalException {
		return trainingMateriPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(trainingMateriLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TrainingMateri.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TrainingMateri.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingMateriPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingMateriLocalServiceImpl#deleteTrainingMateri(TrainingMateri) to avoid orphaned data");
		}

		return trainingMateriLocalService.deleteTrainingMateri(
			(TrainingMateri)persistedModel);
	}

	@Override
	public BasePersistence<TrainingMateri> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingMateriPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingMateri> getTrainingMateris(int start, int end) {
		return trainingMateriPersistence.findAll(start, end);
	}
	...
	public int getTrainingMaterisCount() {
		return trainingMateriPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrainingMateri updateTrainingMateri(TrainingMateri trainingMateri) {
		return trainingMateriPersistence.update(trainingMateri);
	}
	 ...
	 */
	public TrainingMateriLocalService getTrainingMateriLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.TrainingMateri", trainingMateriLocalService);

		_setLocalServiceUtilService(trainingMateriLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.TrainingMateri");
	...
	public String getOSGiServiceIdentifier() {
		return TrainingMateriLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = trainingMateriPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TrainingMateriLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, trainingMateriLocalService);
		}
	...
	@BeanReference(type = TrainingMateriLocalService.class)
	protected TrainingMateriLocalService trainingMateriLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingMateriLocalServiceBaseImpl.class);
