...
import com.astra.dewa.service.SkIrisLocalService;
...
/**
 * Provides the base implementation for the sk iris local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.SkIrisLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.SkIrisLocalServiceImpl
 * @generated
 */
public abstract class SkIrisLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SkIrisLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SkIrisLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SkIrisLocalServiceUtil</code>.
	 */

	/**
	 * Adds the sk iris to the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SkIrisLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param skIris the sk iris
	 * @return the sk iris that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SkIris addSkIris(SkIris skIris) {
		skIris.setNew(true);

		return skIrisPersistence.update(skIris);
	}
	...
	public SkIris createSkIris(int Id) {
		return skIrisPersistence.create(Id);
	}

	/**
	 * Deletes the sk iris with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SkIrisLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 ...
	 * @throws PortalException if a sk iris with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SkIris deleteSkIris(int Id) throws PortalException {
		return skIrisPersistence.remove(Id);
	}

	/**
	 * Deletes the sk iris from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SkIrisLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SkIris deleteSkIris(SkIris skIris) {
		return skIrisPersistence.remove(skIris);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return skIrisPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SkIris.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return skIrisPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return skIrisPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return skIrisPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return skIrisPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return skIrisPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SkIris fetchSkIris(int Id) {
		return skIrisPersistence.fetchByPrimaryKey(Id);
	}

	/**
	 * Returns the sk iris with the primary key.
	 *
	 * @param Id the primary key of the sk iris
	 * @return the sk iris
	 * @throws PortalException if a sk iris with the primary key could not be found
	 */
	@Override
	public SkIris getSkIris(int Id) throws PortalException {
		return skIrisPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(skIrisLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SkIris.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(skIrisLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(SkIris.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return skIrisPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SkIrisLocalServiceImpl#deleteSkIris(SkIris) to avoid orphaned data");
		}

		return skIrisLocalService.deleteSkIris((SkIris)persistedModel);
	}

	@Override
	public BasePersistence<SkIris> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return skIrisPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SkIris> getSkIrises(int start, int end) {
		return skIrisPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSkIrisesCount() {
		return skIrisPersistence.countAll();
	}

	/**
	 * Updates the sk iris in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SkIrisLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param skIris the sk iris
	 * @return the sk iris that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SkIris updateSkIris(SkIris skIris) {
		return skIrisPersistence.update(skIris);
	}
	 ...
	 */
	public SkIrisLocalService getSkIrisLocalService() {
	 ...
	 */
	public void setSkIrisLocalService(SkIrisLocalService skIrisLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.SkIris", skIrisLocalService);

		_setLocalServiceUtilService(skIrisLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.SkIris");
	...
	public String getOSGiServiceIdentifier() {
		return SkIrisLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = skIrisPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		SkIrisLocalService skIrisLocalService) {

		try {
			Field field = SkIrisLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, skIrisLocalService);
		}
	...
	@BeanReference(type = SkIrisLocalService.class)
	protected SkIrisLocalService skIrisLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SkIrisLocalServiceBaseImpl.class);
