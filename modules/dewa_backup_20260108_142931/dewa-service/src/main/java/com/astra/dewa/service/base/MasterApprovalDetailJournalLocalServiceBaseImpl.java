...
import com.astra.dewa.service.MasterApprovalDetailJournalLocalService;
...
/**
 * Provides the base implementation for the master approval detail journal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.MasterApprovalDetailJournalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.MasterApprovalDetailJournalLocalServiceImpl
 * @generated
 */
public abstract class MasterApprovalDetailJournalLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterApprovalDetailJournalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterApprovalDetailJournalLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterApprovalDetailJournal addMasterApprovalDetailJournal(
		MasterApprovalDetailJournal masterApprovalDetailJournal) {

		masterApprovalDetailJournal.setNew(true);

		return masterApprovalDetailJournalPersistence.update(
	...
	public MasterApprovalDetailJournal createMasterApprovalDetailJournal(
		int Id) {

		return masterApprovalDetailJournalPersistence.create(Id);
	}
	...
	@Override
	public MasterApprovalDetailJournal deleteMasterApprovalDetailJournal(int Id)
		throws PortalException {

		return masterApprovalDetailJournalPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterApprovalDetailJournal deleteMasterApprovalDetailJournal(
		MasterApprovalDetailJournal masterApprovalDetailJournal) {

		return masterApprovalDetailJournalPersistence.remove(
			masterApprovalDetailJournal);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return masterApprovalDetailJournalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterApprovalDetailJournal.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterApprovalDetailJournalPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterApprovalDetailJournalPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public MasterApprovalDetailJournal fetchMasterApprovalDetailJournal(
		int Id) {

		return masterApprovalDetailJournalPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public MasterApprovalDetailJournal getMasterApprovalDetailJournal(int Id)
		throws PortalException {

		return masterApprovalDetailJournalPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MasterApprovalDetailJournal.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			MasterApprovalDetailJournal.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalDetailJournalPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MasterApprovalDetailJournalLocalServiceImpl#deleteMasterApprovalDetailJournal(MasterApprovalDetailJournal) to avoid orphaned data");
		}

		return masterApprovalDetailJournalLocalService.
			deleteMasterApprovalDetailJournal(
				(MasterApprovalDetailJournal)persistedModel);
	}

	@Override
	public BasePersistence<MasterApprovalDetailJournal> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalDetailJournalPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterApprovalDetailJournal> getMasterApprovalDetailJournals(
		int start, int end) {

		return masterApprovalDetailJournalPersistence.findAll(start, end);
	}
	...
	public int getMasterApprovalDetailJournalsCount() {
		return masterApprovalDetailJournalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterApprovalDetailJournal updateMasterApprovalDetailJournal(
		MasterApprovalDetailJournal masterApprovalDetailJournal) {
	 ...
	 */
	public MasterApprovalDetailJournalLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(masterApprovalDetailJournalLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterApprovalDetailJournalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				masterApprovalDetailJournalPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterApprovalDetailJournalLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, masterApprovalDetailJournalLocalService);
		}
	...
	@BeanReference(type = MasterApprovalDetailJournalLocalService.class)
	protected MasterApprovalDetailJournalLocalService
		masterApprovalDetailJournalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MasterApprovalDetailJournalLocalServiceBaseImpl.class);
