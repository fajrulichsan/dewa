...
import com.astra.dewa.service.TopikMateriLocalService;
...
/**
 * Provides the base implementation for the topik materi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TopikMateriLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TopikMateriLocalServiceImpl
 * @generated
 */
public abstract class TopikMateriLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TopikMateriLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TopikMateriLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TopikMateriLocalServiceUtil</code>.
	 */
	...
	@Override
	public TopikMateri addTopikMateri(TopikMateri topikMateri) {
		topikMateri.setNew(true);

		return topikMateriPersistence.update(topikMateri);
	}
	...
	public TopikMateri createTopikMateri(int Id) {
		return topikMateriPersistence.create(Id);
	}
	...
	@Override
	public TopikMateri deleteTopikMateri(int Id) throws PortalException {
		return topikMateriPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TopikMateri deleteTopikMateri(TopikMateri topikMateri) {
		return topikMateriPersistence.remove(topikMateri);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return topikMateriPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TopikMateri.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return topikMateriPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return topikMateriPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return topikMateriPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return topikMateriPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TopikMateri fetchTopikMateri(int Id) {
		return topikMateriPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public TopikMateri getTopikMateri(int Id) throws PortalException {
		return topikMateriPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(topikMateriLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TopikMateri.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TopikMateri.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return topikMateriPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TopikMateriLocalServiceImpl#deleteTopikMateri(TopikMateri) to avoid orphaned data");
		}

		return topikMateriLocalService.deleteTopikMateri(
			(TopikMateri)persistedModel);
	}

	@Override
	public BasePersistence<TopikMateri> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return topikMateriPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TopikMateri> getTopikMateris(int start, int end) {
		return topikMateriPersistence.findAll(start, end);
	}
	...
	public int getTopikMaterisCount() {
		return topikMateriPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TopikMateri updateTopikMateri(TopikMateri topikMateri) {
		return topikMateriPersistence.update(topikMateri);
	}
	 ...
	 */
	public TopikMateriLocalService getTopikMateriLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.TopikMateri", topikMateriLocalService);

		_setLocalServiceUtilService(topikMateriLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.TopikMateri");
	...
	public String getOSGiServiceIdentifier() {
		return TopikMateriLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = topikMateriPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TopikMateriLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, topikMateriLocalService);
		}
	...
	@BeanReference(type = TopikMateriLocalService.class)
	protected TopikMateriLocalService topikMateriLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TopikMateriLocalServiceBaseImpl.class);
