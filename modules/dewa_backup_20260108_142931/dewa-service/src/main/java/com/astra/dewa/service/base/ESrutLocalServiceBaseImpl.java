...
import com.astra.dewa.service.ESrutLocalService;
...
/**
 * Provides the base implementation for the e srut local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ESrutLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ESrutLocalServiceImpl
 * @generated
 */
public abstract class ESrutLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ESrutLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ESrutLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ESrutLocalServiceUtil</code>.
	 */
	...
	@Override
	public ESrut addESrut(ESrut eSrut) {
		eSrut.setNew(true);

		return eSrutPersistence.update(eSrut);
	}
	...
	public ESrut createESrut(int Id) {
		return eSrutPersistence.create(Id);
	}
	...
	@Override
	public ESrut deleteESrut(int Id) throws PortalException {
		return eSrutPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ESrut deleteESrut(ESrut eSrut) {
		return eSrutPersistence.remove(eSrut);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return eSrutPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ESrut.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return eSrutPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return eSrutPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return eSrutPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return eSrutPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return eSrutPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public ESrut fetchESrut(int Id) {
		return eSrutPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ESrut getESrut(int Id) throws PortalException {
		return eSrutPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(eSrutLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ESrut.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(eSrutLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ESrut.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return eSrutPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ESrutLocalServiceImpl#deleteESrut(ESrut) to avoid orphaned data");
		}

		return eSrutLocalService.deleteESrut((ESrut)persistedModel);
	}

	@Override
	public BasePersistence<ESrut> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return eSrutPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ESrut> getESruts(int start, int end) {
		return eSrutPersistence.findAll(start, end);
	}
	...
	public int getESrutsCount() {
		return eSrutPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ESrut updateESrut(ESrut eSrut) {
		return eSrutPersistence.update(eSrut);
	}
	 ...
	 */
	public ESrutLocalService getESrutLocalService() {
	 ...
	 */
	public void setESrutLocalService(ESrutLocalService eSrutLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ESrut", eSrutLocalService);

		_setLocalServiceUtilService(eSrutLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.ESrut");
	...
	public String getOSGiServiceIdentifier() {
		return ESrutLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = eSrutPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		ESrutLocalService eSrutLocalService) {

		try {
			Field field = ESrutLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, eSrutLocalService);
		}
	...
	@BeanReference(type = ESrutLocalService.class)
	protected ESrutLocalService eSrutLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ESrutLocalServiceBaseImpl.class);
