...
import com.astra.dewa.service.TahunLocalService;
import com.astra.dewa.service.TahunLocalServiceUtil;
...
/**
 * Provides the base implementation for the tahun local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TahunLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TahunLocalServiceImpl
 * @generated
 */
public abstract class TahunLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TahunLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TahunLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TahunLocalServiceUtil</code>.
	 */
	...
	@Override
	public Tahun addTahun(Tahun tahun) {
		tahun.setNew(true);

		return tahunPersistence.update(tahun);
	}
	...
	public Tahun createTahun(String Id) {
		return tahunPersistence.create(Id);
	}
	...
	@Override
	public Tahun deleteTahun(String Id) throws PortalException {
		return tahunPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Tahun deleteTahun(Tahun tahun) {
		return tahunPersistence.remove(tahun);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tahunPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Tahun.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tahunPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tahunPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tahunPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tahunPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return tahunPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Tahun fetchTahun(String Id) {
		return tahunPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Tahun getTahun(String Id) throws PortalException {
		return tahunPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tahunPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TahunLocalServiceImpl#deleteTahun(Tahun) to avoid orphaned data");
		}

		return tahunLocalService.deleteTahun((Tahun)persistedModel);
	}

	@Override
	public BasePersistence<Tahun> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return tahunPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Tahun> getTahuns(int start, int end) {
		return tahunPersistence.findAll(start, end);
	}
	...
	public int getTahunsCount() {
		return tahunPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Tahun updateTahun(Tahun tahun) {
		return tahunPersistence.update(tahun);
	}
	 ...
	 */
	public TahunLocalService getTahunLocalService() {
	 ...
	 */
	public void setTahunLocalService(TahunLocalService tahunLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Tahun", tahunLocalService);

		_setLocalServiceUtilService(tahunLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Tahun");
	...
	public String getOSGiServiceIdentifier() {
		return TahunLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = tahunPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		TahunLocalService tahunLocalService) {

		try {
			Field field = TahunLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, tahunLocalService);
		}
	...
	@BeanReference(type = TahunLocalService.class)
	protected TahunLocalService tahunLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TahunLocalServiceBaseImpl.class);
