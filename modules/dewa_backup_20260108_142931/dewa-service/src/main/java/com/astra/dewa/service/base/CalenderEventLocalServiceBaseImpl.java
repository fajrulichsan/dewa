...
import com.astra.dewa.service.CalenderEventLocalService;
...
/**
 * Provides the base implementation for the calender event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.CalenderEventLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.CalenderEventLocalServiceImpl
 * @generated
 */
public abstract class CalenderEventLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CalenderEventLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CalenderEventLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CalenderEventLocalServiceUtil</code>.
	 */
	...
	@Override
	public CalenderEvent addCalenderEvent(CalenderEvent calenderEvent) {
		calenderEvent.setNew(true);

		return calenderEventPersistence.update(calenderEvent);
	}
	...
	public CalenderEvent createCalenderEvent(int Id) {
		return calenderEventPersistence.create(Id);
	}
	...
	@Override
	public CalenderEvent deleteCalenderEvent(int Id) throws PortalException {
		return calenderEventPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CalenderEvent deleteCalenderEvent(CalenderEvent calenderEvent) {
		return calenderEventPersistence.remove(calenderEvent);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return calenderEventPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CalenderEvent.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return calenderEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return calenderEventPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return calenderEventPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return calenderEventPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CalenderEvent fetchCalenderEvent(int Id) {
		return calenderEventPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public CalenderEvent getCalenderEvent(int Id) throws PortalException {
		return calenderEventPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(calenderEventLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CalenderEvent.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CalenderEvent.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return calenderEventPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CalenderEventLocalServiceImpl#deleteCalenderEvent(CalenderEvent) to avoid orphaned data");
		}

		return calenderEventLocalService.deleteCalenderEvent(
			(CalenderEvent)persistedModel);
	}

	@Override
	public BasePersistence<CalenderEvent> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return calenderEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CalenderEvent> getCalenderEvents(int start, int end) {
		return calenderEventPersistence.findAll(start, end);
	}
	...
	public int getCalenderEventsCount() {
		return calenderEventPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CalenderEvent updateCalenderEvent(CalenderEvent calenderEvent) {
		return calenderEventPersistence.update(calenderEvent);
	}
	 ...
	 */
	public CalenderEventLocalService getCalenderEventLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.CalenderEvent", calenderEventLocalService);

		_setLocalServiceUtilService(calenderEventLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.CalenderEvent");
	...
	public String getOSGiServiceIdentifier() {
		return CalenderEventLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = calenderEventPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CalenderEventLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, calenderEventLocalService);
		}
	...
	@BeanReference(type = CalenderEventLocalService.class)
	protected CalenderEventLocalService calenderEventLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CalenderEventLocalServiceBaseImpl.class);
