...
import com.astra.dewa.service.ApplicationHeaderStatusLocalService;
...
/**
 * Provides the base implementation for the application header status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationHeaderStatusLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationHeaderStatusLocalServiceImpl
 * @generated
 */
public abstract class ApplicationHeaderStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationHeaderStatusLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationHeaderStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationHeaderStatusLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApplicationHeaderStatus addApplicationHeaderStatus(
		ApplicationHeaderStatus applicationHeaderStatus) {

		applicationHeaderStatus.setNew(true);

		return applicationHeaderStatusPersistence.update(
	...
	public ApplicationHeaderStatus createApplicationHeaderStatus(int Id) {
		return applicationHeaderStatusPersistence.create(Id);
	}
	...
	@Override
	public ApplicationHeaderStatus deleteApplicationHeaderStatus(int Id)
		throws PortalException {

		return applicationHeaderStatusPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationHeaderStatus deleteApplicationHeaderStatus(
		ApplicationHeaderStatus applicationHeaderStatus) {

		return applicationHeaderStatusPersistence.remove(
			applicationHeaderStatus);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationHeaderStatusPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationHeaderStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationHeaderStatusPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationHeaderStatusPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApplicationHeaderStatus fetchApplicationHeaderStatus(int Id) {
		return applicationHeaderStatusPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApplicationHeaderStatus getApplicationHeaderStatus(int Id)
		throws PortalException {

		return applicationHeaderStatusPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationHeaderStatus.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationHeaderStatusPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationHeaderStatusLocalServiceImpl#deleteApplicationHeaderStatus(ApplicationHeaderStatus) to avoid orphaned data");
		}

		return applicationHeaderStatusLocalService.
			deleteApplicationHeaderStatus(
				(ApplicationHeaderStatus)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationHeaderStatus> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationHeaderStatusPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplicationHeaderStatus> getApplicationHeaderStatuses(
		int start, int end) {

		return applicationHeaderStatusPersistence.findAll(start, end);
	}
	...
	public int getApplicationHeaderStatusesCount() {
		return applicationHeaderStatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationHeaderStatus updateApplicationHeaderStatus(
		ApplicationHeaderStatus applicationHeaderStatus) {
	 ...
	 */
	public ApplicationHeaderStatusLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(applicationHeaderStatusLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationHeaderStatusLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationHeaderStatusPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationHeaderStatusLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationHeaderStatusLocalService);
		}
	...
	@BeanReference(type = ApplicationHeaderStatusLocalService.class)
	protected ApplicationHeaderStatusLocalService
		applicationHeaderStatusLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationHeaderStatusLocalServiceBaseImpl.class);
