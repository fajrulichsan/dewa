...
import com.astra.dewa.service.TokenLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TokenLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TokenLocalServiceImpl
 * @generated
 */
public abstract class TokenLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TokenLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TokenLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TokenLocalServiceUtil</code>.
	 */
	...
	public Token createToken(int Id) {
		return tokenPersistence.create(Id);
	}
	...
	@Override
	public Token deleteToken(int Id) throws PortalException {
		return tokenPersistence.remove(Id);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tokenPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Token.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tokenPersistence.findWithDynamicQuery(
	...
	public Token fetchToken(int Id) {
		return tokenPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Token getToken(int Id) throws PortalException {
		return tokenPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(tokenLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Token.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(tokenLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Token.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tokenPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TokenLocalServiceImpl#deleteToken(Token) to avoid orphaned data");
		}

		return tokenLocalService.deleteToken((Token)persistedModel);
	}

	@Override
	public BasePersistence<Token> getBasePersistence() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Token", tokenLocalService);

		_setLocalServiceUtilService(tokenLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Token");
	...
	public String getOSGiServiceIdentifier() {
		return TokenLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TokenLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, tokenLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TokenLocalServiceBaseImpl.class);
