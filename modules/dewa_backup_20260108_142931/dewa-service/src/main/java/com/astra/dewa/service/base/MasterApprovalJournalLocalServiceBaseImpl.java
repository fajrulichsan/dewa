...
import com.astra.dewa.service.MasterApprovalJournalLocalService;
...
/**
 * Provides the base implementation for the master approval journal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.MasterApprovalJournalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.MasterApprovalJournalLocalServiceImpl
 * @generated
 */
public abstract class MasterApprovalJournalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, MasterApprovalJournalLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterApprovalJournalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterApprovalJournalLocalServiceUtil</code>.
	 */
	...
	public MasterApprovalJournal addMasterApprovalJournal(
		...
		return masterApprovalJournalPersistence.update(masterApprovalJournal);
	}
	...
	public MasterApprovalJournal createMasterApprovalJournal(int Id) {
		return masterApprovalJournalPersistence.create(Id);
	}
	...
	public MasterApprovalJournal deleteMasterApprovalJournal(int Id)
		...
		return masterApprovalJournalPersistence.remove(Id);
	}
	...
	public MasterApprovalJournal deleteMasterApprovalJournal(
		...
		return masterApprovalJournalPersistence.remove(masterApprovalJournal);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return masterApprovalJournalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterApprovalJournal.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterApprovalJournalPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterApprovalJournalPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public MasterApprovalJournal fetchMasterApprovalJournal(int Id) {
		return masterApprovalJournalPersistence.fetchByPrimaryKey(Id);
	}
	...
	public MasterApprovalJournal getMasterApprovalJournal(int Id)
		...
		return masterApprovalJournalPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MasterApprovalJournal.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalJournalPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MasterApprovalJournalLocalServiceImpl#deleteMasterApprovalJournal(MasterApprovalJournal) to avoid orphaned data");
		}

		return masterApprovalJournalLocalService.deleteMasterApprovalJournal(
			(MasterApprovalJournal)persistedModel);
	}

	@Override
	public BasePersistence<MasterApprovalJournal> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalJournalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MasterApprovalJournal> getMasterApprovalJournals(
		...
		return masterApprovalJournalPersistence.findAll(start, end);
	}
	...
	public int getMasterApprovalJournalsCount() {
		return masterApprovalJournalPersistence.countAll();
	}
	 ...
	 */
	public MasterApprovalJournalLocalService
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.MasterApprovalJournal",
			masterApprovalJournalLocalService);

		_setLocalServiceUtilService(masterApprovalJournalLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterApprovalJournalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				masterApprovalJournalPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterApprovalJournalLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterApprovalJournalLocalService);
		}
	...
	@BeanReference(type = MasterApprovalJournalLocalService.class)
	protected MasterApprovalJournalLocalService
		masterApprovalJournalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MasterApprovalJournalLocalServiceBaseImpl.class);
