...
import com.astra.dewa.service.KategoriDealerLocalService;
...
/**
 * Provides the base implementation for the kategori dealer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.KategoriDealerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.KategoriDealerLocalServiceImpl
 * @generated
 */
public abstract class KategoriDealerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, KategoriDealerLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>KategoriDealerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>KategoriDealerLocalServiceUtil</code>.
	 */
	...
	@Override
	public KategoriDealer addKategoriDealer(KategoriDealer kategoriDealer) {
		kategoriDealer.setNew(true);

		return kategoriDealerPersistence.update(kategoriDealer);
	}
	...
	public KategoriDealer createKategoriDealer(long Id) {
		return kategoriDealerPersistence.create(Id);
	}
	...
	@Override
	public KategoriDealer deleteKategoriDealer(long Id) throws PortalException {
		return kategoriDealerPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KategoriDealer deleteKategoriDealer(KategoriDealer kategoriDealer) {
		return kategoriDealerPersistence.remove(kategoriDealer);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return kategoriDealerPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			KategoriDealer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return kategoriDealerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return kategoriDealerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return kategoriDealerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return kategoriDealerPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public KategoriDealer fetchKategoriDealer(long Id) {
		return kategoriDealerPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public KategoriDealer getKategoriDealer(long Id) throws PortalException {
		return kategoriDealerPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(kategoriDealerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(KategoriDealer.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(KategoriDealer.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return kategoriDealerPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KategoriDealerLocalServiceImpl#deleteKategoriDealer(KategoriDealer) to avoid orphaned data");
		}

		return kategoriDealerLocalService.deleteKategoriDealer(
			(KategoriDealer)persistedModel);
	}

	@Override
	public BasePersistence<KategoriDealer> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return kategoriDealerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KategoriDealer> getKategoriDealers(int start, int end) {
		return kategoriDealerPersistence.findAll(start, end);
	}
	...
	public int getKategoriDealersCount() {
		return kategoriDealerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KategoriDealer updateKategoriDealer(KategoriDealer kategoriDealer) {
		return kategoriDealerPersistence.update(kategoriDealer);
	}
	 ...
	 */
	public KategoriDealerLocalService getKategoriDealerLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.KategoriDealer", kategoriDealerLocalService);

		_setLocalServiceUtilService(kategoriDealerLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.KategoriDealer");
	...
	public String getOSGiServiceIdentifier() {
		return KategoriDealerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = kategoriDealerPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = KategoriDealerLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, kategoriDealerLocalService);
		}
	...
	@BeanReference(type = KategoriDealerLocalService.class)
	protected KategoriDealerLocalService kategoriDealerLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		KategoriDealerLocalServiceBaseImpl.class);
