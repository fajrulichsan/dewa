...
import com.astra.dewa.service.UsersDealersLocalService;
...
/**
 * Provides the base implementation for the users dealers local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.UsersDealersLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.UsersDealersLocalServiceImpl
 * @generated
 */
public abstract class UsersDealersLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, UsersDealersLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UsersDealersLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UsersDealersLocalServiceUtil</code>.
	 */
	...
	@Override
	public UsersDealers addUsersDealers(UsersDealers usersDealers) {
		usersDealers.setNew(true);

		return usersDealersPersistence.update(usersDealers);
	}
	...
	public UsersDealers createUsersDealers(int Id) {
		return usersDealersPersistence.create(Id);
	}
	...
	@Override
	public UsersDealers deleteUsersDealers(int Id) throws PortalException {
		return usersDealersPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UsersDealers deleteUsersDealers(UsersDealers usersDealers) {
		return usersDealersPersistence.remove(usersDealers);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return usersDealersPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UsersDealers.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return usersDealersPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return usersDealersPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return usersDealersPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return usersDealersPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public UsersDealers fetchUsersDealers(int Id) {
		return usersDealersPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public UsersDealers getUsersDealers(int Id) throws PortalException {
		return usersDealersPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(usersDealersLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UsersDealers.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(UsersDealers.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return usersDealersPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement UsersDealersLocalServiceImpl#deleteUsersDealers(UsersDealers) to avoid orphaned data");
		}

		return usersDealersLocalService.deleteUsersDealers(
			(UsersDealers)persistedModel);
	}

	@Override
	public BasePersistence<UsersDealers> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return usersDealersPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UsersDealers> getUsersDealerses(int start, int end) {
		return usersDealersPersistence.findAll(start, end);
	}
	...
	public int getUsersDealersesCount() {
		return usersDealersPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UsersDealers updateUsersDealers(UsersDealers usersDealers) {
		return usersDealersPersistence.update(usersDealers);
	}
	 ...
	 */
	public UsersDealersLocalService getUsersDealersLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.UsersDealers", usersDealersLocalService);

		_setLocalServiceUtilService(usersDealersLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.UsersDealers");
	...
	public String getOSGiServiceIdentifier() {
		return UsersDealersLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = usersDealersPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = UsersDealersLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, usersDealersLocalService);
		}
	...
	@BeanReference(type = UsersDealersLocalService.class)
	protected UsersDealersLocalService usersDealersLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UsersDealersLocalServiceBaseImpl.class);
