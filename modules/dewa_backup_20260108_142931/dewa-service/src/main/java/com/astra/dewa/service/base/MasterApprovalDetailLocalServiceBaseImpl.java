...
import com.astra.dewa.service.MasterApprovalDetailLocalService;
...
/**
 * Provides the base implementation for the master approval detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.MasterApprovalDetailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.MasterApprovalDetailLocalServiceImpl
 * @generated
 */
public abstract class MasterApprovalDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, MasterApprovalDetailLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterApprovalDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterApprovalDetailLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterApprovalDetail addMasterApprovalDetail(
		MasterApprovalDetail masterApprovalDetail) {

		masterApprovalDetail.setNew(true);

		return masterApprovalDetailPersistence.update(masterApprovalDetail);
	}
	...
	public MasterApprovalDetail createMasterApprovalDetail(int Id) {
		return masterApprovalDetailPersistence.create(Id);
	}
	...
	@Override
	public MasterApprovalDetail deleteMasterApprovalDetail(int Id)
		throws PortalException {

		return masterApprovalDetailPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterApprovalDetail deleteMasterApprovalDetail(
		MasterApprovalDetail masterApprovalDetail) {

		return masterApprovalDetailPersistence.remove(masterApprovalDetail);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return masterApprovalDetailPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterApprovalDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterApprovalDetailPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterApprovalDetailPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public MasterApprovalDetail fetchMasterApprovalDetail(int Id) {
		return masterApprovalDetailPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public MasterApprovalDetail getMasterApprovalDetail(int Id)
		throws PortalException {

		return masterApprovalDetailPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MasterApprovalDetail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalDetailPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MasterApprovalDetailLocalServiceImpl#deleteMasterApprovalDetail(MasterApprovalDetail) to avoid orphaned data");
		}

		return masterApprovalDetailLocalService.deleteMasterApprovalDetail(
			(MasterApprovalDetail)persistedModel);
	}

	@Override
	public BasePersistence<MasterApprovalDetail> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterApprovalDetail> getMasterApprovalDetails(
		int start, int end) {

		return masterApprovalDetailPersistence.findAll(start, end);
	}
	...
	public int getMasterApprovalDetailsCount() {
		return masterApprovalDetailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterApprovalDetail updateMasterApprovalDetail(
		MasterApprovalDetail masterApprovalDetail) {
	 ...
	 */
	public MasterApprovalDetailLocalService
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.MasterApprovalDetail",
			masterApprovalDetailLocalService);

		_setLocalServiceUtilService(masterApprovalDetailLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterApprovalDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				masterApprovalDetailPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterApprovalDetailLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterApprovalDetailLocalService);
		}
	...
	@BeanReference(type = MasterApprovalDetailLocalService.class)
	protected MasterApprovalDetailLocalService masterApprovalDetailLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MasterApprovalDetailLocalServiceBaseImpl.class);
