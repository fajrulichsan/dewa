...
import com.astra.dewa.service.BulanLocalService;
...
/**
 * Provides the base implementation for the bulan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.BulanLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.BulanLocalServiceImpl
 * @generated
 */
public abstract class BulanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements BulanLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BulanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BulanLocalServiceUtil</code>.
	 */
	...
	@Override
	public Bulan addBulan(Bulan bulan) {
		bulan.setNew(true);

		return bulanPersistence.update(bulan);
	}
	...
	public Bulan createBulan(String Id) {
		return bulanPersistence.create(Id);
	}
	...
	@Override
	public Bulan deleteBulan(String Id) throws PortalException {
		return bulanPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Bulan deleteBulan(Bulan bulan) {
		return bulanPersistence.remove(bulan);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return bulanPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Bulan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bulanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return bulanPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return bulanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bulanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return bulanPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Bulan fetchBulan(String Id) {
		return bulanPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Bulan getBulan(String Id) throws PortalException {
		return bulanPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return bulanPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BulanLocalServiceImpl#deleteBulan(Bulan) to avoid orphaned data");
		}

		return bulanLocalService.deleteBulan((Bulan)persistedModel);
	}

	@Override
	public BasePersistence<Bulan> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return bulanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Bulan> getBulans(int start, int end) {
		return bulanPersistence.findAll(start, end);
	}
	...
	public int getBulansCount() {
		return bulanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Bulan updateBulan(Bulan bulan) {
		return bulanPersistence.update(bulan);
	}
	 ...
	 */
	public BulanLocalService getBulanLocalService() {
	 ...
	 */
	public void setBulanLocalService(BulanLocalService bulanLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Bulan", bulanLocalService);

		_setLocalServiceUtilService(bulanLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Bulan");
	...
	public String getOSGiServiceIdentifier() {
		return BulanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = bulanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		BulanLocalService bulanLocalService) {

		try {
			Field field = BulanLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, bulanLocalService);
		}
	...
	@BeanReference(type = BulanLocalService.class)
	protected BulanLocalService bulanLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BulanLocalServiceBaseImpl.class);
