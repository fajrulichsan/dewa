...
import com.astra.dewa.service.TrainingAgendaLocalService;
...
/**
 * Provides the base implementation for the training agenda local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TrainingAgendaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TrainingAgendaLocalServiceImpl
 * @generated
 */
public abstract class TrainingAgendaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TrainingAgendaLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingAgendaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingAgendaLocalServiceUtil</code>.
	 */
	...
	@Override
	public TrainingAgenda addTrainingAgenda(TrainingAgenda trainingAgenda) {
		trainingAgenda.setNew(true);

		return trainingAgendaPersistence.update(trainingAgenda);
	}
	...
	public TrainingAgenda createTrainingAgenda(int Id) {
		return trainingAgendaPersistence.create(Id);
	}
	...
	@Override
	public TrainingAgenda deleteTrainingAgenda(int Id) throws PortalException {
		return trainingAgendaPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingAgenda deleteTrainingAgenda(TrainingAgenda trainingAgenda) {
		return trainingAgendaPersistence.remove(trainingAgenda);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return trainingAgendaPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingAgenda.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingAgendaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return trainingAgendaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingAgendaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return trainingAgendaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TrainingAgenda fetchTrainingAgenda(int Id) {
		return trainingAgendaPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public TrainingAgenda getTrainingAgenda(int Id) throws PortalException {
		return trainingAgendaPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(trainingAgendaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TrainingAgenda.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TrainingAgenda.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingAgendaPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingAgendaLocalServiceImpl#deleteTrainingAgenda(TrainingAgenda) to avoid orphaned data");
		}

		return trainingAgendaLocalService.deleteTrainingAgenda(
			(TrainingAgenda)persistedModel);
	}

	@Override
	public BasePersistence<TrainingAgenda> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingAgendaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingAgenda> getTrainingAgendas(int start, int end) {
		return trainingAgendaPersistence.findAll(start, end);
	}
	...
	public int getTrainingAgendasCount() {
		return trainingAgendaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrainingAgenda updateTrainingAgenda(TrainingAgenda trainingAgenda) {
		return trainingAgendaPersistence.update(trainingAgenda);
	}
	 ...
	 */
	public TrainingAgendaLocalService getTrainingAgendaLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.TrainingAgenda", trainingAgendaLocalService);

		_setLocalServiceUtilService(trainingAgendaLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.TrainingAgenda");
	...
	public String getOSGiServiceIdentifier() {
		return TrainingAgendaLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = trainingAgendaPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TrainingAgendaLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, trainingAgendaLocalService);
		}
	...
	@BeanReference(type = TrainingAgendaLocalService.class)
	protected TrainingAgendaLocalService trainingAgendaLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingAgendaLocalServiceBaseImpl.class);
