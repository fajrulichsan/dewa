 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.DealerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.DealerLocalServiceImpl
 * @generated
 */
public abstract class DealerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DealerLocalService, IdentifiableOSGiService {
	...
	public Dealer createDealer(int Id) {
		return dealerPersistence.create(Id);
	}
	...
	@Override
	public Dealer deleteDealer(int Id) throws PortalException {
		return dealerPersistence.remove(Id);
	}
	...
	@Override
	public Dealer fetchDealer(int Id) {
		return dealerPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Dealer getDealer(int Id) throws PortalException {
		return dealerPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dealerPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	 ...
	 */
	public DealerLocalService getDealerLocalService() {
	 ...
	 */
	public void setDealerLocalService(DealerLocalService dealerLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Dealer", dealerLocalService);
	...
	@BeanReference(type = DealerLocalService.class)
