...
import com.astra.dewa.service.ApplicationHeaderJournalLocalService;
...
/**
 * Provides the base implementation for the application header journal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationHeaderJournalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationHeaderJournalLocalServiceImpl
 * @generated
 */
public abstract class ApplicationHeaderJournalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationHeaderJournalLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationHeaderJournalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationHeaderJournalLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApplicationHeaderJournal addApplicationHeaderJournal(
		ApplicationHeaderJournal applicationHeaderJournal) {

		applicationHeaderJournal.setNew(true);

		return applicationHeaderJournalPersistence.update(
	...
	public ApplicationHeaderJournal createApplicationHeaderJournal(int Id) {
		return applicationHeaderJournalPersistence.create(Id);
	}
	...
	@Override
	public ApplicationHeaderJournal deleteApplicationHeaderJournal(int Id)
		throws PortalException {

		return applicationHeaderJournalPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationHeaderJournal deleteApplicationHeaderJournal(
		ApplicationHeaderJournal applicationHeaderJournal) {

		return applicationHeaderJournalPersistence.remove(
			applicationHeaderJournal);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationHeaderJournalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationHeaderJournal.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationHeaderJournalPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationHeaderJournalPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApplicationHeaderJournal fetchApplicationHeaderJournal(int Id) {
		return applicationHeaderJournalPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApplicationHeaderJournal getApplicationHeaderJournal(int Id)
		throws PortalException {

		return applicationHeaderJournalPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationHeaderJournal.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ApplicationHeaderJournal.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationHeaderJournalPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationHeaderJournalLocalServiceImpl#deleteApplicationHeaderJournal(ApplicationHeaderJournal) to avoid orphaned data");
		}

		return applicationHeaderJournalLocalService.
			deleteApplicationHeaderJournal(
				(ApplicationHeaderJournal)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationHeaderJournal> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationHeaderJournalPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplicationHeaderJournal> getApplicationHeaderJournals(
		int start, int end) {

		return applicationHeaderJournalPersistence.findAll(start, end);
	}
	...
	public int getApplicationHeaderJournalsCount() {
		return applicationHeaderJournalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationHeaderJournal updateApplicationHeaderJournal(
		ApplicationHeaderJournal applicationHeaderJournal) {
	 ...
	 */
	public ApplicationHeaderJournalLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(applicationHeaderJournalLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationHeaderJournalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationHeaderJournalPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationHeaderJournalLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationHeaderJournalLocalService);
		}
	...
	@BeanReference(type = ApplicationHeaderJournalLocalService.class)
	protected ApplicationHeaderJournalLocalService
		applicationHeaderJournalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationHeaderJournalLocalServiceBaseImpl.class);
