...
import com.astra.dewa.service.TrainingAgendaParticipantLocalService;
...
/**
 * Provides the base implementation for the training agenda participant local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TrainingAgendaParticipantLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TrainingAgendaParticipantLocalServiceImpl
 * @generated
 */
public abstract class TrainingAgendaParticipantLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TrainingAgendaParticipantLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingAgendaParticipantLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingAgendaParticipantLocalServiceUtil</code>.
	 */
	...
	public TrainingAgendaParticipant addTrainingAgendaParticipant(
		...
		return trainingAgendaParticipantPersistence.update(
	...
	public TrainingAgendaParticipant createTrainingAgendaParticipant(int Id) {
		return trainingAgendaParticipantPersistence.create(Id);
	}
	...
	public TrainingAgendaParticipant deleteTrainingAgendaParticipant(int Id)
		...
		return trainingAgendaParticipantPersistence.remove(Id);
	}
	...
	public TrainingAgendaParticipant deleteTrainingAgendaParticipant(
		...
		return trainingAgendaParticipantPersistence.remove(
			trainingAgendaParticipant);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return trainingAgendaParticipantPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingAgendaParticipant.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingAgendaParticipantPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingAgendaParticipantPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TrainingAgendaParticipant fetchTrainingAgendaParticipant(int Id) {
		return trainingAgendaParticipantPersistence.fetchByPrimaryKey(Id);
	}
	...
	public TrainingAgendaParticipant getTrainingAgendaParticipant(int Id)
		...
		return trainingAgendaParticipantPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TrainingAgendaParticipant.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TrainingAgendaParticipant.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingAgendaParticipantPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingAgendaParticipantLocalServiceImpl#deleteTrainingAgendaParticipant(TrainingAgendaParticipant) to avoid orphaned data");
		}

		return trainingAgendaParticipantLocalService.
			deleteTrainingAgendaParticipant(
				(TrainingAgendaParticipant)persistedModel);
	}

	@Override
	public BasePersistence<TrainingAgendaParticipant> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingAgendaParticipantPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	...
	public List<TrainingAgendaParticipant> getTrainingAgendaParticipants(
		...
		return trainingAgendaParticipantPersistence.findAll(start, end);
	}
	...
	public int getTrainingAgendaParticipantsCount() {
		return trainingAgendaParticipantPersistence.countAll();
	}
	 ...
	 */
	public TrainingAgendaParticipantLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(trainingAgendaParticipantLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingAgendaParticipantLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				trainingAgendaParticipantPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TrainingAgendaParticipantLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, trainingAgendaParticipantLocalService);
		}
	...
	@BeanReference(type = TrainingAgendaParticipantLocalService.class)
	protected TrainingAgendaParticipantLocalService
		trainingAgendaParticipantLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingAgendaParticipantLocalServiceBaseImpl.class);
