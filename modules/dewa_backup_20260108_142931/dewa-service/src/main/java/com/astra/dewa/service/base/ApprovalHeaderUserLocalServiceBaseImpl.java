...
import com.astra.dewa.service.ApprovalHeaderUserLocalService;
...
/**
 * Provides the base implementation for the approval header user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApprovalHeaderUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApprovalHeaderUserLocalServiceImpl
 * @generated
 */
public abstract class ApprovalHeaderUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApprovalHeaderUserLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApprovalHeaderUserLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApprovalHeaderUserLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApprovalHeaderUser addApprovalHeaderUser(
		ApprovalHeaderUser approvalHeaderUser) {

		approvalHeaderUser.setNew(true);

		return approvalHeaderUserPersistence.update(approvalHeaderUser);
	}
	...
	public ApprovalHeaderUser createApprovalHeaderUser(int Id) {
		return approvalHeaderUserPersistence.create(Id);
	}
	...
	@Override
	public ApprovalHeaderUser deleteApprovalHeaderUser(int Id)
		throws PortalException {

		return approvalHeaderUserPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApprovalHeaderUser deleteApprovalHeaderUser(
		ApprovalHeaderUser approvalHeaderUser) {

		return approvalHeaderUserPersistence.remove(approvalHeaderUser);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return approvalHeaderUserPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApprovalHeaderUser.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return approvalHeaderUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return approvalHeaderUserPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return approvalHeaderUserPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApprovalHeaderUser fetchApprovalHeaderUser(int Id) {
		return approvalHeaderUserPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApprovalHeaderUser getApprovalHeaderUser(int Id)
		throws PortalException {

		return approvalHeaderUserPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApprovalHeaderUser.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ApprovalHeaderUser.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return approvalHeaderUserPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApprovalHeaderUserLocalServiceImpl#deleteApprovalHeaderUser(ApprovalHeaderUser) to avoid orphaned data");
		}

		return approvalHeaderUserLocalService.deleteApprovalHeaderUser(
			(ApprovalHeaderUser)persistedModel);
	}

	@Override
	public BasePersistence<ApprovalHeaderUser> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return approvalHeaderUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApprovalHeaderUser> getApprovalHeaderUsers(int start, int end) {
		return approvalHeaderUserPersistence.findAll(start, end);
	}
	...
	public int getApprovalHeaderUsersCount() {
		return approvalHeaderUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApprovalHeaderUser updateApprovalHeaderUser(
		ApprovalHeaderUser approvalHeaderUser) {
	 ...
	 */
	public ApprovalHeaderUserLocalService getApprovalHeaderUserLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ApprovalHeaderUser",
			approvalHeaderUserLocalService);

		_setLocalServiceUtilService(approvalHeaderUserLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApprovalHeaderUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				approvalHeaderUserPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApprovalHeaderUserLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, approvalHeaderUserLocalService);
		}
	...
	@BeanReference(type = ApprovalHeaderUserLocalService.class)
	protected ApprovalHeaderUserLocalService approvalHeaderUserLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApprovalHeaderUserLocalServiceBaseImpl.class);
