...
import com.astra.dewa.service.ApprovalDetailUserLocalService;
...
/**
 * Provides the base implementation for the approval detail user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApprovalDetailUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApprovalDetailUserLocalServiceImpl
 * @generated
 */
public abstract class ApprovalDetailUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApprovalDetailUserLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApprovalDetailUserLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApprovalDetailUserLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApprovalDetailUser addApprovalDetailUser(
		ApprovalDetailUser approvalDetailUser) {

		approvalDetailUser.setNew(true);

		return approvalDetailUserPersistence.update(approvalDetailUser);
	}
	...
	public ApprovalDetailUser createApprovalDetailUser(int Id) {
		return approvalDetailUserPersistence.create(Id);
	}
	...
	@Override
	public ApprovalDetailUser deleteApprovalDetailUser(int Id)
		throws PortalException {

		return approvalDetailUserPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApprovalDetailUser deleteApprovalDetailUser(
		ApprovalDetailUser approvalDetailUser) {

		return approvalDetailUserPersistence.remove(approvalDetailUser);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return approvalDetailUserPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApprovalDetailUser.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return approvalDetailUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return approvalDetailUserPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return approvalDetailUserPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApprovalDetailUser fetchApprovalDetailUser(int Id) {
		return approvalDetailUserPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApprovalDetailUser getApprovalDetailUser(int Id)
		throws PortalException {

		return approvalDetailUserPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApprovalDetailUser.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ApprovalDetailUser.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return approvalDetailUserPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApprovalDetailUserLocalServiceImpl#deleteApprovalDetailUser(ApprovalDetailUser) to avoid orphaned data");
		}

		return approvalDetailUserLocalService.deleteApprovalDetailUser(
			(ApprovalDetailUser)persistedModel);
	}

	@Override
	public BasePersistence<ApprovalDetailUser> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return approvalDetailUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApprovalDetailUser> getApprovalDetailUsers(int start, int end) {
		return approvalDetailUserPersistence.findAll(start, end);
	}
	...
	public int getApprovalDetailUsersCount() {
		return approvalDetailUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApprovalDetailUser updateApprovalDetailUser(
		ApprovalDetailUser approvalDetailUser) {
	 ...
	 */
	public ApprovalDetailUserLocalService getApprovalDetailUserLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ApprovalDetailUser",
			approvalDetailUserLocalService);

		_setLocalServiceUtilService(approvalDetailUserLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApprovalDetailUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				approvalDetailUserPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApprovalDetailUserLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, approvalDetailUserLocalService);
		}
	...
	@BeanReference(type = ApprovalDetailUserLocalService.class)
	protected ApprovalDetailUserLocalService approvalDetailUserLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApprovalDetailUserLocalServiceBaseImpl.class);
