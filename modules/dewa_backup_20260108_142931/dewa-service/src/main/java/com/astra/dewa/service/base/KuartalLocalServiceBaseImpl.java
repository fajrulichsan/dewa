...
import com.astra.dewa.service.KuartalLocalService;
import com.astra.dewa.service.KuartalLocalServiceUtil;
...
/**
 * Provides the base implementation for the kuartal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.KuartalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.KuartalLocalServiceImpl
 * @generated
 */
public abstract class KuartalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, KuartalLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>KuartalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>KuartalLocalServiceUtil</code>.
	 */
	...
	@Override
	public Kuartal addKuartal(Kuartal kuartal) {
		kuartal.setNew(true);

		return kuartalPersistence.update(kuartal);
	}
	...
	public Kuartal createKuartal(String Id) {
		return kuartalPersistence.create(Id);
	}
	...
	@Override
	public Kuartal deleteKuartal(String Id) throws PortalException {
		return kuartalPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Kuartal deleteKuartal(Kuartal kuartal) {
		return kuartalPersistence.remove(kuartal);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return kuartalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Kuartal.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return kuartalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return kuartalPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return kuartalPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return kuartalPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Kuartal fetchKuartal(String Id) {
		return kuartalPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Kuartal getKuartal(String Id) throws PortalException {
		return kuartalPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return kuartalPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement KuartalLocalServiceImpl#deleteKuartal(Kuartal) to avoid orphaned data");
		}

		return kuartalLocalService.deleteKuartal((Kuartal)persistedModel);
	}

	@Override
	public BasePersistence<Kuartal> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return kuartalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Kuartal> getKuartals(int start, int end) {
		return kuartalPersistence.findAll(start, end);
	}
	...
	public int getKuartalsCount() {
		return kuartalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Kuartal updateKuartal(Kuartal kuartal) {
		return kuartalPersistence.update(kuartal);
	}
	 ...
	 */
	public KuartalLocalService getKuartalLocalService() {
	...
	public void setKuartalLocalService(
		KuartalLocalService kuartalLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Kuartal", kuartalLocalService);

		_setLocalServiceUtilService(kuartalLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Kuartal");
	...
	public String getOSGiServiceIdentifier() {
		return KuartalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = kuartalPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = KuartalLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, kuartalLocalService);
		}
	...
	@BeanReference(type = KuartalLocalService.class)
	protected KuartalLocalService kuartalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		KuartalLocalServiceBaseImpl.class);
