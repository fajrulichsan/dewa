...
import com.astra.dewa.service.OTPLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.OTPLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.OTPLocalServiceImpl
 * @generated
 */
public abstract class OTPLocalServiceBaseImpl
	...
	public OTP createOTP(int Id) {
		return otpPersistence.create(Id);
	}
	...
	@Override
	public OTP deleteOTP(int Id) throws PortalException {
		return otpPersistence.remove(Id);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return otpPersistence.dslQuery(dslQuery);
	}
	...
	@Override
	public OTP fetchOTP(int Id) {
		return otpPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public OTP getOTP(int Id) throws PortalException {
		return otpPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return otpPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OTPLocalServiceImpl#deleteOTP(OTP) to avoid orphaned data");
		}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.OTP", otpLocalService);
