...
import com.astra.dewa.service.TrainingMateriLampiranLocalService;
...
/**
 * Provides the base implementation for the training materi lampiran local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TrainingMateriLampiranLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TrainingMateriLampiranLocalServiceImpl
 * @generated
 */
public abstract class TrainingMateriLampiranLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TrainingMateriLampiranLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingMateriLampiranLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingMateriLampiranLocalServiceUtil</code>.
	 */
	...
	@Override
	public TrainingMateriLampiran addTrainingMateriLampiran(
		TrainingMateriLampiran trainingMateriLampiran) {

		trainingMateriLampiran.setNew(true);

		return trainingMateriLampiranPersistence.update(trainingMateriLampiran);
	}
	...
	public TrainingMateriLampiran createTrainingMateriLampiran(int Id) {
		return trainingMateriLampiranPersistence.create(Id);
	}
	...
	@Override
	public TrainingMateriLampiran deleteTrainingMateriLampiran(int Id)
		throws PortalException {

		return trainingMateriLampiranPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingMateriLampiran deleteTrainingMateriLampiran(
		TrainingMateriLampiran trainingMateriLampiran) {

		return trainingMateriLampiranPersistence.remove(trainingMateriLampiran);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return trainingMateriLampiranPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingMateriLampiran.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingMateriLampiranPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingMateriLampiranPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TrainingMateriLampiran fetchTrainingMateriLampiran(int Id) {
		return trainingMateriLampiranPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public TrainingMateriLampiran getTrainingMateriLampiran(int Id)
		throws PortalException {

		return trainingMateriLampiranPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TrainingMateriLampiran.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingMateriLampiranPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingMateriLampiranLocalServiceImpl#deleteTrainingMateriLampiran(TrainingMateriLampiran) to avoid orphaned data");
		}

		return trainingMateriLampiranLocalService.deleteTrainingMateriLampiran(
			(TrainingMateriLampiran)persistedModel);
	}

	@Override
	public BasePersistence<TrainingMateriLampiran> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingMateriLampiranPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingMateriLampiran> getTrainingMateriLampirans(
		int start, int end) {

		return trainingMateriLampiranPersistence.findAll(start, end);
	}
	...
	public int getTrainingMateriLampiransCount() {
		return trainingMateriLampiranPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrainingMateriLampiran updateTrainingMateriLampiran(
		TrainingMateriLampiran trainingMateriLampiran) {
	 ...
	 */
	public TrainingMateriLampiranLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(trainingMateriLampiranLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingMateriLampiranLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				trainingMateriLampiranPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TrainingMateriLampiranLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, trainingMateriLampiranLocalService);
		}
	...
	@BeanReference(type = TrainingMateriLampiranLocalService.class)
	protected TrainingMateriLampiranLocalService
		trainingMateriLampiranLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingMateriLampiranLocalServiceBaseImpl.class);
