...
import com.astra.dewa.service.CabangLocalService;
...
/**
 * Provides the base implementation for the cabang local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.CabangLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.CabangLocalServiceImpl
 * @generated
 */
public abstract class CabangLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CabangLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CabangLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CabangLocalServiceUtil</code>.
	 */
	...
	@Override
	public Cabang addCabang(Cabang cabang) {
		cabang.setNew(true);

		return cabangPersistence.update(cabang);
	}
	...
	public Cabang createCabang(int Id) {
		return cabangPersistence.create(Id);
	}
	...
	@Override
	public Cabang deleteCabang(int Id) throws PortalException {
		return cabangPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Cabang deleteCabang(Cabang cabang) {
		return cabangPersistence.remove(cabang);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return cabangPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Cabang.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cabangPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cabangPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return cabangPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cabangPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return cabangPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Cabang fetchCabang(int Id) {
		return cabangPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Cabang getCabang(int Id) throws PortalException {
		return cabangPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(cabangLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Cabang.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(cabangLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Cabang.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cabangPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CabangLocalServiceImpl#deleteCabang(Cabang) to avoid orphaned data");
		}

		return cabangLocalService.deleteCabang((Cabang)persistedModel);
	}

	@Override
	public BasePersistence<Cabang> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return cabangPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Cabang> getCabangs(int start, int end) {
		return cabangPersistence.findAll(start, end);
	}
	...
	public int getCabangsCount() {
		return cabangPersistence.countAll();
	}
	 ...
	 */
	public CabangLocalService getCabangLocalService() {
	 ...
	 */
	public void setCabangLocalService(CabangLocalService cabangLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Cabang", cabangLocalService);

		_setLocalServiceUtilService(cabangLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Cabang");
	...
	public String getOSGiServiceIdentifier() {
		return CabangLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cabangPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		CabangLocalService cabangLocalService) {

		try {
			Field field = CabangLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cabangLocalService);
		}
	...
	@BeanReference(type = CabangLocalService.class)
	protected CabangLocalService cabangLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CabangLocalServiceBaseImpl.class);
