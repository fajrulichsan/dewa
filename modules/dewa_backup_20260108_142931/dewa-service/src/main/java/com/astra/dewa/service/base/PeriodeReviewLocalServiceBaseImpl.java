...
import com.astra.dewa.service.PeriodeReviewLocalService;
...
/**
 * Provides the base implementation for the periode review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.PeriodeReviewLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.PeriodeReviewLocalServiceImpl
 * @generated
 */
public abstract class PeriodeReviewLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, PeriodeReviewLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PeriodeReviewLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PeriodeReviewLocalServiceUtil</code>.
	 */
	...
	@Override
	public PeriodeReview addPeriodeReview(PeriodeReview periodeReview) {
		periodeReview.setNew(true);

		return periodeReviewPersistence.update(periodeReview);
	}
	...
	public PeriodeReview createPeriodeReview(String Id) {
		return periodeReviewPersistence.create(Id);
	}
	...
	@Override
	public PeriodeReview deletePeriodeReview(String Id) throws PortalException {
		return periodeReviewPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PeriodeReview deletePeriodeReview(PeriodeReview periodeReview) {
		return periodeReviewPersistence.remove(periodeReview);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return periodeReviewPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PeriodeReview.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return periodeReviewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return periodeReviewPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return periodeReviewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return periodeReviewPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PeriodeReview fetchPeriodeReview(String Id) {
		return periodeReviewPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public PeriodeReview getPeriodeReview(String Id) throws PortalException {
		return periodeReviewPersistence.findByPrimaryKey(Id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return periodeReviewPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PeriodeReviewLocalServiceImpl#deletePeriodeReview(PeriodeReview) to avoid orphaned data");
		}

		return periodeReviewLocalService.deletePeriodeReview(
			(PeriodeReview)persistedModel);
	}

	@Override
	public BasePersistence<PeriodeReview> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return periodeReviewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PeriodeReview> getPeriodeReviews(int start, int end) {
		return periodeReviewPersistence.findAll(start, end);
	}
	...
	public int getPeriodeReviewsCount() {
		return periodeReviewPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PeriodeReview updatePeriodeReview(PeriodeReview periodeReview) {
		return periodeReviewPersistence.update(periodeReview);
	}
	 ...
	 */
	public PeriodeReviewLocalService getPeriodeReviewLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.PeriodeReview", periodeReviewLocalService);

		_setLocalServiceUtilService(periodeReviewLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.PeriodeReview");
	...
	public String getOSGiServiceIdentifier() {
		return PeriodeReviewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = periodeReviewPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PeriodeReviewLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, periodeReviewLocalService);
		}
	...
	@BeanReference(type = PeriodeReviewLocalService.class)
	protected PeriodeReviewLocalService periodeReviewLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PeriodeReviewLocalServiceBaseImpl.class);
