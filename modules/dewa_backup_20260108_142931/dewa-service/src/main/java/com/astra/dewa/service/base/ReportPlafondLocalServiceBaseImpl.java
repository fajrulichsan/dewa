...
import com.astra.dewa.service.ReportPlafondLocalService;
...
/**
 * Provides the base implementation for the report plafond local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ReportPlafondLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ReportPlafondLocalServiceImpl
 * @generated
 */
public abstract class ReportPlafondLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, ReportPlafondLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReportPlafondLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReportPlafondLocalServiceUtil</code>.
	 */
	...
	@Override
	public ReportPlafond addReportPlafond(ReportPlafond reportPlafond) {
		reportPlafond.setNew(true);

		return reportPlafondPersistence.update(reportPlafond);
	}
	...
	public ReportPlafond createReportPlafond(int Id) {
		return reportPlafondPersistence.create(Id);
	}
	...
	@Override
	public ReportPlafond deleteReportPlafond(int Id) throws PortalException {
		return reportPlafondPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ReportPlafond deleteReportPlafond(ReportPlafond reportPlafond) {
		return reportPlafondPersistence.remove(reportPlafond);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return reportPlafondPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ReportPlafond.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return reportPlafondPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return reportPlafondPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return reportPlafondPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return reportPlafondPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ReportPlafond fetchReportPlafond(int Id) {
		return reportPlafondPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ReportPlafond getReportPlafond(int Id) throws PortalException {
		return reportPlafondPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(reportPlafondLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ReportPlafond.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ReportPlafond.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return reportPlafondPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ReportPlafondLocalServiceImpl#deleteReportPlafond(ReportPlafond) to avoid orphaned data");
		}

		return reportPlafondLocalService.deleteReportPlafond(
			(ReportPlafond)persistedModel);
	}

	@Override
	public BasePersistence<ReportPlafond> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return reportPlafondPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ReportPlafond> getReportPlafonds(int start, int end) {
		return reportPlafondPersistence.findAll(start, end);
	}
	...
	public int getReportPlafondsCount() {
		return reportPlafondPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ReportPlafond updateReportPlafond(ReportPlafond reportPlafond) {
		return reportPlafondPersistence.update(reportPlafond);
	}
	 ...
	 */
	public ReportPlafondLocalService getReportPlafondLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ReportPlafond", reportPlafondLocalService);

		_setLocalServiceUtilService(reportPlafondLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.ReportPlafond");
	...
	public String getOSGiServiceIdentifier() {
		return ReportPlafondLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = reportPlafondPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ReportPlafondLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, reportPlafondLocalService);
		}
	...
	@BeanReference(type = ReportPlafondLocalService.class)
	protected ReportPlafondLocalService reportPlafondLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ReportPlafondLocalServiceBaseImpl.class);
