...
import com.astra.dewa.service.SalesProgramLocalService;
...
/**
 * Provides the base implementation for the sales program local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.SalesProgramLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.SalesProgramLocalServiceImpl
 * @generated
 */
public abstract class SalesProgramLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SalesProgramLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SalesProgramLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SalesProgramLocalServiceUtil</code>.
	 */

	/**
	 * Adds the sales program to the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SalesProgramLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param salesProgram the sales program
	 * @return the sales program that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SalesProgram addSalesProgram(SalesProgram salesProgram) {
		salesProgram.setNew(true);

		return salesProgramPersistence.update(salesProgram);
	}
	...
	public SalesProgram createSalesProgram(long Id) {
		return salesProgramPersistence.create(Id);
	}

	/**
	 * Deletes the sales program with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SalesProgramLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 ...
	 * @throws PortalException if a sales program with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SalesProgram deleteSalesProgram(long Id) throws PortalException {
		return salesProgramPersistence.remove(Id);
	}

	/**
	 * Deletes the sales program from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SalesProgramLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SalesProgram deleteSalesProgram(SalesProgram salesProgram) {
		return salesProgramPersistence.remove(salesProgram);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return salesProgramPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SalesProgram.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return salesProgramPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return salesProgramPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return salesProgramPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return salesProgramPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SalesProgram fetchSalesProgram(long Id) {
		return salesProgramPersistence.fetchByPrimaryKey(Id);
	}

	/**
	 * Returns the sales program with the primary key.
	 *
	 * @param Id the primary key of the sales program
	 ...
	 */
	@Override
	public SalesProgram getSalesProgram(long Id) throws PortalException {
		return salesProgramPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(salesProgramLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SalesProgram.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SalesProgram.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return salesProgramPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SalesProgramLocalServiceImpl#deleteSalesProgram(SalesProgram) to avoid orphaned data");
		}

		return salesProgramLocalService.deleteSalesProgram(
			(SalesProgram)persistedModel);
	}

	@Override
	public BasePersistence<SalesProgram> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return salesProgramPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SalesProgram> getSalesPrograms(int start, int end) {
		return salesProgramPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSalesProgramsCount() {
		return salesProgramPersistence.countAll();
	}

	/**
	 * Updates the sales program in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect SalesProgramLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param salesProgram the sales program
	 * @return the sales program that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SalesProgram updateSalesProgram(SalesProgram salesProgram) {
		return salesProgramPersistence.update(salesProgram);
	}
	 ...
	 */
	public com.astra.dewa.service.DiskonFleetLocalService
		getDiskonFleetLocalService() {
	...
	public void setDiskonFleetLocalService(
		com.astra.dewa.service.DiskonFleetLocalService
	 ...
	 */
	public SalesProgramLocalService getSalesProgramLocalService() {
	...
	public void setSalesProgramLocalService(
		SalesProgramLocalService salesProgramLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.SalesProgram", salesProgramLocalService);

		_setLocalServiceUtilService(salesProgramLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.SalesProgram");
	...
	public String getOSGiServiceIdentifier() {
		return SalesProgramLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = salesProgramPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SalesProgramLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, salesProgramLocalService);
		}
	...
	@BeanReference(type = com.astra.dewa.service.DiskonFleetLocalService.class)
	protected com.astra.dewa.service.DiskonFleetLocalService
		diskonFleetLocalService;
	...
	@BeanReference(type = SalesProgramLocalService.class)
	protected SalesProgramLocalService salesProgramLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SalesProgramLocalServiceBaseImpl.class);
