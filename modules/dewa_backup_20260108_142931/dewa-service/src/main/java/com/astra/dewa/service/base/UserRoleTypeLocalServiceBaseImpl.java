...
import com.astra.dewa.service.UserRoleTypeLocalService;
...
/**
 * Provides the base implementation for the user role type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.UserRoleTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.UserRoleTypeLocalServiceImpl
 * @generated
 */
public abstract class UserRoleTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, UserRoleTypeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserRoleTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UserRoleTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public UserRoleType addUserRoleType(UserRoleType userRoleType) {
		userRoleType.setNew(true);

		return userRoleTypePersistence.update(userRoleType);
	}
	...
	public UserRoleType createUserRoleType(int Id) {
		return userRoleTypePersistence.create(Id);
	}
	...
	@Override
	public UserRoleType deleteUserRoleType(int Id) throws PortalException {
		return userRoleTypePersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserRoleType deleteUserRoleType(UserRoleType userRoleType) {
		return userRoleTypePersistence.remove(userRoleType);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return userRoleTypePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UserRoleType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userRoleTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return userRoleTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userRoleTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return userRoleTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public UserRoleType fetchUserRoleType(int Id) {
		return userRoleTypePersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public UserRoleType getUserRoleType(int Id) throws PortalException {
		return userRoleTypePersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userRoleTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserRoleType.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(UserRoleType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return userRoleTypePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement UserRoleTypeLocalServiceImpl#deleteUserRoleType(UserRoleType) to avoid orphaned data");
		}

		return userRoleTypeLocalService.deleteUserRoleType(
			(UserRoleType)persistedModel);
	}

	@Override
	public BasePersistence<UserRoleType> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return userRoleTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserRoleType> getUserRoleTypes(int start, int end) {
		return userRoleTypePersistence.findAll(start, end);
	}
	...
	public int getUserRoleTypesCount() {
		return userRoleTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserRoleType updateUserRoleType(UserRoleType userRoleType) {
		return userRoleTypePersistence.update(userRoleType);
	}
	 ...
	 */
	public UserRoleTypeLocalService getUserRoleTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.UserRoleType", userRoleTypeLocalService);

		_setLocalServiceUtilService(userRoleTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.UserRoleType");
	...
	public String getOSGiServiceIdentifier() {
		return UserRoleTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userRoleTypePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = UserRoleTypeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, userRoleTypeLocalService);
		}
	...
	@BeanReference(type = UserRoleTypeLocalService.class)
	protected UserRoleTypeLocalService userRoleTypeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UserRoleTypeLocalServiceBaseImpl.class);
