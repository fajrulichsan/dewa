...
import com.astra.dewa.service.JenisMateriLocalService;
...
/**
 * Provides the base implementation for the jenis materi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.JenisMateriLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.JenisMateriLocalServiceImpl
 * @generated
 */
public abstract class JenisMateriLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, JenisMateriLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JenisMateriLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JenisMateriLocalServiceUtil</code>.
	 */
	...
	@Override
	public JenisMateri addJenisMateri(JenisMateri jenisMateri) {
		jenisMateri.setNew(true);

		return jenisMateriPersistence.update(jenisMateri);
	}
	...
	public JenisMateri createJenisMateri(int Id) {
		return jenisMateriPersistence.create(Id);
	}
	...
	@Override
	public JenisMateri deleteJenisMateri(int Id) throws PortalException {
		return jenisMateriPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JenisMateri deleteJenisMateri(JenisMateri jenisMateri) {
		return jenisMateriPersistence.remove(jenisMateri);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return jenisMateriPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JenisMateri.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jenisMateriPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return jenisMateriPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jenisMateriPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return jenisMateriPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public JenisMateri fetchJenisMateri(int Id) {
		return jenisMateriPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public JenisMateri getJenisMateri(int Id) throws PortalException {
		return jenisMateriPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(jenisMateriLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JenisMateri.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(JenisMateri.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return jenisMateriPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement JenisMateriLocalServiceImpl#deleteJenisMateri(JenisMateri) to avoid orphaned data");
		}

		return jenisMateriLocalService.deleteJenisMateri(
			(JenisMateri)persistedModel);
	}

	@Override
	public BasePersistence<JenisMateri> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return jenisMateriPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JenisMateri> getJenisMateris(int start, int end) {
		return jenisMateriPersistence.findAll(start, end);
	}
	...
	public int getJenisMaterisCount() {
		return jenisMateriPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JenisMateri updateJenisMateri(JenisMateri jenisMateri) {
		return jenisMateriPersistence.update(jenisMateri);
	}
	 ...
	 */
	public JenisMateriLocalService getJenisMateriLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.JenisMateri", jenisMateriLocalService);

		_setLocalServiceUtilService(jenisMateriLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.JenisMateri");
	...
	public String getOSGiServiceIdentifier() {
		return JenisMateriLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = jenisMateriPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = JenisMateriLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, jenisMateriLocalService);
		}
	...
	@BeanReference(type = JenisMateriLocalService.class)
	protected JenisMateriLocalService jenisMateriLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JenisMateriLocalServiceBaseImpl.class);
