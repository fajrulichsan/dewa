...
import com.astra.dewa.service.ApprovalHistoryUserLocalService;
...
/**
 * Provides the base implementation for the approval history user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApprovalHistoryUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApprovalHistoryUserLocalServiceImpl
 * @generated
 */
public abstract class ApprovalHistoryUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApprovalHistoryUserLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApprovalHistoryUserLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApprovalHistoryUserLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApprovalHistoryUser addApprovalHistoryUser(
		ApprovalHistoryUser approvalHistoryUser) {

		approvalHistoryUser.setNew(true);

		return approvalHistoryUserPersistence.update(approvalHistoryUser);
	}
	...
	public ApprovalHistoryUser createApprovalHistoryUser(int Id) {
		return approvalHistoryUserPersistence.create(Id);
	}
	...
	@Override
	public ApprovalHistoryUser deleteApprovalHistoryUser(int Id)
		throws PortalException {

		return approvalHistoryUserPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApprovalHistoryUser deleteApprovalHistoryUser(
		ApprovalHistoryUser approvalHistoryUser) {

		return approvalHistoryUserPersistence.remove(approvalHistoryUser);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return approvalHistoryUserPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApprovalHistoryUser.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return approvalHistoryUserPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return approvalHistoryUserPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApprovalHistoryUser fetchApprovalHistoryUser(int Id) {
		return approvalHistoryUserPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApprovalHistoryUser getApprovalHistoryUser(int Id)
		throws PortalException {

		return approvalHistoryUserPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApprovalHistoryUser.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return approvalHistoryUserPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApprovalHistoryUserLocalServiceImpl#deleteApprovalHistoryUser(ApprovalHistoryUser) to avoid orphaned data");
		}

		return approvalHistoryUserLocalService.deleteApprovalHistoryUser(
			(ApprovalHistoryUser)persistedModel);
	}

	@Override
	public BasePersistence<ApprovalHistoryUser> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return approvalHistoryUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApprovalHistoryUser> getApprovalHistoryUsers(
		int start, int end) {

		return approvalHistoryUserPersistence.findAll(start, end);
	}
	...
	public int getApprovalHistoryUsersCount() {
		return approvalHistoryUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApprovalHistoryUser updateApprovalHistoryUser(
		ApprovalHistoryUser approvalHistoryUser) {
	 ...
	 */
	public ApprovalHistoryUserLocalService
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ApprovalHistoryUser",
			approvalHistoryUserLocalService);

		_setLocalServiceUtilService(approvalHistoryUserLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApprovalHistoryUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				approvalHistoryUserPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApprovalHistoryUserLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, approvalHistoryUserLocalService);
		}
	...
	@BeanReference(type = ApprovalHistoryUserLocalService.class)
	protected ApprovalHistoryUserLocalService approvalHistoryUserLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApprovalHistoryUserLocalServiceBaseImpl.class);
