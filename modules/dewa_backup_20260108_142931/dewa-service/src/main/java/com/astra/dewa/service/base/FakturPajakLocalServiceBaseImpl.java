...
import com.astra.dewa.service.FakturPajakLocalService;
...
/**
 * Provides the base implementation for the faktur pajak local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.FakturPajakLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.FakturPajakLocalServiceImpl
 * @generated
 */
public abstract class FakturPajakLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements FakturPajakLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FakturPajakLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FakturPajakLocalServiceUtil</code>.
	 */
	...
	@Override
	public FakturPajak addFakturPajak(FakturPajak fakturPajak) {
		fakturPajak.setNew(true);

		return fakturPajakPersistence.update(fakturPajak);
	}
	...
	public FakturPajak createFakturPajak(int Id) {
		return fakturPajakPersistence.create(Id);
	}
	...
	@Override
	public FakturPajak deleteFakturPajak(int Id) throws PortalException {
		return fakturPajakPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FakturPajak deleteFakturPajak(FakturPajak fakturPajak) {
		return fakturPajakPersistence.remove(fakturPajak);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fakturPajakPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FakturPajak.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fakturPajakPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return fakturPajakPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fakturPajakPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return fakturPajakPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FakturPajak fetchFakturPajak(int Id) {
		return fakturPajakPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public FakturPajak getFakturPajak(int Id) throws PortalException {
		return fakturPajakPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fakturPajakLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FakturPajak.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(FakturPajak.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return fakturPajakPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FakturPajakLocalServiceImpl#deleteFakturPajak(FakturPajak) to avoid orphaned data");
		}

		return fakturPajakLocalService.deleteFakturPajak(
			(FakturPajak)persistedModel);
	}

	@Override
	public BasePersistence<FakturPajak> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return fakturPajakPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FakturPajak> getFakturPajaks(int start, int end) {
		return fakturPajakPersistence.findAll(start, end);
	}
	...
	public int getFakturPajaksCount() {
		return fakturPajakPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FakturPajak updateFakturPajak(FakturPajak fakturPajak) {
		return fakturPajakPersistence.update(fakturPajak);
	}
	 ...
	 */
	public FakturPajakLocalService getFakturPajakLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.FakturPajak", fakturPajakLocalService);

		_setLocalServiceUtilService(fakturPajakLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.FakturPajak");
	...
	public String getOSGiServiceIdentifier() {
		return FakturPajakLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fakturPajakPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FakturPajakLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fakturPajakLocalService);
		}
	...
	@BeanReference(type = FakturPajakLocalService.class)
	protected FakturPajakLocalService fakturPajakLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FakturPajakLocalServiceBaseImpl.class);
