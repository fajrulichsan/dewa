...
import com.astra.dewa.service.RolesLocalService;
...
/**
 * Provides the base implementation for the roles local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.RolesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.RolesLocalServiceImpl
 * @generated
 */
public abstract class RolesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, RolesLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RolesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RolesLocalServiceUtil</code>.
	 */
	...
	public Roles addRoles(Roles roles) {
		...
		return rolesPersistence.update(roles);
	}
	...
	public Roles createRoles(int Id) {
		return rolesPersistence.create(Id);
	}
	...
	@Override
	public Roles deleteRoles(int Id) throws PortalException {
		return rolesPersistence.remove(Id);
	}
	...
	public Roles deleteRoles(Roles roles) {
		return rolesPersistence.remove(roles);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rolesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Roles.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rolesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rolesPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rolesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rolesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return rolesPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Roles fetchRoles(int Id) {
		return rolesPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Roles getRoles(int Id) throws PortalException {
		return rolesPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rolesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Roles.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(rolesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Roles.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rolesPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RolesLocalServiceImpl#deleteRoles(Roles) to avoid orphaned data");
		}

		return rolesLocalService.deleteRoles((Roles)persistedModel);
	}

	@Override
	public BasePersistence<Roles> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rolesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Roles> getRoleses(int start, int end) {
		return rolesPersistence.findAll(start, end);
	}
	...
	public int getRolesesCount() {
		return rolesPersistence.countAll();
	}
	 ...
	 */
	public RolesLocalService getRolesLocalService() {
	 ...
	 */
	public void setRolesLocalService(RolesLocalService rolesLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Roles", rolesLocalService);

		_setLocalServiceUtilService(rolesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Roles");
	...
	public String getOSGiServiceIdentifier() {
		return RolesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rolesPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		RolesLocalService rolesLocalService) {

		try {
			Field field = RolesLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rolesLocalService);
		}
	...
	@BeanReference(type = RolesLocalService.class)
	protected RolesLocalService rolesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RolesLocalServiceBaseImpl.class);
