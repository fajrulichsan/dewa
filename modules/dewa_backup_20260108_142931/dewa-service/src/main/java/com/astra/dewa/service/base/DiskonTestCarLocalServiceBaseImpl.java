...
import com.astra.dewa.service.DiskonTestCarLocalService;
...
/**
 * Provides the base implementation for the diskon test car local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.DiskonTestCarLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.DiskonTestCarLocalServiceImpl
 * @generated
 */
public abstract class DiskonTestCarLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DiskonTestCarLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DiskonTestCarLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DiskonTestCarLocalServiceUtil</code>.
	 */
	...
	@Override
	public DiskonTestCar addDiskonTestCar(DiskonTestCar diskonTestCar) {
		diskonTestCar.setNew(true);

		return diskonTestCarPersistence.update(diskonTestCar);
	}
	...
	public DiskonTestCar createDiskonTestCar(int Id) {
		return diskonTestCarPersistence.create(Id);
	}
	...
	@Override
	public DiskonTestCar deleteDiskonTestCar(int Id) throws PortalException {
		return diskonTestCarPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DiskonTestCar deleteDiskonTestCar(DiskonTestCar diskonTestCar) {
		return diskonTestCarPersistence.remove(diskonTestCar);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return diskonTestCarPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DiskonTestCar.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return diskonTestCarPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return diskonTestCarPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return diskonTestCarPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return diskonTestCarPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DiskonTestCar fetchDiskonTestCar(int Id) {
		return diskonTestCarPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public DiskonTestCar getDiskonTestCar(int Id) throws PortalException {
		return diskonTestCarPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(diskonTestCarLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DiskonTestCar.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DiskonTestCar.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return diskonTestCarPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DiskonTestCarLocalServiceImpl#deleteDiskonTestCar(DiskonTestCar) to avoid orphaned data");
		}

		return diskonTestCarLocalService.deleteDiskonTestCar(
			(DiskonTestCar)persistedModel);
	}

	@Override
	public BasePersistence<DiskonTestCar> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return diskonTestCarPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DiskonTestCar> getDiskonTestCars(int start, int end) {
		return diskonTestCarPersistence.findAll(start, end);
	}
	...
	public int getDiskonTestCarsCount() {
		return diskonTestCarPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DiskonTestCar updateDiskonTestCar(DiskonTestCar diskonTestCar) {
		return diskonTestCarPersistence.update(diskonTestCar);
	}
	 ...
	 */
	public DiskonTestCarLocalService getDiskonTestCarLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.DiskonTestCar", diskonTestCarLocalService);

		_setLocalServiceUtilService(diskonTestCarLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.DiskonTestCar");
	...
	public String getOSGiServiceIdentifier() {
		return DiskonTestCarLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = diskonTestCarPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DiskonTestCarLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, diskonTestCarLocalService);
		}
	...
	@BeanReference(type = DiskonTestCarLocalService.class)
	protected DiskonTestCarLocalService diskonTestCarLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DiskonTestCarLocalServiceBaseImpl.class);
