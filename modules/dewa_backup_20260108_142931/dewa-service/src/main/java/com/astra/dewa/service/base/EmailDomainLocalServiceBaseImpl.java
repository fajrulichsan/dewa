...
import com.astra.dewa.service.EmailDomainLocalService;
...
/**
 * Provides the base implementation for the email domain local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.EmailDomainLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.EmailDomainLocalServiceImpl
 * @generated
 */
public abstract class EmailDomainLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements EmailDomainLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmailDomainLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EmailDomainLocalServiceUtil</code>.
	 */
	...
	@Override
	public EmailDomain addEmailDomain(EmailDomain emailDomain) {
		emailDomain.setNew(true);

		return emailDomainPersistence.update(emailDomain);
	}
	...
	public EmailDomain createEmailDomain(int Id) {
		return emailDomainPersistence.create(Id);
	}
	...
	@Override
	public EmailDomain deleteEmailDomain(int Id) throws PortalException {
		return emailDomainPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public EmailDomain deleteEmailDomain(EmailDomain emailDomain) {
		return emailDomainPersistence.remove(emailDomain);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return emailDomainPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EmailDomain.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return emailDomainPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return emailDomainPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return emailDomainPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return emailDomainPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EmailDomain fetchEmailDomain(int Id) {
		return emailDomainPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public EmailDomain getEmailDomain(int Id) throws PortalException {
		return emailDomainPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(emailDomainLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EmailDomain.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(EmailDomain.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return emailDomainPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EmailDomainLocalServiceImpl#deleteEmailDomain(EmailDomain) to avoid orphaned data");
		}

		return emailDomainLocalService.deleteEmailDomain(
			(EmailDomain)persistedModel);
	}

	@Override
	public BasePersistence<EmailDomain> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return emailDomainPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<EmailDomain> getEmailDomains(int start, int end) {
		return emailDomainPersistence.findAll(start, end);
	}
	...
	public int getEmailDomainsCount() {
		return emailDomainPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public EmailDomain updateEmailDomain(EmailDomain emailDomain) {
		return emailDomainPersistence.update(emailDomain);
	}
	 ...
	 */
	public EmailDomainLocalService getEmailDomainLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.EmailDomain", emailDomainLocalService);

		_setLocalServiceUtilService(emailDomainLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.EmailDomain");
	...
	public String getOSGiServiceIdentifier() {
		return EmailDomainLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = emailDomainPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = EmailDomainLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, emailDomainLocalService);
		}
	...
	@BeanReference(type = EmailDomainLocalService.class)
	protected EmailDomainLocalService emailDomainLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EmailDomainLocalServiceBaseImpl.class);
