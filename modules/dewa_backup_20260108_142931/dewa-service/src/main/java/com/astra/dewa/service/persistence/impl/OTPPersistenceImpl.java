...
import com.astra.dewa.exception.NoSuchOTPException;
import com.astra.dewa.model.OTP;
import com.astra.dewa.model.OTPTable;
import com.astra.dewa.model.impl.OTPImpl;
import com.astra.dewa.model.impl.OTPModelImpl;
import com.astra.dewa.service.persistence.OTPPersistence;
import com.astra.dewa.service.persistence.OTPUtil;
...
public class OTPPersistenceImpl
	...
	public void cacheResult(OTP otp) {
		dummyEntityCache.putResult(OTPImpl.class, otp.getPrimaryKey(), otp);
	}
	...
	public void cacheResult(List<OTP> otps) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (otps.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void clearCache() {
		dummyEntityCache.clearCache(OTPImpl.class);

		dummyFinderCache.clearCache(OTPImpl.class);
	}
	...
	public void clearCache(OTP otp) {
		dummyEntityCache.removeResult(OTPImpl.class, otp);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			dummyEntityCache.removeResult(OTPImpl.class, primaryKey);
		}
	}
	 ...
	 */
	@Override
	public OTP create(int Id) {
		OTP otp = new OTPImpl();

		otp.setNew(true);
		otp.setPrimaryKey(Id);
	 ...
	 */
	@Override
	public OTP remove(int Id) throws NoSuchOTPException {
	...
	public OTP updateImpl(OTP otp) {
		...
		dummyEntityCache.putResult(OTPImpl.class, otp, false, true);
	 ...
	 */
	@Override
	public OTP findByPrimaryKey(int Id) throws NoSuchOTPException {
	 ...
	 */
	@Override
	public OTP fetchByPrimaryKey(int Id) {
	...
	public List<OTP> findAll(
		...
		if (useFinderCache) {
			list = (List<OTP>)dummyFinderCache.getResult(
	...
	public void afterPropertiesSet() {
		...
		_setOTPUtilPersistence(this);
	}

	public void destroy() {
		_setOTPUtilPersistence(null);

		dummyEntityCache.removeCache(OTPImpl.class.getName());
	}

	private void _setOTPUtilPersistence(OTPPersistence otpPersistence) {
		try {
			Field field = OTPUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, otpPersistence);
		}
