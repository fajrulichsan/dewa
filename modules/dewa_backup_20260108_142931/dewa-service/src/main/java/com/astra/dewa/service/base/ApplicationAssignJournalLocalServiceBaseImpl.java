...
import com.astra.dewa.service.ApplicationAssignJournalLocalService;
...
/**
 * Provides the base implementation for the application assign journal local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationAssignJournalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationAssignJournalLocalServiceImpl
 * @generated
 */
public abstract class ApplicationAssignJournalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationAssignJournalLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationAssignJournalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationAssignJournalLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApplicationAssignJournal addApplicationAssignJournal(
		ApplicationAssignJournal applicationAssignJournal) {

		applicationAssignJournal.setNew(true);

		return applicationAssignJournalPersistence.update(
	...
	public ApplicationAssignJournal createApplicationAssignJournal(int Id) {
		return applicationAssignJournalPersistence.create(Id);
	}
	...
	@Override
	public ApplicationAssignJournal deleteApplicationAssignJournal(int Id)
		throws PortalException {

		return applicationAssignJournalPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationAssignJournal deleteApplicationAssignJournal(
		ApplicationAssignJournal applicationAssignJournal) {

		return applicationAssignJournalPersistence.remove(
			applicationAssignJournal);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationAssignJournalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationAssignJournal.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationAssignJournalPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationAssignJournalPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApplicationAssignJournal fetchApplicationAssignJournal(int Id) {
		return applicationAssignJournalPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApplicationAssignJournal getApplicationAssignJournal(int Id)
		throws PortalException {

		return applicationAssignJournalPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationAssignJournal.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ApplicationAssignJournal.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationAssignJournalPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationAssignJournalLocalServiceImpl#deleteApplicationAssignJournal(ApplicationAssignJournal) to avoid orphaned data");
		}

		return applicationAssignJournalLocalService.
			deleteApplicationAssignJournal(
				(ApplicationAssignJournal)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationAssignJournal> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationAssignJournalPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplicationAssignJournal> getApplicationAssignJournals(
		int start, int end) {

		return applicationAssignJournalPersistence.findAll(start, end);
	}
	...
	public int getApplicationAssignJournalsCount() {
		return applicationAssignJournalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationAssignJournal updateApplicationAssignJournal(
		ApplicationAssignJournal applicationAssignJournal) {
	 ...
	 */
	public ApplicationAssignJournalLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(applicationAssignJournalLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationAssignJournalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationAssignJournalPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationAssignJournalLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationAssignJournalLocalService);
		}
	...
	@BeanReference(type = ApplicationAssignJournalLocalService.class)
	protected ApplicationAssignJournalLocalService
		applicationAssignJournalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationAssignJournalLocalServiceBaseImpl.class);
