...
import com.astra.dewa.service.DiskonOtherLocalService;
...
/**
 * Provides the base implementation for the diskon other local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.DiskonOtherLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.DiskonOtherLocalServiceImpl
 * @generated
 */
public abstract class DiskonOtherLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DiskonOtherLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DiskonOtherLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DiskonOtherLocalServiceUtil</code>.
	 */
	...
	@Override
	public DiskonOther addDiskonOther(DiskonOther diskonOther) {
		diskonOther.setNew(true);

		return diskonOtherPersistence.update(diskonOther);
	}
	...
	public DiskonOther createDiskonOther(long diskonOtherId) {
		return diskonOtherPersistence.create(diskonOtherId);
	}
	...
	@Override
	public DiskonOther deleteDiskonOther(long diskonOtherId)
		throws PortalException {

		return diskonOtherPersistence.remove(diskonOtherId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DiskonOther deleteDiskonOther(DiskonOther diskonOther) {
		return diskonOtherPersistence.remove(diskonOther);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return diskonOtherPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DiskonOther.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return diskonOtherPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return diskonOtherPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return diskonOtherPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return diskonOtherPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DiskonOther fetchDiskonOther(long diskonOtherId) {
		return diskonOtherPersistence.fetchByPrimaryKey(diskonOtherId);
	}
	 ...
	 */
	@Override
	public DiskonOther getDiskonOther(long diskonOtherId)
		throws PortalException {

		return diskonOtherPersistence.findByPrimaryKey(diskonOtherId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(diskonOtherLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DiskonOther.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("diskonOtherId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DiskonOther.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return diskonOtherPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DiskonOtherLocalServiceImpl#deleteDiskonOther(DiskonOther) to avoid orphaned data");
		}

		return diskonOtherLocalService.deleteDiskonOther(
			(DiskonOther)persistedModel);
	}

	@Override
	public BasePersistence<DiskonOther> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return diskonOtherPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DiskonOther> getDiskonOthers(int start, int end) {
		return diskonOtherPersistence.findAll(start, end);
	}
	...
	public int getDiskonOthersCount() {
		return diskonOtherPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DiskonOther updateDiskonOther(DiskonOther diskonOther) {
		return diskonOtherPersistence.update(diskonOther);
	}
	 ...
	 */
	public DiskonOtherLocalService getDiskonOtherLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.DiskonOther", diskonOtherLocalService);

		_setLocalServiceUtilService(diskonOtherLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.DiskonOther");
	...
	public String getOSGiServiceIdentifier() {
		return DiskonOtherLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = diskonOtherPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DiskonOtherLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, diskonOtherLocalService);
		}
	...
	@BeanReference(type = DiskonOtherLocalService.class)
	protected DiskonOtherLocalService diskonOtherLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DiskonOtherLocalServiceBaseImpl.class);
