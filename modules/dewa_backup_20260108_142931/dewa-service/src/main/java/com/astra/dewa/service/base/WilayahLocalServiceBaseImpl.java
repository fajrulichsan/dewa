...
import com.astra.dewa.service.WilayahLocalService;
...
/**
 * Provides the base implementation for the wilayah local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.WilayahLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.WilayahLocalServiceImpl
 * @generated
 */
public abstract class WilayahLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, WilayahLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WilayahLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>WilayahLocalServiceUtil</code>.
	 */
	...
	@Override
	public Wilayah addWilayah(Wilayah wilayah) {
		wilayah.setNew(true);

		return wilayahPersistence.update(wilayah);
	}
	...
	public Wilayah createWilayah(int Id) {
		return wilayahPersistence.create(Id);
	}
	...
	@Override
	public Wilayah deleteWilayah(int Id) throws PortalException {
		return wilayahPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Wilayah deleteWilayah(Wilayah wilayah) {
		return wilayahPersistence.remove(wilayah);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return wilayahPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Wilayah.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return wilayahPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return wilayahPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return wilayahPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return wilayahPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Wilayah fetchWilayah(int Id) {
		return wilayahPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Wilayah getWilayah(int Id) throws PortalException {
		return wilayahPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(wilayahLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Wilayah.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Wilayah.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return wilayahPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement WilayahLocalServiceImpl#deleteWilayah(Wilayah) to avoid orphaned data");
		}

		return wilayahLocalService.deleteWilayah((Wilayah)persistedModel);
	}

	@Override
	public BasePersistence<Wilayah> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return wilayahPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Wilayah> getWilayahs(int start, int end) {
		return wilayahPersistence.findAll(start, end);
	}
	...
	public int getWilayahsCount() {
		return wilayahPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Wilayah updateWilayah(Wilayah wilayah) {
		return wilayahPersistence.update(wilayah);
	}
	 ...
	 */
	public WilayahLocalService getWilayahLocalService() {
	...
	public void setWilayahLocalService(
		WilayahLocalService wilayahLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Wilayah", wilayahLocalService);

		_setLocalServiceUtilService(wilayahLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Wilayah");
	...
	public String getOSGiServiceIdentifier() {
		return WilayahLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = wilayahPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = WilayahLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, wilayahLocalService);
		}
	...
	@BeanReference(type = WilayahLocalService.class)
	protected WilayahLocalService wilayahLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WilayahLocalServiceBaseImpl.class);
