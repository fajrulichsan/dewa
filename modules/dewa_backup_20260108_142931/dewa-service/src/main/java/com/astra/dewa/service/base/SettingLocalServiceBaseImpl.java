...
import com.astra.dewa.service.SettingLocalService;
...
/**
 * Provides the base implementation for the setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.SettingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.SettingLocalServiceImpl
 * @generated
 */
public abstract class SettingLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SettingLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SettingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SettingLocalServiceUtil</code>.
	 */
	...
	public Setting addSetting(Setting setting) {
		...
		return settingPersistence.update(setting);
	}
	...
	public Setting createSetting(int Id) {
		return settingPersistence.create(Id);
	}
	...
	@Override
	public Setting deleteSetting(int Id) throws PortalException {
		return settingPersistence.remove(Id);
	}
	...
	public Setting deleteSetting(Setting setting) {
		return settingPersistence.remove(setting);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return settingPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Setting.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return settingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return settingPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return settingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return settingPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Setting fetchSetting(int Id) {
		return settingPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public Setting getSetting(int Id) throws PortalException {
		return settingPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(settingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Setting.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Setting.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return settingPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SettingLocalServiceImpl#deleteSetting(Setting) to avoid orphaned data");
		}

		return settingLocalService.deleteSetting((Setting)persistedModel);
	}

	@Override
	public BasePersistence<Setting> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return settingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Setting> getSettings(int start, int end) {
		return settingPersistence.findAll(start, end);
	}
	...
	public int getSettingsCount() {
		return settingPersistence.countAll();
	}
	 ...
	 */
	public SettingLocalService getSettingLocalService() {
	...
	public void setSettingLocalService(
		SettingLocalService settingLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Setting", settingLocalService);

		_setLocalServiceUtilService(settingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Setting");
	...
	public String getOSGiServiceIdentifier() {
		return SettingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = settingPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SettingLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, settingLocalService);
		}
	...
	@BeanReference(type = SettingLocalService.class)
	protected SettingLocalService settingLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SettingLocalServiceBaseImpl.class);
