...
import com.astra.dewa.service.FakturIndirectLocalService;
...
/**
 * Provides the base implementation for the faktur indirect local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.FakturIndirectLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.FakturIndirectLocalServiceImpl
 * @generated
 */
public abstract class FakturIndirectLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements FakturIndirectLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FakturIndirectLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FakturIndirectLocalServiceUtil</code>.
	 */
	...
	@Override
	public FakturIndirect addFakturIndirect(FakturIndirect fakturIndirect) {
		fakturIndirect.setNew(true);

		return fakturIndirectPersistence.update(fakturIndirect);
	}
	...
	public FakturIndirect createFakturIndirect(int Id) {
		return fakturIndirectPersistence.create(Id);
	}
	...
	@Override
	public FakturIndirect deleteFakturIndirect(int Id) throws PortalException {
		return fakturIndirectPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FakturIndirect deleteFakturIndirect(FakturIndirect fakturIndirect) {
		return fakturIndirectPersistence.remove(fakturIndirect);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fakturIndirectPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FakturIndirect.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fakturIndirectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return fakturIndirectPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fakturIndirectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return fakturIndirectPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FakturIndirect fetchFakturIndirect(int Id) {
		return fakturIndirectPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public FakturIndirect getFakturIndirect(int Id) throws PortalException {
		return fakturIndirectPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fakturIndirectLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FakturIndirect.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(FakturIndirect.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return fakturIndirectPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FakturIndirectLocalServiceImpl#deleteFakturIndirect(FakturIndirect) to avoid orphaned data");
		}

		return fakturIndirectLocalService.deleteFakturIndirect(
			(FakturIndirect)persistedModel);
	}

	@Override
	public BasePersistence<FakturIndirect> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return fakturIndirectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FakturIndirect> getFakturIndirects(int start, int end) {
		return fakturIndirectPersistence.findAll(start, end);
	}
	...
	public int getFakturIndirectsCount() {
		return fakturIndirectPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FakturIndirect updateFakturIndirect(FakturIndirect fakturIndirect) {
		return fakturIndirectPersistence.update(fakturIndirect);
	}
	 ...
	 */
	public FakturIndirectLocalService getFakturIndirectLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.FakturIndirect", fakturIndirectLocalService);

		_setLocalServiceUtilService(fakturIndirectLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.FakturIndirect");
	...
	public String getOSGiServiceIdentifier() {
		return FakturIndirectLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fakturIndirectPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FakturIndirectLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, fakturIndirectLocalService);
		}
	...
	@BeanReference(type = FakturIndirectLocalService.class)
	protected FakturIndirectLocalService fakturIndirectLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FakturIndirectLocalServiceBaseImpl.class);
