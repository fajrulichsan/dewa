...
import com.astra.dewa.service.SalesReportLocalService;
...
/**
 * Provides the base implementation for the sales report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.SalesReportLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.SalesReportLocalServiceImpl
 * @generated
 */
public abstract class SalesReportLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, SalesReportLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SalesReportLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SalesReportLocalServiceUtil</code>.
	 */
	...
	@Override
	public SalesReport addSalesReport(SalesReport salesReport) {
		salesReport.setNew(true);

		return salesReportPersistence.update(salesReport);
	}
	...
	public SalesReport createSalesReport(int Id) {
		return salesReportPersistence.create(Id);
	}
	...
	@Override
	public SalesReport deleteSalesReport(int Id) throws PortalException {
		return salesReportPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SalesReport deleteSalesReport(SalesReport salesReport) {
		return salesReportPersistence.remove(salesReport);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return salesReportPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SalesReport.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return salesReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return salesReportPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return salesReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return salesReportPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SalesReport fetchSalesReport(int Id) {
		return salesReportPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public SalesReport getSalesReport(int Id) throws PortalException {
		return salesReportPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(salesReportLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SalesReport.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SalesReport.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return salesReportPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SalesReportLocalServiceImpl#deleteSalesReport(SalesReport) to avoid orphaned data");
		}

		return salesReportLocalService.deleteSalesReport(
			(SalesReport)persistedModel);
	}

	@Override
	public BasePersistence<SalesReport> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return salesReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SalesReport> getSalesReports(int start, int end) {
		return salesReportPersistence.findAll(start, end);
	}
	...
	public int getSalesReportsCount() {
		return salesReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SalesReport updateSalesReport(SalesReport salesReport) {
		return salesReportPersistence.update(salesReport);
	}
	 ...
	 */
	public SalesReportLocalService getSalesReportLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.SalesReport", salesReportLocalService);

		_setLocalServiceUtilService(salesReportLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.SalesReport");
	...
	public String getOSGiServiceIdentifier() {
		return SalesReportLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = salesReportPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SalesReportLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, salesReportLocalService);
		}
	...
	@BeanReference(type = SalesReportLocalService.class)
	protected SalesReportLocalService salesReportLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SalesReportLocalServiceBaseImpl.class);
