...
import com.astra.dewa.service.ApplicationAssignLocalService;
...
/**
 * Provides the base implementation for the application assign local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationAssignLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationAssignLocalServiceImpl
 * @generated
 */
public abstract class ApplicationAssignLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationAssignLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationAssignLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationAssignLocalServiceUtil</code>.
	 */
	...
	@Override
	public ApplicationAssign addApplicationAssign(
		ApplicationAssign applicationAssign) {

		applicationAssign.setNew(true);

		return applicationAssignPersistence.update(applicationAssign);
	}
	...
	public ApplicationAssign createApplicationAssign(int Id) {
		return applicationAssignPersistence.create(Id);
	}
	...
	@Override
	public ApplicationAssign deleteApplicationAssign(int Id)
		throws PortalException {

		return applicationAssignPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationAssign deleteApplicationAssign(
		ApplicationAssign applicationAssign) {

		return applicationAssignPersistence.remove(applicationAssign);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationAssignPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationAssign.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationAssignPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return applicationAssignPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationAssignPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return applicationAssignPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ApplicationAssign fetchApplicationAssign(int Id) {
		return applicationAssignPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public ApplicationAssign getApplicationAssign(int Id)
		throws PortalException {

		return applicationAssignPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationAssign.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ApplicationAssign.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationAssignPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationAssignLocalServiceImpl#deleteApplicationAssign(ApplicationAssign) to avoid orphaned data");
		}

		return applicationAssignLocalService.deleteApplicationAssign(
			(ApplicationAssign)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationAssign> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationAssignPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplicationAssign> getApplicationAssigns(int start, int end) {
		return applicationAssignPersistence.findAll(start, end);
	}
	...
	public int getApplicationAssignsCount() {
		return applicationAssignPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationAssign updateApplicationAssign(
		ApplicationAssign applicationAssign) {
	 ...
	 */
	public ApplicationAssignLocalService getApplicationAssignLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ApplicationAssign",
			applicationAssignLocalService);

		_setLocalServiceUtilService(applicationAssignLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationAssignLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationAssignPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationAssignLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationAssignLocalService);
		}
	...
	@BeanReference(type = ApplicationAssignLocalService.class)
	protected ApplicationAssignLocalService applicationAssignLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationAssignLocalServiceBaseImpl.class);
