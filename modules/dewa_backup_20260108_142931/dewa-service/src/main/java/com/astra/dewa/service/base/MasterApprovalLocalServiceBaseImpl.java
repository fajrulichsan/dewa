...
import com.astra.dewa.service.MasterApprovalLocalService;
...
/**
 * Provides the base implementation for the master approval local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.MasterApprovalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.MasterApprovalLocalServiceImpl
 * @generated
 */
public abstract class MasterApprovalLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, MasterApprovalLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterApprovalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterApprovalLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterApproval addMasterApproval(MasterApproval masterApproval) {
		masterApproval.setNew(true);

		return masterApprovalPersistence.update(masterApproval);
	}
	...
	public MasterApproval createMasterApproval(int Id) {
		return masterApprovalPersistence.create(Id);
	}
	...
	@Override
	public MasterApproval deleteMasterApproval(int Id) throws PortalException {
		return masterApprovalPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterApproval deleteMasterApproval(MasterApproval masterApproval) {
		return masterApprovalPersistence.remove(masterApproval);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return masterApprovalPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterApproval.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterApprovalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterApprovalPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterApprovalPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterApprovalPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterApproval fetchMasterApproval(int Id) {
		return masterApprovalPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public MasterApproval getMasterApproval(int Id) throws PortalException {
		return masterApprovalPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterApprovalLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterApproval.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MasterApproval.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MasterApprovalLocalServiceImpl#deleteMasterApproval(MasterApproval) to avoid orphaned data");
		}

		return masterApprovalLocalService.deleteMasterApproval(
			(MasterApproval)persistedModel);
	}

	@Override
	public BasePersistence<MasterApproval> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterApprovalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterApproval> getMasterApprovals(int start, int end) {
		return masterApprovalPersistence.findAll(start, end);
	}
	...
	public int getMasterApprovalsCount() {
		return masterApprovalPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterApproval updateMasterApproval(MasterApproval masterApproval) {
		return masterApprovalPersistence.update(masterApproval);
	}
	 ...
	 */
	public MasterApprovalLocalService getMasterApprovalLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.MasterApproval", masterApprovalLocalService);

		_setLocalServiceUtilService(masterApprovalLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.MasterApproval");
	...
	public String getOSGiServiceIdentifier() {
		return MasterApprovalLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterApprovalPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterApprovalLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterApprovalLocalService);
		}
	...
	@BeanReference(type = MasterApprovalLocalService.class)
	protected MasterApprovalLocalService masterApprovalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MasterApprovalLocalServiceBaseImpl.class);
