...
import com.astra.dewa.service.CommonLocalService;
...
/**
 * Provides the base implementation for the common local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.CommonLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.CommonLocalServiceImpl
 * @generated
 */
public abstract class CommonLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CommonLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommonLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommonLocalServiceUtil</code>.
	 */
	...
	public Common addCommon(Common common) {
		...
		return commonPersistence.update(common);
	}
	...
	public Common createCommon(String CommonKey) {
		return commonPersistence.create(CommonKey);
	}
	...
	@Override
	public Common deleteCommon(String CommonKey) throws PortalException {
		return commonPersistence.remove(CommonKey);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Common deleteCommon(Common common) {
		return commonPersistence.remove(common);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return commonPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Common.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return commonPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return commonPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return commonPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return commonPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return commonPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Common fetchCommon(String CommonKey) {
		return commonPersistence.fetchByPrimaryKey(CommonKey);
	}
	 ...
	 */
	@Override
	public Common getCommon(String CommonKey) throws PortalException {
		return commonPersistence.findByPrimaryKey(CommonKey);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return commonPersistence.create((String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CommonLocalServiceImpl#deleteCommon(Common) to avoid orphaned data");
		}

		return commonLocalService.deleteCommon((Common)persistedModel);
	}

	@Override
	public BasePersistence<Common> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return commonPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Common> getCommons(int start, int end) {
		return commonPersistence.findAll(start, end);
	}
	...
	public int getCommonsCount() {
		return commonPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Common updateCommon(Common common) {
		return commonPersistence.update(common);
	}
	 ...
	 */
	public CommonLocalService getCommonLocalService() {
	 ...
	 */
	public void setCommonLocalService(CommonLocalService commonLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.Common", commonLocalService);

		_setLocalServiceUtilService(commonLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.astra.dewa.model.Common");
	...
	public String getOSGiServiceIdentifier() {
		return CommonLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = commonPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		CommonLocalService commonLocalService) {

		try {
			Field field = CommonLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, commonLocalService);
		}
	...
	@BeanReference(type = CommonLocalService.class)
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommonLocalServiceBaseImpl.class);
