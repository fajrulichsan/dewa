...
import com.astra.dewa.service.ApplicationCategoryLocalService;
...
/**
 * Provides the base implementation for the application category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.ApplicationCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.ApplicationCategoryLocalServiceImpl
 * @generated
 */
public abstract class ApplicationCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ApplicationCategoryLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ApplicationCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ApplicationCategoryLocalServiceUtil</code>.
	 */

	/**
	 * Adds the application category to the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect ApplicationCategoryLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param applicationCategory the application category
	 * @return the application category that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationCategory addApplicationCategory(
		ApplicationCategory applicationCategory) {

		applicationCategory.setNew(true);

		return applicationCategoryPersistence.update(applicationCategory);
	}
	...
	public ApplicationCategory createApplicationCategory(int Id) {
		return applicationCategoryPersistence.create(Id);
	}

	/**
	 * Deletes the application category with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect ApplicationCategoryLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 ...
	 * @throws PortalException if a application category with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationCategory deleteApplicationCategory(int Id)
		throws PortalException {

		return applicationCategoryPersistence.remove(Id);
	}

	/**
	 * Deletes the application category from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect ApplicationCategoryLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplicationCategory deleteApplicationCategory(
		ApplicationCategory applicationCategory) {

		return applicationCategoryPersistence.remove(applicationCategory);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return applicationCategoryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ApplicationCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationCategoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationCategoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ApplicationCategory fetchApplicationCategory(int Id) {
		return applicationCategoryPersistence.fetchByPrimaryKey(Id);
	}

	/**
	 * Returns the application category with the primary key.
	 *
	 * @param Id the primary key of the application category
	 ...
	 */
	@Override
	public ApplicationCategory getApplicationCategory(int Id)
		throws PortalException {

		return applicationCategoryPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ApplicationCategory.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return applicationCategoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ApplicationCategoryLocalServiceImpl#deleteApplicationCategory(ApplicationCategory) to avoid orphaned data");
		}

		return applicationCategoryLocalService.deleteApplicationCategory(
			(ApplicationCategory)persistedModel);
	}

	@Override
	public BasePersistence<ApplicationCategory> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return applicationCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ApplicationCategory> getApplicationCategories(
		...
		return applicationCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getApplicationCategoriesCount() {
		return applicationCategoryPersistence.countAll();
	}

	/**
	 * Updates the application category in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect ApplicationCategoryLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param applicationCategory the application category
	 * @return the application category that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplicationCategory updateApplicationCategory(
		ApplicationCategory applicationCategory) {
	 ...
	 */
	public ApplicationCategoryLocalService
	...
	public void setApplicationCategoryLocalService(
		ApplicationCategoryLocalService applicationCategoryLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.astra.dewa.model.ApplicationCategory",
			applicationCategoryLocalService);

		_setLocalServiceUtilService(applicationCategoryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ApplicationCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				applicationCategoryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ApplicationCategoryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, applicationCategoryLocalService);
		}
	...
	@BeanReference(type = ApplicationCategoryLocalService.class)
	protected ApplicationCategoryLocalService applicationCategoryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ApplicationCategoryLocalServiceBaseImpl.class);
