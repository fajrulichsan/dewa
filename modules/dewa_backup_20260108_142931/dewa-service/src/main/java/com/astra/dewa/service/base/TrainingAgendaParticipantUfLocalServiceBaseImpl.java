...
import com.astra.dewa.service.TrainingAgendaParticipantUfLocalService;
...
/**
 * Provides the base implementation for the training agenda participant uf local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.astra.dewa.service.impl.TrainingAgendaParticipantUfLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.astra.dewa.service.impl.TrainingAgendaParticipantUfLocalServiceImpl
 * @generated
 */
public abstract class TrainingAgendaParticipantUfLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingAgendaParticipantUfLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingAgendaParticipantUfLocalServiceUtil</code>.
	 */
	...
	@Override
	public TrainingAgendaParticipantUf addTrainingAgendaParticipantUf(
		TrainingAgendaParticipantUf trainingAgendaParticipantUf) {

		trainingAgendaParticipantUf.setNew(true);

		return trainingAgendaParticipantUfPersistence.update(
	...
	public TrainingAgendaParticipantUf createTrainingAgendaParticipantUf(
		int Id) {

		return trainingAgendaParticipantUfPersistence.create(Id);
	}
	...
	@Override
	public TrainingAgendaParticipantUf deleteTrainingAgendaParticipantUf(int Id)
		throws PortalException {

		return trainingAgendaParticipantUfPersistence.remove(Id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrainingAgendaParticipantUf deleteTrainingAgendaParticipantUf(
		TrainingAgendaParticipantUf trainingAgendaParticipantUf) {

		return trainingAgendaParticipantUfPersistence.remove(
			trainingAgendaParticipantUf);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return trainingAgendaParticipantUfPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingAgendaParticipantUf.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingAgendaParticipantUfPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingAgendaParticipantUfPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TrainingAgendaParticipantUf fetchTrainingAgendaParticipantUf(
		int Id) {

		return trainingAgendaParticipantUfPersistence.fetchByPrimaryKey(Id);
	}
	 ...
	 */
	@Override
	public TrainingAgendaParticipantUf getTrainingAgendaParticipantUf(int Id)
		throws PortalException {

		return trainingAgendaParticipantUfPersistence.findByPrimaryKey(Id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TrainingAgendaParticipantUf.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TrainingAgendaParticipantUf.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingAgendaParticipantUfPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingAgendaParticipantUfLocalServiceImpl#deleteTrainingAgendaParticipantUf(TrainingAgendaParticipantUf) to avoid orphaned data");
		}

		return trainingAgendaParticipantUfLocalService.
			deleteTrainingAgendaParticipantUf(
				(TrainingAgendaParticipantUf)persistedModel);
	}

	@Override
	public BasePersistence<TrainingAgendaParticipantUf> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingAgendaParticipantUfPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrainingAgendaParticipantUf> getTrainingAgendaParticipantUfs(
		int start, int end) {

		return trainingAgendaParticipantUfPersistence.findAll(start, end);
	}
	...
	public int getTrainingAgendaParticipantUfsCount() {
		return trainingAgendaParticipantUfPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrainingAgendaParticipantUf updateTrainingAgendaParticipantUf(
		TrainingAgendaParticipantUf trainingAgendaParticipantUf) {
	 ...
	 */
	public TrainingAgendaParticipantUfLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(trainingAgendaParticipantUfLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingAgendaParticipantUfLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				trainingAgendaParticipantUfPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TrainingAgendaParticipantUfLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, trainingAgendaParticipantUfLocalService);
		}
	...
	@BeanReference(type = TrainingAgendaParticipantUfLocalService.class)
	protected TrainingAgendaParticipantUfLocalService
		trainingAgendaParticipantUfLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingAgendaParticipantUfLocalServiceBaseImpl.class);
